...
(function () {
  ...
  function Eb(a, b, c, d) {
    ...
    if (u(b)) {
      ...
      h = i[bb]();
      for (
        var d = i.getTime(), l = i[ab](), m = i[Sa](), p = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5;
        d < c;
      )
        (e.push(d),
          j === D[Da]
    ...
    qa = function (a) {
      ...
      (function (a) {
        a && a.stops
          ...
          : (c = Yb.exec(a))
            ? (b = [y(c[1]), y(c[2]), y(c[3]), parseFloat(c[4], 10)])
            : (c = Zb.exec(a))
              ? (b = [y(c[1], 16), y(c[2], 16), y(c[3], 16), 1])
              : (c = $b.exec(a)) && (b = [y(c[1]), y(c[2]), y(c[3]), 1]);
      })(a);
      return {
        get: function (c) {
          var f;
  ...
  va.prototype = {
          ...
          if (((j = !1), (d = a[c]), (e = k[c] && k[c].call(this, d, c)), e !== !1)) {
            ...
            if (c === "d") (d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"));
              ...
              ((e = g.getElementsByTagName("title")[0]),
                e || ((e = z.createElementNS(ya, "title")), g.appendChild(e)),
                (e.textContent = d));
            ...
            if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c))
              for (e = l.length; e--; ) w(l[e], c, c === "height" ? r(d - (l[e].cutHeight || 0), 0) : d);
    ...
    css: function (a) {
      var b = this.element,
        c = (this.textWidth = a && a.width && b.nodeName.toLowerCase() === "text" && y(a.width)),
        d,
        e = "",
        f = function (a, b) {
      ...
      jb && a === "click"
        ? ((d.ontouchstart = function (a) {
          ...
          (d.onclick = function (a) {
            (na.indexOf("Android") === -1 || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
          }))
        : (d["on" + a] = b);
      return this;
    },
    ...
    setSpanRotation: function (a) {
      var b = {};
      b[sa ? "-ms-transform" : hb ? "-webkit-transform" : ib ? "MozTransform" : Nb ? "-o-transform" : ""] =
    ...
    add: function (a) {
      ...
      if (c.handleZ)
        for (c = 0; c < e.length; c++)
          if (((a = e[c]), (b = w(a, "zIndex")), a !== f && (y(b) > g || (!u(g) && u(b))))) {
            d.insertBefore(f, a);
            h = !0;
            break;
          }
  ...
  za.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      this.alignedObjects = [];
      this.url =
        (ib || hb) && z.getElementsByTagName("base").length
          ? e.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      if (ib && a.getBoundingClientRect)
        ((this.subPixelFix = b =
          function () {
            ...
            I(a, { left: wa(h.left) - h.left + "px", top: wa(h.top) - h.top + "px" });
          }),
          b(),
          K(N, "resize", b));
    },
    ...
    symbol: function (a, b, c, d, e, f) {
      var g,
        ...
        j,
        k;
      if (h) ((g = this.path(h)), s(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && s(g, f));
      else if (i.test(a))
        ((k = function (a, b) {
          a.element &&
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        return f.test(a)
          ? ((e = qa(a)), w(b, c + "-opacity", e.get("a")), e.get("rgb"))
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        if (y) {
          if (!B)
            ((a = t(-r * da)),
              (b = h ? -w : 0),
              (q.box = B = d ? p.symbol(d, a, b, q.width, q.height, Xa) : p.rect(a, b, q.width, q.height, 0, Xa[Rb])),
              B.add(q));
      ...
      function k() {
        var a = q.styles,
          ...
          c;
        c = h ? 0 : w;
        if (u(Oa) && (a === "center" || a === "right")) b += { center: 0.5, right: 1 }[a] * (Oa - O.width);
          ...
          for (c in a)
            if (((d = a[c]), (m = !1), (e = p[c] && p[c].call(this, d, c)), e !== !1 && d !== null)) {
              ...
              if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                ...
                h === "DIV" &&
                  ((d = d === "hidden" ? "-999em" : 0), gb || (g[c] = d ? "visible" : "hidden"), (c = "top"));
                g[c] = d;
                m = !0;
              } else if (c === "zIndex") (d && (g[c] = d), (m = !0));
              else if (pa(c, ["x", "y", "width", "height"]) !== -1)
                ((this[c] = d),
                  c === "x" || c === "y" ? (c = { x: "left", y: "top" }[c]) : (d = r(0, d)),
                ...
                (((f.getElementsByTagName("stroke")[0] || U(i.prepVML(["<stroke/>"]), null, null, f))[c] =
                  d || "solid"),
                  (this.dashstyle = d),
                  (m = !0));
              else if (c === "fill")
      ...
      clip: function (a) {
        ...
        a
          ? ((c = a.members),
            ...
            (a = a.getCSS(b)))
          : (b.destroyClip && b.destroyClip(), (a = { clip: gb ? "inherit" : "rect(auto)" }));
        return b.css(a);
      },
          ...
          if (c === "fill")
            if (i === "gradient")
              ((c = m.x1 || m[0] || 0),
                ...
                (p = m.x2 || m[2] || 0),
                (m = m.y2 || m[3] || 0),
                (r = 'angle="' + (90 - (R.atan((m - a) / (p - c)) * 180) / xa) + '"'),
                v());
            else {
              var j = m.r,
                s = j * 2,
                ...
                j = function () {
                  x &&
                    ((w = d.getBBox()),
                    (H += (x[0] - w.x) / w.width - 0.5),
                    (C += (x[1] - w.y) / w.height - 0.5),
                    (s *= x[2] / w.width),
                    (E *= x[2] / w.height));
                  r =
                    'src="' +
                    L.global.VMLRadialGradientURL +
                    '" size="' +
                    s +
                    "," +
                    E +
      ...
      symbols: {
        ...
        rect: function (a, b, c, d, e) {
          var f = a + c,
            ...
            h;
          !u(e) || !e.r
            ? (f = za.prototype.symbols.square.apply(0, arguments))
            : ((h = J(e.r, c, d)),
              (f = [
                "M",
                a + h,
  ...
  vb.prototype = {
    render: function () {
      ...
      if (h) {
        if (((q = b.getPlotLinePath(l, h)), (d = { stroke: B, "stroke-width": h }), m)) d.dashstyle = m;
      } else if (k) {
        if (
          ((j = r(j, b.min - d)),
          (i = J(i, b.max + d)),
      ...
      if (u(O)) d.zIndex = O;
      if (p)
        if (q) p.animate({ d: q }, null, p.onGetPath);
        else {
          if (
            (p.hide(),
      ...
      if (f && u(f.text) && q && q.length && b.width > 0 && b.height > 0) {
        ...
        if (!g)
          a.label = g = v
            ...
            .attr({ align: f.textAlign || f.align, rotation: f.rotation, zIndex: O })
            .css(f.style)
            .add();
        b = [q[1], q[4], o(q[6], q[1])];
        q = [q[2], q[5], o(q[7], q[2])];
  ...
  eb.prototype = {
    ...
    setOptions: function (a) {
      this.options = x(
        ...
        x(L[this.isXAxis ? "xAxis" : "yAxis"], a),
      );
    },
    update: function (a, b) {
      var c = this.chart,
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b
        ...
        : (e && (a = this.val2lin(a)),
          f === "between" && (f = 0.5),
          (a = h * (a - d) * j + i + h * k + (ra(f) ? j * f * this.pointRange : 0)));
      return a;
    },
    ...
    setTickPositions: function (a) {
      ...
      b.min === b.max || b.min === void 0 || b.max === void 0
        ...
        : h && !l && p === b.linkedParent.options.tickPixelInterval
          ...
          : ((b.tickInterval = o(l, aa ? 1 : ((b.max - b.min) * p) / r(b.len, p))),
      ...
      if (!a)
        (!b.ordinalPositions && (b.max - b.min) / b.tickInterval > r(2 * b.len, 200) && ka(19, !0),
          (a = f
    ...
    zoom: function (a, b) {
      this.allowZoomOutside ||
        (u(this.dataMin) && a <= this.dataMin && (a = v), u(this.dataMax) && b >= this.dataMax && (b = v));
    ...
    getOffset: function () {
      ...
      if (j || a.isLinked) {
        ...
        n(e, function (b) {
          if (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === a.labelAlign) aa = r(f[b].getLabelSize(), aa);
        });
    ...
    render: function () {
            ...
            n(g, function (b, c) {
              if (c % 2 === 0 && b < a.max)
                (l[b] || (l[b] = new vb(a)),
                  ...
                  (l[b].options = { from: e ? fa(s) : s, to: e ? fa(w) : w, color: p }),
                  l[b].render(),
                  (l[b].isActive = !0));
            }),
          !a._addedPlotLB)
      ...
      if (o)
        ((B = a.getLinePath(o)),
          a.axisLine
            ...
            : (a.axisLine = c.path(B).attr({ stroke: d.lineColor, "stroke-width": o, zIndex: 7 }).add(a.axisGroup)),
      ...
      if (m && m.enabled) {
        ...
        for (x in i) for (y in ((c = i[x]), c)) c[y].render(d);
      }
      a.isDirty = !1;
    },
  ...
  wb.prototype = {
    ...
    getAnchor: function (a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === v && (b = d.pointer.normalize(b)), (c = [b.chartX - d.plotLeft, b.chartY - f]));
      c ||
        (n(a, function (a) {
          i = a.series.yAxis;
          g += a.plotX;
  ...
  xb.prototype = {
    ...
    pinch: function (a) {
      ...
      if (a.type === "touchstart")
        ...
        if (!l) b.selectionMarker = l = s({ destroy: oa }, c.plotBox);
    ...
    drop: function (a) {
      ...
      if (b)
        (I(b.container, { cursor: b._cursor }),
      ...
      if (!b.cancelClick)
        c && this.inClass(a.target, "highcharts-tracker")
          ? ((g = this.chartPosition),
            (h = c.plotX),
            (i = c.plotY),
            s(c, { pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i) }),
            A(c.series, "click", s(a, { point: c })),
            b.hoverPoint && c.firePointEvent("click", a))
          : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && A(b, "click", a));
    },
  ...
  fb.prototype = {
    ...
    renderItem: function (a) {
      ...
      if (
        ...
        (a.legendItem = t =
          d
            .text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, w)
            .css(x(a.visible ? i : j))
    ...
    scroll: function (a, b) {
      ...
      if (d > 0)
        (b !== v && La(b, this.chart),
          ...
          (e = -J(e * (d - 1), this.fullHeight - e + i) + 1),
  ...
  yb.prototype = {
    ...
    addSeries: function (a, b, c) {
      ...
      a &&
        ((b = o(b, !0)),
        A(e, "addSeries", { options: a }, function () {
          d = e.initSeries(a);
          e.isDirtyLegend = !0;
          e.linkSeries();
          b && e.redraw(c);
    ...
    showLoading: function (a) {
      ...
      if (!c)
        ((this.loadingDiv = c =
          U(Ea, { className: "highcharts-loading" }, s(d.style, { zIndex: 10, display: S }), this.container)),
    ...
    layOutTitles: function () {
      ...
      if (
        b &&
        (b.css({ width: (e.width || f) + "px" }).align(s({ y: 15 }, e), !1, "spacingBox"),
        !e.floating && !e.verticalAlign)
      )
        ((a = b.getBBox().height), a >= 18 && a <= 25 && (a = 15));
      c &&
        (c.css({ width: (d.width || f) + "px" }).align(s({ y: a + e.margin }, d), !1, "spacingBox"),
        !d.floating && !d.verticalAlign && (a = wa(a + c.getBBox().height)));
      this.titleOffset = a;
    },
    ...
    cloneRenderTo: function (a) {
      ...
      a
        ...
        : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
          ...
          I(b, { position: "absolute", top: "-9999px", display: "block" }),
    ...
    getMargins: function () {
      ...
      if (c.display && !e.floating)
        if (i === "right") {
          if (!u(d[1])) this.marginRight = r(this.marginRight, c.legendWidth - g + f + a[1]);
        } else if (i === "left") {
    ...
    drawChartBox: function () {
      ...
      u ? u.animate({ width: s.width, height: s.height }) : (this.clipRect = b.clipRect(s));
      if (m)
        g
          ? g.animate(g.crisp(null, q, o, n, r))
          : (this.plotBorder = b
              .rect(q, o, n, r, 0, -m)
    ...
    isReadyToRender: function () {
      var a = this;
      return (!W && N == N.top && z.readyState !== "complete") || (ca && !N.canvg)
        ? (ca
            ? Tb.push(function () {
                a.firstRender();
          ...
          n(e.getSelectedPoints(), function (a) {
            if (a.selected && a !== c)
              ((a.selected = a.options.selected = !1),
                (d.options.data[pa(a, d.data)] = a.options),
                a.setState(""),
    ...
    setState: function (a) {
      ...
      if (
        !(
          ...
          (e[a] && e[a].enabled === !1) ||
          (a && (i || (g && !h.enabled))) ||
          (a && k.states && k.states[a] && k.states[a].enabled === !1)
        )
      ) {
        if (this.graphic)
  ...
  Q.prototype = {
    ...
    addPoint: function (a, b, c, d) {
      ...
      g = d.x;
      h = j.length;
      if (this.requireSorting && g < j[h - 1]) for (r = !0; h && j[h - 1] > g; ) h--;
      j.splice(h, 0, g);
      ...
      for (m = 0; m < g; m++)
        ((i = h + m),
          j
            ...
            : (b[i] ? (k = b[i]) : a[i] !== v && (b[i] = k = new f().init(this, a[i], d[m])), (l[m] = k)));
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++) if ((m === h && !j && (m += g), b[m])) (b[m].destroyElements(), (b[m].plotX = v));
      this.data = b;
      this.points = l;
    },
      ...
      if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
        ...
        for (o = 0; o < d; o++) {
          ...
          e === "percent"
            ? ((p = p ? h : i),
              j && l[p] && l[p][n]
                ? ((p = l[p][n]), (q.total = p.total = r(p.total, q.total) + M(t) || 0))
                : (q.total += M(t) || 0))
            : (q.total += t || 0);
          q.cum = (q.cum || 0) + (t || 0);
    ...
    getExtremes: function () {
      ...
      for (l = 0; l < d; l++)
        if (
          ((j = b[l]),
          (k = c[l]),
          (i = k !== null && k !== v && (!a.isLog || k.length || k > 0)),
      ...
      for (
        ...
        if (b && this.visible && n && n[m])
          ((n = n[m]),
            ...
            (l.percentage = b === "percent" && (l.y / n.total) * 100),
            (l.stackY = p),
      ...
      if (this.options.enableMouseTracking !== !1) {
        ...
        for (i = 0; i < a; i++)
          if (((e = b[i]), (c = e.x), c >= f.min && c <= f.max)) {
            ...
            c = d === v ? 0 : d + 1;
            for (
              d = b[i + 1] ? J(r(0, P((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g;
              c >= 0 && c <= d;
            )
              j[c++] = e;
          }
        ...
        for (f = b.length; f--; )
          if (
            ...
            if (
              ...
              k.attr({ visibility: m ? (W ? "inherit" : "visible") : "hidden" }).animate(
                s({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}),
              );
            else {
              if (m && (h > 0 || j))
    ...
    getAttribs: function () {
      ...
      for (g = i.length; g--; ) {
        ...
        if (f) {
          ...
          f = d.hover = d.hover || {};
          if (!b.marker)
            f.color = qa(f.color || h.color)
              .brighten(f.brightness || e.brightness)
              .get();
          k[""] = a.convertAttribs(
            s({ color: h.color, fillColor: h.color, lineColor: p === null ? h.color : v }, c),
            j[""],
          );
        ...
        (a.dlProcessOptions && a.dlProcessOptions(d),
          ...
          n(b, function (b) {
            ...
            if (k && !j) b.dataLabel = k.destroy();
              ...
              j = d.rotation;
              l = b.getLabelConfig();
              g = d.format ? Ca(d.format, l) : d.formatter.call(l, d);
              d.style.color = o(d.color, d.style.color, a.color, "black");
              if (k)
                if (u(g)) (k.attr({ text: g }), (q = !1));
                else {
                ...
                k = b.dataLabel = a.chart.renderer[j ? "text" : "label"](g, 0, -999, null, null, null, d.useHTML)
                  .attr(k)
                  .css(s(d.style, c && { cursor: c }))
                  .add(h)
                  .shadow(d.shadow);
              }
    ...
    alignDataLabel: function (a, b, c, d, e) {
      ...
      if ((a = this.visible && f.isInsidePlot(a.plotX, a.plotY, g)))
        ((d = s({ x: g ? f.plotWidth - i : h, y: t(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
          s(c, { width: j.width, height: j.height }),
          c.rotation
    ...
    drawGraph: function () {
      ...
      n(c, function (c, h) {
        var k = c[0],
          l = a[k];
        if (l) (Wa(l), l.animate({ d: g }));
        else if (d && g.length)
          ((l = { stroke: c[1], "stroke-width": d, zIndex: 1 }),
          ...
          if (!k || (g[a] && g[a].y !== null))
            g[a]
              ...
              : ((h = d.translate(a)),
                ...
                (i = e.toPixels(l, !0)),
                b.push({ y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: oa }));
        });
        b.length && a.push(b);
      ...
      n(f, function (d) {
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              .path(b)
              .attr({ fill: o(d[2], qa(d[1]).setOpacity(o(c.fillOpacity, 0.75)).get()), zIndex: 0 })
              .add(a.group));
      });
    },
  ...
  F = ha(Q, {
      ...
      b.grouping === !1
        ...
        : n(a.chart.series, function (b) {
            ...
            if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
              (c.stacking ? ((f = b.stackKey), g[f] === v && (g[f] = i++), (h = g[f])) : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h));
          });
    ...
    animate: function (a) {
      ...
      if (W)
        a
          ? ((e.scaleY = 0.001),
            (a = J(b.pos + b.len, r(b.pos, b.toPixels(c.threshold)))),
  ...
  Y = {
        ...
        for (H = 2; H--; ) {
          ...
          if (l > 0) {
            ...
            for (C = 0; C < K; C++) {
              ...
              if (F < C && b[C] !== null) F = C;
              else for (v < K - C + F && b[C] !== null && (F = v - K + C); b[F] === null; ) F++;
              I.push({ i: F, y: b[F] });
              b[F] = null;
            }
            I.sort(J);
          ...
          for (C = 0; C < K; C++) {
            ...
            c = w[1];
            if (l > 0) {
              if (((v = I.pop()), (F = v.i), (A = v.y), (c > A && b[F + 1] !== null) || (c < A && b[F - 1] !== null)))
                A = c;
            } else A = c;
            ...
            if (this.options.size === null)
              ((v = s.width),
                z - v < f ? (D[3] = r(t(v - z + f), D[3])) : z + v > h - f && (D[1] = r(t(z + v - h + f), D[1])),
                A - x / 2 < 0 ? (D[0] = r(t(-A + x / 2), D[0])) : A + x / 2 > d && (D[2] = r(t(A + x / 2 - d), D[2])));
          }
        }
                ...
                if ((s = b.dataLabel) && s._pos)
                  ((E = s._attr.visibility),
                    ...
                    (j = k
                      ...
                      : ["M", z + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]]),
                    i
    ...
    verifyDataLabelOverflow: function (a) {
      ...
      d[1] !== null
        ? (e = r(J(e, b[2] - r(a[0], a[2])), c))
        : ((e = r(J(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
      e < b[2]
        ? ((b[2] = e),
          this.translate(b),
          n(this.points, function (a) {
