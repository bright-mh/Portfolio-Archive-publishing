  ...
  (!(function (a) {
        ...
        a.mobile,
        {
          ...
          getInheritedTheme: function (a, b) {
            for (
              ...
              e && ((c = e.className || ""), !(c && (d = g.exec(c)) && (f = d[2])));
            )
              e = e.parentNode;
            return f || b || "a";
          },
        ...
        (a.fn.jqmData = function (b, c) {
          ...
          return (
            "undefined" != typeof b &&
              ...
              (e = arguments.length < 2 || c === d ? this.data(b) : this.data(b, c))),
            e
          );
        }),
                ...
                ? this.each(function () {
                    ...
                    return e
                      ? a.isFunction(e[g]) && "_" !== g.charAt(0)
                        ? ((d = e[g].apply(e, i)),
                          d !== e && d !== b ? ((j = d && d.jquery ? j.pushStack(d.get()) : d), !1) : void 0)
      ...
      a.widget("mobile.widget", {
        ...
        enhance: function (b, c) {
          var d,
            e,
            f = a(b);
          ((f = a.mobile.enhanceable(f)),
            c &&
              f.length &&
              ((d = a.mobile.closestPageData(f)), (e = (d && d.keepNativeSelector()) || ""), (f = f.not(e))),
            f[this.widgetName]());
        },
        raise: function (a) {
    ...
    (function (a) {
      ...
      (a.widget("mobile.loader", {
        ...
        defaultHtml:
          "<div class='" + b + "'>" + "<span class='ui-icon ui-icon-loading'></span>" + "<h1></h1>" + "</div>",
        ...
        checkLoaderPosition: function () {
          ...
          (b.top < c || b.top - c > d) &&
            ...
            this.fakeFixLoader(),
            e.unbind("scroll", this.checkLoaderPosition).bind("scroll", a.proxy(this.fakeFixLoader, this)));
        },
        resetHtml: function () {
        ...
        show: function (f, g, h) {
          ...
          (this.resetHtml(),
            "object" === a.type(f)
              ? ((k = a.extend({}, this.options, f)), (f = k.theme || a.mobile.loadingMessageTheme))
              : ((k = this.options), (f = f || a.mobile.loadingMessageTheme || k.theme)),
            (j = g || a.mobile.loadingMessage || k.text),
            c.addClass("ui-loading"),
            (a.mobile.loadingMessage !== !1 || k.html) &&
              ((i = a.mobile.loadingMessageTextVisible !== d ? a.mobile.loadingMessageTextVisible : k.textVisible),
              this.element.attr(
                "class",
                b +
                  ...
                  f +
                  " ui-loader-" +
                  (i || g || f.text ? "verbose" : "default") +
                  (k.textonly || h ? " ui-loader-textonly" : ""),
              ),
              k.html ? this.element.html(k.html) : this.element.find("h1").text(j),
              this.element.appendTo(a.mobile.pageContainer),
              this.checkLoaderPosition(),
              e.bind("scroll", a.proxy(this.checkLoaderPosition, this))));
        },
        hide: function () {
        ...
        (f = (function () {
          function c() {
            ...
            (d !== j
              ...
              : h !== j && (location.href = location.href.replace(/#.*/, "") + h),
    ...
    (function (a, d) {
      ...
      function g() {
        ...
        var g = c.createElement("div"),
          h = { MozTransform: "-moz-transform", transform: "transform" };
        l.append(g);
        for (var i in h)
          g.style[i] !== d &&
            ((g.style[i] = "translate3d( 100px, 1px, 1px )"), (f = b.getComputedStyle(g).getPropertyValue(h[i])));
        return !!f && "none" !== f;
      }
      function h() {
        var b,
          ...
          g = "";
        return (
          e.length ? (g = e.attr("href")) : (e = f = a("<base>", { href: d }).appendTo("head")),
          (b = a("<a href='testurl' />").prependTo(l)),
          (c = b[0].href),
      ...
      function k() {
        var a = b,
          ...
          j = !!i && i[1];
        return ((d.indexOf("iPhone") > -1 || d.indexOf("iPad") > -1 || d.indexOf("iPod") > -1) && f && 534 > f) ||
      ...
      (a.extend(a.mobile, { browser: {} }),
        ...
        a.extend(a.support, {
          cssTransitions:
            "WebKitTransitionEvent" in b ||
            (f("transition", "height 100ms linear", ["Webkit", "Moz", ""]) && !a.mobile.browser.oldIE && !p),
          pushState:
      ...
      ((a.mobile.gradeA = function () {
        return (
          (a.support.mediaquery || (a.mobile.browser.oldIE && a.mobile.browser.oldIE >= 7)) &&
          (a.support.boundingRect || null !== a.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/))
        );
      }),
        (a.mobile.ajaxBlacklist = (b.blackberry && !b.WebKitPoint) || q || s),
        s &&
          a(function () {
      ...
      a.event.special.navigate = c = {
        ...
        hashchange: function (b) {
          var c = new a.Event("navigate"),
            e = new a.Event("beforenavigate");
          (d.trigger(e),
            e.isDefaultPrevented() || ((c.originalEvent = b), d.trigger(c, { state: b.hashchangeState || {} })));
        },
        setup: function () {
          c.bound ||
            ((c.bound = !0),
            c.isPushStateEnabled()
              ? ((c.originalEventName = "popstate"), d.bind("popstate.navigate", c.popstate))
              : c.isHashChangeEnabled() &&
                ((c.originalEventName = "hashchange"), d.bind("hashchange.navigate", c.hashchange)));
        },
      };
    })(a),
    (function (a, c) {
      ...
      ((a.mobile.path = d =
        {
          ...
          convertUrlToDataUrl: function (a) {
            var c = d.parseUrl(a);
            return d.isEmbeddedPage(c)
              ? c.hash.split(f)[0].replace(/^#/, "").replace(/\?.*$/, "")
              : d.isSameDomain(c, this.documentBase)
                ? c.hrefNoHash.replace(this.documentBase.domain, "").split(f)[0]
            ...
            return "" !== b.protocol
              ? !this.isPath(b.hash) &&
                  ...
                  (b.hrefNoHash === this.documentUrl.hrefNoHash ||
                    (this.documentBaseDiffers && b.hrefNoHash === this.documentBase.hrefNoHash))
              : /^#/.test(b.href);
          },
          squash: function (a, b) {
            var c,
              ...
              k = "";
            return (
              (b = b || (d.isPath(a) ? d.getLocation() : d.getDocumentUrl())),
              (e = h ? d.stripHash(a) : a),
              ...
              h
                ? ((d.isPath(j) || 0 === j.replace("#", "").indexOf(this.uiStateKey)) && (j = ""),
                  k && -1 === j.indexOf(this.uiStateKey) && (j += k),
                  -1 === j.indexOf("#") && "" !== j && (j = "#" + j),
                  (c = d.parseUrl(c)),
                  (c = c.protocol + "//" + c.host + c.pathname + f + j))
                : (c += c.indexOf("#") > -1 ? k : "#" + k),
              c
            );
          },
        ...
        a.extend(a.mobile.History.prototype, {
          ...
          closest: function (a) {
            ...
            return (
              ...
              c === b && ((c = this.find(a, this.stack.slice(d), !0)), (c = c === b ? c : c + d)),
              c
            );
          },
          direct: function (c) {
            ...
            (d !== b && ((this.activeIndex = d), (this.previousIndex = e)),
              e > d
                ...
                : d > e
                  ? (c.present || c.forward || a.noop)(this.getActive(), "forward")
    ...
    (function (a) {
      ...
      ((a.mobile.Navigator = function (b) {
        ...
        a.extend(a.mobile.Navigator.prototype, {
          ...
          hash: function (a, b) {
            var c, e, f;
            if (((c = d.parseUrl(a)), (e = d.parseLocation()), e.pathname + e.search === c.pathname + c.search))
          ...
          popstate: function (b) {
            ...
            if (a.event.special.navigate.isPushStateEnabled())
              return this.preventHashAssignPopState
                ? ((this.preventHashAssignPopState = !1), b.stopImmediatePropagation(), void 0)
                : this.ignorePopState
                  ? ((this.ignorePopState = !1), void 0)
                  : !b.originalEvent.state &&
                    ...
                    : ((c = d.parseLocation().hash),
                      !b.originalEvent.state && c
                        ? ((f = this.squash(c)), this.history.add(f.url, f), (b.historyState = f), void 0)
                        : (this.history.direct({
          ...
          hashchange: function (b) {
            ...
            if (a.event.special.navigate.isHashChangeEnabled() && !a.event.special.navigate.isPushStateEnabled()) {
              if (this.preventNextHashChange)
                return ((this.preventNextHashChange = !1), b.stopImmediatePropagation(), void 0);
              ((e = this.history),
        ...
        if (!L) {
          ...
          if ((o("vmouseup", a, c), !I)) {
            ...
            d &&
              ...
              ((b = e(a).changedTouches[0]), J.push({ touchID: P, x: b.clientX, y: b.clientY }), (K = !0));
          }
          ...
          setup: function () {
            ...
            ((d[b] = !0),
              ...
              M &&
                ...
                1 === E.touchstart &&
                  N.bind("touchstart", q).bind("touchend", t).bind("touchmove", s).bind("scroll", r)));
          },
          teardown: function () {
            (--E[b],
              E[b] || N.unbind(c, p),
              M &&
                (--E.touchstart,
                E.touchstart ||
                  N.unbind("touchstart", q).unbind("touchmove", s).unbind("touchend", t).unbind("scroll", r)));
            var d = a(this),
              e = a.data(this, y);
              ...
              for (c = b.clientX, d = b.clientY, x = a.vmouse.clickDistanceThreshold, e = j; e; ) {
                for (f = 0; i > f; f++)
                  if (
                    ((g = J[f]),
                    (h = 0),
                    (e === j && Math.abs(g.x - c) < x && Math.abs(g.y - d) < x) || a.data(e, z) === g.touchID)
                  )
                    return (b.preventDefault(), b.stopPropagation(), void 0);
                e = e.parentNode;
              }
          },
          !0,
            ...
            c.bind(i, function (b) {
              function e(b) {
                g &&
                  ...
                  Math.abs(g.coords[0] - f.coords[0]) > a.event.special.swipe.scrollSupressionThreshold &&
                    b.preventDefault());
              }
              var f,
    ...
    (function (a, b) {
      ...
      ((a.event.special.orientationchange = a.extend({}, a.event.special.orientationchange, {
        setup: function () {
          return a.support.orientation && !a.event.special.orientationchange.disabled
            ? !1
            : ((f = e()), i.bind("throttledresize", d), void 0);
        },
        teardown: function () {
          return a.support.orientation && !a.event.special.orientationchange.disabled
            ? !1
            : (i.unbind("throttledresize", d), void 0);
        },
        add: function (a) {
          var b = a.handler;
        ...
        (a.event.special.orientationchange.orientation = e =
          function () {
            var d = !0,
              e = c.documentElement;
            return (
              (d = a.support.orientation ? k[b.orientation] : e && e.clientWidth / e.clientHeight < 1.1),
      ...
      a.widget("mobile.page", a.mobile.widget, {
        ...
        keepNativeSelector: function () {
          ...
          return c && b.keepNative !== b.keepNativeDefault
            ? [b.keepNative, b.keepNativeDefault].join(", ")
            : b.keepNativeDefault;
        },
      });
    })(a),
    (function (a, b, c) {
            ...
            function (c, e, f, g) {
              var h = new a.Deferred(),
                ...
                n =
                  ...
                  !c ||
                  "none" === c ||
                  Math.max(a.mobile.window.scrollTop(), k) > a.mobile.getMaxScrollForTransition(),
                o = " ui-page-pre-in",
                p = function () {
                ...
                s = function () {
                  (d ? g.animationComplete(t) : t(),
                    g.height(l + a.mobile.window.scrollTop()).addClass(c + " out" + i));
                },
                t = function () {
                  (g && d && r(), u());
                },
                u = function () {
                  (f.css("z-index", -10),
                    f.addClass(a.mobile.activePageClass + o),
                    a.mobile.focusPage(f),
                    f.height(l + k),
                    q(),
                    f.css("z-index", ""),
                    n || f.animationComplete(v),
                    f.removeClass(o).addClass(c + " in" + i),
                    n && v());
                },
                v = function () {
                  (d || (g && r()),
                    f.removeClass("out in reverse " + c).height(""),
                    p(),
                    a.mobile.window.scrollTop() !== k && q(),
                    h.resolve(c, e, f, g, !0));
                };
      ...
      ((a.mobile.defaultTransitionHandler = e),
        (a.mobile.transitionHandlers = { default: a.mobile.defaultTransitionHandler, sequential: e, simultaneous: f }),
        (a.mobile.transitionFallbacks = {}),
        (a.mobile._maybeDegradeTransition = function (b) {
          return (
            b && !a.support.cssTransform3d && a.mobile.transitionFallbacks[b] && (b = a.mobile.transitionFallbacks[b]),
            b
          );
        }),
    ...
    (function (a, d) {
      function e(b) {
        (!p || (p.closest("." + a.mobile.activePageClass).length && !b) || p.removeClass(a.mobile.activeBtnClass),
          (p = null));
      }
      function f() {
      ...
      function g(b, c, d, e) {
        (c && c.data("mobile-page")._trigger("beforehide", null, { nextPage: b }),
          b.data("mobile-page")._trigger("beforeshow", null, { prevPage: c || a("") }),
        ...
        return (
          g.done(function () {
            (c && c.data("mobile-page")._trigger("hide", null, { nextPage: b }),
              b.data("mobile-page")._trigger("show", null, { prevPage: c || a("") }));
          }),
          g
        );
      }
      ...
      var l = a.mobile.window,
        ...
        n = a.extend(a.mobile.path, {
          ...
          isFirstPageUrl: function (b) {
            var c = n.parseUrl(n.makeUrlAbsolute(b, this.documentBase)),
              e =
                c.hrefNoHash === this.documentUrl.hrefNoHash ||
                (this.documentBaseDiffers && c.hrefNoHash === this.documentBase.hrefNoHash),
        ...
        z = a.support.dynamicBaseTag
          ...
          : d;
      ((a.mobile.getDocumentUrl = n.getDocumentUrl),
        (a.mobile.getDocumentBase = n.getDocumentBase),
      ...
      ((A = function () {
        ...
        (a.fn.animationComplete = function (b) {
          return a.support.cssTransitions
            ? a(this).one("webkitAnimationEnd animationend", b)
            : (setTimeout(b, 0), a(this));
        }),
        (a.mobile.path = n),
        (a.mobile.base = z),
        (a.mobile.urlHistory = r),
        (a.mobile.dialogHashKey = u),
        (a.mobile.allowCrossDomainPages = !1),
        (a.mobile._bindPageRemove = function () {
          var b = a(this);
          !b.data("mobile-page").options.domCache &&
            b.is(":jqmData(external-page='true')") &&
        ...
        (a.mobile.loadPage = function (b, c) {
          ...
          (f.data && "get" === f.type && ((k = n.addSearchParams(k, f.data)), (f.data = d)),
            f.data && "post" === f.type && (f.reloadPage = !0));
          var l = n.getFilePath(k),
            m = n.convertUrlToDataUrl(k);
          if (
            ((f.pageContainer = f.pageContainer || a.mobile.pageContainer),
            (g = f.pageContainer.children("[data-" + a.mobile.ns + "url='" + m + "']")),
            0 === g.length &&
              m &&
              !n.isPath(m) &&
              (g = f.pageContainer
                .children("#" + m)
                .attr("data-" + a.mobile.ns + "url", m)
                .jqmData("url", m)),
            0 === g.length)
          )
            if (a.mobile.firstPage && n.isFirstPageUrl(l))
          ...
          var o = f.pageContainer,
            ...
            q = { url: b, absUrl: k, dataUrl: m, deferred: e, options: f };
          ...
          return (
            !z || ("undefined" != typeof c && "undefined" != typeof c.prefetch) || z.reset(),
            a.mobile.allowCrossDomainPages || n.isSameDomain(w, k)
              ? a.ajax({
                  url: l,
                  type: f.type,
                  data: f.data,
                  ...
                  success: function (d, i, o) {
                    ...
                    if (
                      (t.test(d) &&
                        ...
                        u.test(RegExp.$1) &&
                        RegExp.$1 &&
                        (b = l = n.getFilePath(a("<div>" + RegExp.$1 + "</div>").text())),
                      !z || ("undefined" != typeof c && "undefined" != typeof c.prefetch) || z.set(l),
                      (p.get(0).innerHTML = d),
                      (g = p.find(":jqmData(role='page'), :jqmData(role='dialog')").first()),
                      g.length ||
                        (g = a(
                          "<div data-" +
                            a.mobile.ns +
                      ...
                      r &&
                        !g.jqmData("title") &&
                        (~r.indexOf("&") && (r = a("<div>" + r + "</div>").text()), g.jqmData("title", r)),
                      !a.support.dynamicBaseTag)
                    ) {
                      var v = n.get(l);
                      g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(
                        function () {
                    ...
                    (g
                      .attr("data-" + a.mobile.ns + "url", n.convertUrlToDataUrl(l))
                      .attr("data-" + a.mobile.ns + "external-page", !0)
                      .appendTo(f.pageContainer),
                      g.one("pagecreate", a.mobile._bindPageRemove),
                      h(g, f.role),
                      k.indexOf("&" + a.mobile.subPageUrlKey) > -1 &&
                        (g = f.pageContainer.children("[data-" + a.mobile.ns + "url='" + m + "']")),
                      f.showLoadMsg && s(),
                      (q.xhr = o),
                      (q.textStatus = i),
                      (q.page = g),
                      f.pageContainer.trigger("pageload", q),
                      e.resolve(k, c, g, j));
                  },
                  error: function (b, d, g) {
                    (z && z.set(n.get()), (q.xhr = b), (q.textStatus = d), (q.errorThrown = g));
                    var h = new a.Event("pageloadfailed");
                    (f.pageContainer.trigger(h, q),
                      h.isDefaultPrevented() ||
                        (f.showLoadMsg &&
                          ...
                          setTimeout(a.mobile.hidePageLoadingMsg, 1500)),
                        e.reject(k, c)));
                  },
                })
              : e.reject(k, c),
        ...
        (a.mobile.changePage = function (b, j) {
          ...
          var k,
            l = a.extend({}, a.mobile.changePage.defaults, j);
          ((l.pageContainer = l.pageContainer || a.mobile.pageContainer),
            (l.fromPage = l.fromPage || a.mobile.activePage),
            (k = "string" == typeof b));
          var m = l.pageContainer,
            o = new a.Event("pagebeforechange"),
            p = { toPage: b, options: l };
          if (
            ((p.absUrl = k ? n.makeUrlAbsolute(b, i()) : b.data("absUrl")), m.trigger(o, p), !o.isDefaultPrevented())
          ) {
            ...
            if (q && q[0] === b[0] && !l.allowSamePageTransition)
              return ((t = !1), m.trigger("pagechange", p), l.fromHashChange && r.direct({ url: v }), void 0);
            ...
            C &&
              ...
              (y.url &&
                y.url.indexOf(u) > -1 &&
                a.mobile.activePage &&
                !a.mobile.activePage.is(".ui-dialog") &&
                r.activeIndex > 0 &&
                ((l.changeHash = !1), (E = !0)),
              (v = y.url || ""),
              (v += !E && v.indexOf("#") > -1 ? u : "#" + u),
              0 === r.activeIndex && v === r.initialDst && (v += u));
            var F = y ? b.jqmData("title") || b.children(":jqmData(role='header')").find(".ui-title").text() : B;
            if (
              (F && B === c.title && (B = F),
              b.jqmData("title") || b.jqmData("title", B),
              (l.transition =
                l.transition ||
                (A && !z ? y.transition : d) ||
                (C ? a.mobile.defaultDialogTransition : a.mobile.defaultPageTransition)),
              !A && E && (r.getActive().pageUrl = x),
              v && !l.fromHashChange)
            ) {
              var G;
              (!n.isPath(v) && v.indexOf("#") < 0 && (v = "#" + v),
                (G = { transition: l.transition, title: B, pageUrl: x, role: l.role }),
                l.changeHash !== !1 && a.mobile.hashListeningEnabled
                  ? a.mobile.navigate(v, G, !0)
                  : b[0] !== a.mobile.firstPage[0] && a.mobile.navigate.history.add(v, G));
            }
            ((c.title = B),
              (a.mobile.activePage = b),
              (l.reverse = l.reverse || 0 > A),
              g(b, q, l.transition, l.reverse).done(function (c, d, g, h, i) {
                (e(),
                  l.duplicateCachedPage && l.duplicateCachedPage.remove(),
                  i || a.mobile.focusPage(b),
                  f(),
                  m.trigger("pagechange", p));
              }));
          }
        }),
          ...
          var c = function (b, c) {
            ...
            return !a.mobile.ajaxEnabled ||
              ...
              : ((d = b.attr("action")),
                ...
                (d = n.makeUrlAbsolute(d, k(b))),
                n.isExternal(d) && !n.isPermittedCrossDomainRequest(w, d)
                  ? !1
                  : (c ||
                      ((e = b.serializeArray()),
                      o &&
                        ...
                        f &&
                          ...
                          f && e.push({ name: f, value: o.attr("value") }))),
                      (h = {
                        url: d,
                        options: {
                          type: g,
          ...
          (a.mobile.document.delegate("form", "submit", function (b) {
            ...
            a.mobile.document.bind("vclick", function (b) {
              ...
              if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                ...
                (~g.className.indexOf("ui-link-inherit")
                  ...
                  d.length > 0 && !d.hasClass("ui-disabled") && (e(!0), (p = d), p.addClass(a.mobile.activeBtnClass)));
              }
            }),
            ...
            a.mobile.document.delegate(".ui-page", "pageshow.prefetch", function () {
              ...
              a(this)
                ...
                .each(function () {
                  ...
                  d &&
                    -1 === a.inArray(d, b) &&
                    (b.push(d), a.mobile.loadPage(d, { role: c.attr("data-" + a.mobile.ns + "rel"), prefetch: !0 }));
                });
            }),
            (a.mobile._handleHashChange = function (c, e) {
              var f = n.stripHash(c),
                g = 0 === a.mobile.urlHistory.stack.length ? "none" : d,
                h = { changeHash: !1, fromHashChange: !0, reverse: "back" === e.direction };
              if (
                (a.extend(h, e, { transition: (r.getLast() || {}).transition || g }),
                r.activeIndex > 0 && f.indexOf(u) > -1 && r.initialDst !== f)
              ) {
                if (a.mobile.activePage && !a.mobile.activePage.is(".ui-dialog"))
                  return ("back" === e.direction ? a.mobile.back() : b.history.forward(), void 0);
                f = e.pageUrl;
                var i = a.mobile.urlHistory.getActive();
                a.extend(h, { role: i.role, transition: i.transition, reverse: "back" === e.direction });
              }
              f
                ? ((f = n.isPath(f) ? f : n.makeUrlAbsolute("#" + f, x)),
                  f === n.makeUrlAbsolute("#" + r.initialDst, x) &&
                    r.stack.length &&
                    r.stack[0].url !== r.initialDst.replace(u, "") &&
                    (f = a.mobile.firstPage),
                  a.mobile.changePage(f, h))
            ...
            l.bind("navigate", function (b, c) {
              ...
              (b.originalEvent && b.originalEvent.isDefaultPrevented()) ||
                ((d =
                  a.event.special.navigate.originalEventName.indexOf("hashchange") > -1 ? c.state.hash : c.state.url),
    ...
    (function (a) {
      ((a.mobile.page.prototype.options.degradeInputs = {
        ...
        a.mobile.document.bind("pagecreate create", function (b) {
          var c,
            d = a.mobile.closestPageData(a(b.target));
          d &&
            ((c = d.options),
            a(b.target)
              .find("input")
              .not(d.keepNativeSelector())
              .each(function () {
                var b = a(this),
      ...
      (a.widget("mobile.dialog", a.mobile.widget, {
        ...
        _create: function () {
          var b = this.element,
            ...
            d = a("<div/>", { role: "dialog", class: "ui-dialog-contain ui-overlay-shadow" + c });
          (b.addClass("ui-dialog ui-overlay-" + this.options.overlayTheme),
            b.wrapInner(d),
            b.bind("vclick submit", function (b) {
              var c,
              ...
              d.length &&
                ...
                d
                  .attr("data-" + a.mobile.ns + "transition", c.transition || a.mobile.defaultDialogTransition)
                  .attr("data-" + a.mobile.ns + "direction", "reverse"));
            }),
        ...
        _setCloseBtn: function (b) {
          ...
          (this._headerCloseButton && (this._headerCloseButton.remove(), (this._headerCloseButton = null)),
            "none" !== b &&
              ...
              this.element.children().find(":jqmData(role='header')").first().prepend(c),
              this._createComplete && a.fn.buttonMarkup && c.buttonMarkup(),
              (this._createComplete = !0),
        ...
        close: function () {
          var b,
            c,
            d = a.mobile.navigate.history;
          this._isCloseable &&
            ((this._isCloseable = !1),
            a.mobile.hashListeningEnabled && d.activeIndex > 0
              ? a.mobile.back()
              : ((b = Math.max(0, d.activeIndex - 1)),
                (c = d.stack[b].pageUrl || d.stack[b].url),
                (d.previousIndex = d.activeIndex),
                (d.activeIndex = b),
                a.mobile.path.isPath(c) || (c = a.mobile.path.makeUrlAbsolute("#" + c)),
                a.mobile.changePage(c, { direction: "back", changeHash: !1, fromHashChange: !0 })));
        },
      }),
      ...
      ((a.mobile.page.prototype.options.backBtnText = "Back"),
        ...
        a.mobile.document.bind("pagecreate", function (b) {
          var c = a(b.target),
            ...
            e = c.jqmData("role"),
            f = d.theme;
          a(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", c)
            .jqmEnhanceable()
            .each(function () {
              var b,
                g,
              ...
              if ((j.addClass("ui-" + k), "header" === k || "footer" === k)) {
                ...
                (j.addClass("ui-bar-" + n).attr("role", "header" === k ? "banner" : "contentinfo"),
                  "header" === k &&
                    ((b = j.children("a, button")),
                    (g = b.hasClass("ui-btn-left")),
                    (h = b.hasClass("ui-btn-right")),
                    (g = g || b.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length),
                    (h = h || b.eq(1).addClass("ui-btn-right").length)),
                  d.addBackBtn &&
                    "header" === k &&
                    a(".ui-page").length > 1 &&
                    c.jqmData("url") !== a.mobile.path.stripHash(location.hash) &&
                    !g &&
                    (i = a(
                      ...
                      .attr("data-" + a.mobile.ns + "theme", d.backBtnTheme || n)
                      .prependTo(j)),
                  j
    ...
    (function (a, b) {
      function d(a) {
        for (
          var b;
          a &&
          ((b = "string" == typeof a.className && a.className + " "),
          !(b && b.indexOf("ui-btn ") > -1 && b.indexOf("ui-disabled ") < 0));
        )
          a = a.parentNode;
        return a;
      }
      ...
      ((a.fn.buttonMarkup = function (d) {
        ...
        for (var j = 0; j < h.length; j++) {
          ...
          for (
            p = a.data("INPUT" === r.tagName || "BUTTON" === r.tagName ? r.parentNode : r, "buttonElements"),
              p
                ? ((r = p.outer),
                  (q = a(r)),
                  (m = p.inner),
                  ...
                  (v = p.hover),
                  (w = p.state))
                : ((m = c.createElement(s.wrapperEls)), (n = c.createElement(s.wrapperEls))),
              o = s.icon ? c.createElement("span") : null,
              g && !p && g(),
              s.theme || (s.theme = a.mobile.getInheritedTheme(q, "c")),
              k = "ui-btn ",
              k += v ? "ui-btn-hover-" + s.theme : "",
              k += w ? " ui-btn-" + w + "-" + s.theme : "",
              k += s.shadow ? " ui-shadow" : "",
              k += s.corners ? " ui-btn-corner-all" : "",
              s.mini !== b && (k += s.mini === !0 ? " ui-mini" : " ui-fullsize"),
              s.inline !== b && (k += s.inline === !0 ? " ui-btn-inline" : " ui-btn-block"),
              s.icon &&
                ((s.icon = "ui-icon-" + s.icon),
                (s.iconpos = s.iconpos || "left"),
                (l = "ui-icon " + s.icon),
                s.iconshadow && (l += " ui-icon-shadow")),
              s.iconpos &&
                ((k += " ui-btn-icon-" + s.iconpos),
                "notext" !== s.iconpos || q.attr("title") || q.attr("title", q.getEncodedText())),
              p && q.removeClass(p.bcls || ""),
              q.removeClass("ui-link").addClass(k),
              m.className = t,
              n.className = u,
              p || m.appendChild(n),
              o && ((o.className = l), (p && p.icon) || ((o.innerHTML = "&#160;"), m.appendChild(o)));
            r.firstChild && !p;
          )
            n.appendChild(r.firstChild);
          (p || r.appendChild(m),
            (p = { hover: v, state: w, bcls: k, outer: r, inner: m, text: n, icon: o }),
            a.data(r, "buttonElements", p),
            a.data(m, "buttonElements", p),
            a.data(n, "buttonElements", p),
            o && a.data(o, "buttonElements", p));
        }
        return this;
      }),
      ...
      var g = function () {
        var c,
          f,
          h = a.mobile.buttonMarkup.hoverDelay;
            ...
            j.length &&
              ...
              "vmousedown" === l
                ? k
                  ...
                  : e(j, "ui-btn-up-" + i, "ui-btn-down-" + i, b, "down")
                : "vmousecancel" === l || "vmouseup" === l
                  ? e(j, "ui-btn-down-" + i, "ui-btn-up-" + i, b, "up")
                  : "vmouseover" === l || "focus" === l
                    ? k
                      ? (f = setTimeout(function () {
                          e(j, "ui-btn-up-" + i, "ui-btn-hover-" + i, !0, "");
                        }, h))
                      : e(j, "ui-btn-up-" + i, "ui-btn-hover-" + i, !0, "")
                    : ("vmouseout" === l || "blur" === l || "scrollstart" === l) &&
                      (e(j, "ui-btn-hover-" + i + " ui-btn-down-" + i, "ui-btn-up-" + i, !1, "up"),
                      c && clearTimeout(c),
                      f && clearTimeout(f)));
          },
      ...
      (a.widget("mobile.collapsible", a.mobile.widget, {
        ...
        _create: function () {
          ...
          (f.is("legend") && ((f = a("<div role='heading'>" + f.html() + "</div>").insertBefore(f)), f.next().remove()),
            h.length
              ? (d.theme || (d.theme = h.jqmData("theme") || a.mobile.getInheritedTheme(h, "c")),
                d.contentTheme || (d.contentTheme = h.jqmData("content-theme")),
                (d.collapsedIcon = c.jqmData("collapsed-icon") || h.jqmData("collapsed-icon") || d.collapsedIcon),
                (d.expandedIcon = c.jqmData("expanded-icon") || h.jqmData("expanded-icon") || d.expandedIcon),
                (d.iconpos = c.jqmData("iconpos") || h.jqmData("iconpos") || d.iconpos),
                (d.inset = h.jqmData("inset") !== b ? h.jqmData("inset") : !0),
                (d.corners = !1),
                d.mini || (d.mini = h.jqmData("mini")))
              : d.theme || (d.theme = a.mobile.getInheritedTheme(c, "c")),
            d.inset && ((i += " ui-collapsible-inset"), d.corners && (i += " ui-corner-all")),
            d.contentTheme && ((i += " ui-collapsible-themed-content"), g.addClass("ui-body-" + d.contentTheme)),
            "" !== i && e.addClass(i),
            f
              .insertBefore(g)
            ...
            e
              .bind("expand collapse", function (b) {
                if (!b.isDefaultPrevented()) {
                  var c = a(this),
                    e = "collapse" === b.type;
                  (b.preventDefault(),
                    f
                      .toggleClass("ui-collapsible-heading-collapsed", e)
                      .find(".ui-collapsible-heading-status")
                      .text(e ? d.expandCueText : d.collapseCueText)
                      .end()
                      .find(".ui-icon")
                      .toggleClass("ui-icon-" + d.expandedIcon, !e)
                      .toggleClass("ui-icon-" + d.collapsedIcon, e || d.expandedIcon === d.collapsedIcon)
                      .end()
                      .find("a")
                      .first()
                      .removeClass(a.mobile.activeBtnClass),
                    c.toggleClass("ui-collapsible-collapsed", e),
                    g.toggleClass("ui-collapsible-content-collapsed", e).attr("aria-hidden", e),
        ...
        _getVisibles: function (a, b) {
          ...
          return (
            b
              ...
              : ((c = a.filter(":visible")), 0 === c.length && (c = a.not(".ui-screen-hidden"))),
            c
          );
        },
        ...
        a.extend(
          {
            ...
            _create: function () {
              var c = this.element.addClass("ui-collapsible-set"),
                d = this.options;
              (d.theme || (d.theme = a.mobile.getInheritedTheme(c, "c")),
                d.contentTheme || (d.contentTheme = c.jqmData("content-theme")),
                d.corners || (d.corners = c.jqmData("corners")),
                c.jqmData("inset") !== b && (d.inset = c.jqmData("inset")),
                (d.inset = d.inset !== b ? d.inset : !0),
                (d.corners = d.corners !== b ? d.corners : !0),
                d.corners && d.inset && c.addClass("ui-corner-all"),
                c.jqmData("collapsiblebound") ||
                  c.jqmData("collapsiblebound", !0).bind("expand", function (b) {
                    var c = a(b.target).closest(".ui-collapsible");
                    c.parent().is(":jqmData(role='collapsible-set')") &&
                      c.siblings(".ui-collapsible").trigger("collapse");
                  }));
            },
            _init: function () {
              var a = this.element,
            ...
            _refresh: function (b) {
              ...
              (a.mobile.collapsible.prototype.enhance(c.not(".ui-collapsible")),
                this._addFirstLastClasses(c, this._getVisibles(c, b), b));
            },
            refresh: function () {
              this._refresh(!1);
            },
    ...
    (function (a) {
      a.fn.grid = function (b) {
        return this.each(function () {
          var c,
            d = a(this),
            e = a.extend({ grid: null }, b),
            f = d.children(),
            g = { solo: 1, a: 2, b: 3, c: 4, d: 5 },
            h = e.grid;
          if (!h)
            if (f.length <= 5) for (var i in g) g[i] === f.length && (h = i);
            else ((h = "a"), d.addClass("ui-grid-duo"));
          ((c = g[h]),
            d.addClass("ui-grid-" + h),
            f.filter(":nth-child(" + c + "n+1)").addClass("ui-block-a"),
            c > 1 && f.filter(":nth-child(" + c + "n+2)").addClass("ui-block-b"),
            c > 2 && f.filter(":nth-child(" + c + "n+3)").addClass("ui-block-c"),
            c > 3 && f.filter(":nth-child(" + c + "n+4)").addClass("ui-block-d"),
            c > 4 && f.filter(":nth-child(" + c + "n+5)").addClass("ui-block-e"));
        });
      };
    })(a),
    (function (a, b) {
      (a.widget("mobile.navbar", a.mobile.widget, {
        ...
        _create: function () {
          ...
          (d
            ...
            e.buttonMarkup({ corners: !1, shadow: !1, inline: !0, iconpos: f }),
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              ((b += a.options.inset ? " ui-listview-inset" : ""),
                a.options.inset &&
                  ((b += a.options.corners ? " ui-corner-all" : ""), (b += a.options.shadow ? " ui-shadow" : "")),
                a.element.addClass(function (a, c) {
            ...
            _addThumbClasses: function (b) {
              ...
              for (c = 0; e > c; c++)
                ((d = a(this._findFirstElementByTagName(b[c].firstChild, "nextSibling", "img", "IMG"))),
                  d.length &&
                    (d.addClass("ui-li-thumb"),
                    a(this._findFirstElementByTagName(d[0].parentNode, "parentNode", "li", "LI")).addClass(
                      d.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb",
                    )));
            },
            refresh: function (b) {
              ...
              var d,
                ...
                y = q.attr("start"),
                z = {};
              (w && x && q.find(".ui-li-dec").remove(),
                w &&
                  (y || 0 === y
                    ? x
                      ? (j = parseInt(y, 10))
                      : ((k = parseInt(y, 10) - 1), q.css("counter-reset", "listnumbering " + k))
                    : x && (j = 1)),
                p.theme || (p.theme = a.mobile.getInheritedTheme(this.element, "c")));
                ...
                if (((d = v.eq(A)), (e = "ui-li"), b || !d.hasClass("ui-li"))) {
                  ...
                  g.length && !C
                    ? ((n = d.jqmData("icon")),
                      ...
                      n !== !1 && 1 === g.length && d.addClass("ui-li-has-arrow"),
                      g.first().removeClass("ui-link").addClass("ui-link-inherit"),
                      g.length > 1 &&
                        ((e += " ui-li-has-alt"),
                        (h = g.last()),
                        (i = s || h.jqmData("theme") || p.splitTheme),
                        (o = h.jqmData("icon")),
                        h
                          .appendTo(d)
                          .attr("title", a.trim(h.getEncodedText()))
                          .addClass("ui-li-link-alt")
                          .empty()
                          .buttonMarkup({ shadow: !1, corners: !1, theme: f, icon: !1, iconpos: "notext" })
                          .find(".ui-btn-inner")
                          .append(
                            a(c.createElement("span")).buttonMarkup({
                              shadow: !0,
                              corners: !0,
                              theme: i,
                              iconpos: "notext",
                    ...
                    : C
                      ? ((e += " ui-li-divider ui-bar-" + (d.jqmData("theme") || r)),
                        d.attr("role", "heading"),
                        w &&
                          (y || 0 === y
                            ? x
                              ? (j = parseInt(y, 10))
                              : ((l = parseInt(y, 10) - 1), d.css("counter-reset", "listnumbering " + l))
                            : x && (j = 1)))
                      : (e += " ui-li-static ui-btn-up-" + f);
                }
                (w &&
                  x &&
                  e.indexOf("ui-li-divider") < 0 &&
                  ((m = e.indexOf("ui-li-static") > 0 ? d : d.find(".ui-link-inherit")),
                  m.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>" + j++ + ". </span>")),
                  z[e] || (z[e] = []),
                  z[e].push(d[0]));
              }
              ...
              (q
                ...
                .addClass("ui-btn-up-" + (q.jqmData("counttheme") || this.options.countTheme) + " ui-btn-corner-all"),
                this._addThumbClasses(v),
                this._addThumbClasses(q.find(".ui-link-inherit")),
                this._addFirstLastClasses(v, this._getVisibles(v, b), b),
            ...
            _createSubPages: function () {
              ...
              if (
                ...
                (h = h || ++b[g]),
                a(d.find("li>ul, li>ol").toArray().reverse())
                  .each(function (b) {
                    var e,
                      g,
                      k = a(this),
                    ...
                    ((c = !0),
                      (e = k
                        ...
                        .after(l ? a("<div " + j + "role='footer' " + j + "id='" + l + "'>") : "")
                        .parent()
                  ...
                  .listview(),
                c && e.is(":jqmData(external-page='true')") && e.data("mobile-page").options.domCache === !1)
              ) {
                var m = function (b, c) {
                  var d,
                    g = c.nextPage,
                  ...
                  c.nextPage &&
                    ((d = g.jqmData("url")),
                    0 !== d.indexOf(f + "&" + a.mobile.subPageUrlKey) &&
                      (k.childPages().remove(), e.trigger(h), h.isDefaultPrevented() || e.removeWithDependents()));
                };
        ...
        {},
        {
          ...
          disable: function (c) {
            f ||
              ...
              (b.attr("content", d), (a.mobile.zoom.enabled = !1), (a.mobile.zoom.locked = c || !1));
          },
          enable: function (c) {
            f ||
              (a.mobile.zoom.locked && c !== !0) ||
              (b.attr("content", e), (a.mobile.zoom.enabled = !0), (a.mobile.zoom.locked = !1));
          },
          restore: function () {
    ...
    (function (a) {
      (a.widget("mobile.textinput", a.mobile.widget, {
        ...
        _create: function () {
          ...
          if (
            (a("label[for='" + f.attr("id") + "']").addClass("ui-input-text"),
            (c = f.addClass("ui-input-text ui-body-" + h)),
            "undefined" == typeof f[0].autocorrect ||
              a.support.touchOverflow ||
              (f[0].setAttribute("autocorrect", "off"), f[0].setAttribute("autocomplete", "off")),
            k
              ? (c = f
                  .wrap(
              ...
              : o &&
                (c = f
                  .wrap("<div class='ui-input-text ui-shadow-inset ui-corner-all ui-btn-shadow" + i + j + "'></div>")
                  .parent()),
            n || k
              ? ((d = a("<a href='#' class='ui-input-clear' title='" + l + "'>" + l + "</a>")
                  .bind("click", function (a) {
                    (f.val("").focus().trigger("change"), d.addClass("ui-input-clear-hidden"), a.preventDefault());
                  })
                  .appendTo(c)
                  .buttonMarkup({ icon: "delete", iconpos: "notext", corners: !0, shadow: !0, mini: g.mini })),
                k || c.addClass("ui-input-has-clear"),
                b(),
                f.bind("paste cut keyup input focus change blur", b))
              : o || k || f.addClass("ui-corner-all ui-shadow-inset" + i + j),
            f
              .focus(function () {
            ...
            ((this._keyup = function () {
              ...
              a.trim(f.val()) && this._on(!0, a.mobile.window, { load: "_keyup" }));
          }
          f.attr("disabled") && this.disable();
        },
        disable: function () {
          var a,
            b = this.element.is("[type='search'], :jqmData(type='search')"),
            c = this.element.is("input") && !this.element.is(":jqmData(type='range')"),
            d = this.element.attr("disabled", !0) && (c || b);
          return (
            (a = d ? this.element.parent() : this.element),
    ...
    (function (a) {
      ...
      ((a.mobile.listview.prototype.options.filterCallback = b),
        a.mobile.document.delegate("ul, ol", "listviewcreate", function () {
          ...
          if (d && d.options.filter) {
            ...
            var e = a("<form>", { class: "ui-listview-filter ui-bar-" + d.options.filterTheme, role: "search" }).submit(
                function (a) {
              ...
              f = function () {
                ...
                if (!j || j !== g) {
                  if (
                    (d._trigger("beforefilter", "beforefilter", { input: this }),
                    f.jqmData("lastval", g),
                    m || g.length < j.length || 0 !== g.indexOf(j)
                      ? (h = c.children())
                      : ((h = c.children(":not(.ui-screen-hidden)")),
                        !h.length && d.options.filterReveal && (h = c.children(".ui-screen-hidden"))),
                    g)
                  ) {
                    for (var n = h.length - 1; n >= 0; n--)
                      ((e = a(h[n])),
                        (l = e.jqmData("filtertext") || e.text()),
                        e.is("li:jqmData(role=list-divider)")
                          ? (e.toggleClass("ui-filter-hidequeue", !k), (k = !1))
                          : d.options.filterCallback(l, g, e)
                            ? e.toggleClass("ui-filter-hidequeue", !0)
                            : (k = !0));
                    (h.filter(":not(.ui-filter-hidequeue)").toggleClass("ui-screen-hidden", !1),
                      h
                        .filter(".ui-filter-hidequeue")
                        .toggleClass("ui-screen-hidden", !0)
                        .toggleClass("ui-filter-hidequeue", !1));
                  } else h.toggleClass("ui-screen-hidden", !!d.options.filterReveal);
                  d._addFirstLastClasses(i, d._getVisibles(i, !1), !1);
                }
              },
              g = a("<input>", { placeholder: d.options.filterPlaceholder })
                .attr("data-" + a.mobile.ns + "type", "search")
                .jqmData("lastval", "")
                .bind("keyup change input", f)
                .appendTo(e)
                .textinput();
            (d.options.inset && e.addClass("ui-listview-filter-inset"),
              e
                ...
                for (var e, f, g = b.find("li"), h = null, i = 0; i < g.length; i++) {
                  if (((e = g[i]), (f = d.options.autodividersSelector(a(e))), f && h !== f)) {
                    ...
                    (j.appendChild(c.createTextNode(f)),
                      j.setAttribute("data-" + a.mobile.ns + "role", "list-divider"),
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              if ("checkbox" === i || "radio" === i) {
                (a.extend(this, {
                  ...
                  e.theme || (e.theme = a.mobile.getInheritedTheme(this.element, "c")),
                  h.buttonMarkup({ theme: e.theme, icon: l, shadow: !1, mini: j, iconpos: m }));
                ...
                ((p.className = "ui-" + i),
                  ...
                  h.bind({
                    ...
                    vclick: function (a) {
                      return d.is(":disabled")
                        ...
                        : (b._cacheVals(),
                          d.prop("checked", ("radio" === i && !0) || !d.prop("checked")),
                          d.triggerHandler("click"),
                          b._getInputSet().not(d).prop("checked", !1),
                          b._updateAll(),
                          !1);
                    },
                  }),
                  d.bind({
                    ...
                    vclick: function () {
                      var c = a(this);
                      (c.is(":checked")
                        ? (c.prop("checked", !0), b._getInputSet().not(c).prop("checked", !1))
                        : c.prop("checked", !1),
                        b._updateAll());
                    },
                    focus: function () {
            ...
            refresh: function () {
              ...
              (b.checked
                ? e
                    .removeClass(this.uncheckedClass + c)
                    .addClass(d)
                    .buttonMarkup({ icon: this.checkedicon })
                : e.removeClass(d).addClass(this.uncheckedClass).buttonMarkup({ icon: this.uncheckedicon }),
      ...
      (a.widget("mobile.button", a.mobile.widget, {
        ...
        _create: function () {
          var b,
            ...
            e = "";
          return "A" === c[0].tagName
            ? (c.hasClass("ui-btn") || c.buttonMarkup(), void 0)
            : (this.options.theme || (this.options.theme = a.mobile.getInheritedTheme(this.element, "c")),
              ~c[0].className.indexOf("ui-btn-left") && (e = "ui-btn-left"),
              ~c[0].className.indexOf("ui-btn-right") && (e = "ui-btn-right"),
              ("submit" === c.attr("type") || "reset" === c.attr("type")) &&
                (e ? (e += " ui-submit") : (e = "ui-submit")),
              a("label[for='" + c.attr("id") + "']").addClass("ui-submit"),
              (this.button = a("<div></div>")
                [c.html() ? "html" : "text"](c.html() || c.val())
                .insertBefore(c)
                .buttonMarkup(d)
                .addClass(e)
                .append(c.addClass("ui-btn-hidden"))),
              (b = this.button),
              c.bind({
                focus: function () {
        ...
        _setOption: function (b, c) {
          ...
          ((d[b] = c),
            "initSelector" !== b &&
              (this.button.buttonMarkup(d),
              this.element.attr("data-" + (a.mobile.ns || "") + b.replace(/([A-Z])/, "-$1").toLowerCase(), c)),
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              if (
                (w.setAttribute("href", "#"),
                y.setAttribute("role", "application"),
                (y.className = [
                ...
                (w.className = "ui-slider-handle"),
                y.appendChild(w),
                x
                  .buttonMarkup({ corners: !0, theme: j, shadow: !0 })
                  .attr({
                    role: "slider",
                    "aria-valuemin": s,
                    "aria-valuemax": t,
                ...
                for (var D = 0, E = e.length; E > D; D++) {
                  ...
                  ((H.className = ["ui-slider-label ui-slider-label-", F, G, " ui-btn-corner-all"].join("")),
                    H.setAttribute("role", "img"),
                    H.appendChild(c.createTextNode(e[D].innerHTML)),
                    a(H).prependTo(z));
                }
                g._labels = a(".ui-slider-label", z);
              }
              (r.addClass("ui-slider"),
                h.addClass(this.isToggleSwitch ? "ui-slider-switch" : "ui-slider-input"),
                this._on(h, {
                ...
                z.bind("vmousedown", a.proxy(this._sliderVMouseDown, this)).bind("vclick", !1),
                this._on(c, { vmousemove: "_preventDocumentDrag" }),
                this._on(z.add(c), { vmouseup: "_sliderVMouseUp" }),
                z.insertAfter(h),
                this.isToggleSwitch ||
                  m ||
                  ((f = this.options.mini ? "<div class='ui-slider ui-mini'>" : "<div class='ui-slider'>"),
                  h.add(z).wrapAll(f)),
                this.isToggleSwitch &&
                  this.handle.bind({
                    focus: function () {
            ...
            _controlChange: function (a) {
              return this._trigger("controlchange", a) === !1
                ? !1
                : (this.mouseMoved || this.refresh(this._value(), !0), void 0);
            },
            ...
            _sliderVMouseDown: function (a) {
              return this.options.disabled || (1 !== a.which && 0 !== a.which && a.which !== d)
                ? !1
            ...
            refresh: function (b, d, e) {
              ...
              if ("object" == typeof b) {
                ...
                (null == b && (b = q ? parseFloat(p.val() || 0) : p[0].selectedIndex),
                  (o = 100 * ((parseFloat(b) - s) / (t - s))));
              if (!isNaN(o)) {
                var v = (o / 100) * (t - s) + s,
                  w = (v - s) % u,
                  x = v - w;
                ...
                if (
                  ...
                  this.handle[0].setAttribute("aria-valuenow", q ? v : r.eq(v).attr("value")),
                  this.handle[0].setAttribute("aria-valuetext", q ? v : r.eq(v).getEncodedText()),
                  this.handle[0].setAttribute("title", q ? v : r.eq(v).getEncodedText()),
                  this.valuebg && this.valuebg.css("width", o + "%"),
                  this._labels)
                ) {
                ...
                if (!e) {
                  var C = !1;
                  if (
                    (q ? ((C = p.val() !== v), p.val(v)) : ((C = p[0].selectedIndex !== v), (p[0].selectedIndex = v)),
    ...
    (function (a) {
      (a.widget("mobile.rangeslider", a.mobile.widget, {
        ...
        _create: function () {
          ...
          (c.find("label").length > 1 && (b = c.find("label").last().hide()),
            e.addClass("ui-rangeslider-first"),
        ...
        _slidedrag: function (b) {
          ...
          return (
            ...
            ("first" === this._proxy && c) || ("last" === this._proxy && !c)
              ? ((a.data(d.get(0), "mobileSlider").dragging = !0), a.data(d.get(0), "mobileSlider").refresh(b), !1)
              : void 0
          );
        },
        ...
        _slidebeforestart: function (b) {
          ((this._sliderTarget = !1),
            a(b.originalEvent.target).hasClass("ui-slider-track") &&
              ((this._sliderTarget = !0), (this._targetVal = a(b.target).val())));
        },
        ...
        _change: function (b) {
          ...
          return (
            d > e && !this._sliderTarget
              ? (g.val(f ? e : d).slider("refresh"), this._trigger("normalize"))
              : d > e &&
            ...
            d === e
              ? (a.data(g.get(0), "mobileSlider").handle.css("z-index", 1),
                a.data(h.get(0), "mobileSlider").handle.css("z-index", 0))
              : (a.data(h.get(0), "mobileSlider").handle.css("z-index", ""),
                a.data(g.get(0), "mobileSlider").handle.css("z-index", "")),
            this._updateHighlight(),
            d >= e ? !1 : void 0
          );
        },
        ...
        a.extend(
          {
            ...
            _preExtension: function () {
              ...
              (~this.element[0].className.indexOf("ui-btn-left") && (b = " ui-btn-left"),
                ...
                (this.select = this.element
                  ...
                  .wrap("<div class='ui-select" + b + "'>")),
                (this.selectID = this.select.attr("id")),
                (this.label = a("label[for='" + this.selectID + "']").addClass("ui-select")),
                (this.isMultiple = this.select[0].multiple),
                this.options.theme || (this.options.theme = a.mobile.getInheritedTheme(this.select, "c")));
            },
            _destroy: function () {
              var a = this.element.parents(".ui-select");
              a.length > 0 &&
                (a.is(".ui-btn-left, .ui-btn-right") &&
                  this.element.addClass(a.is(".ui-btn-left") ? "ui-btn-left" : "ui-btn-right"),
            ...
            _create: function () {
              ...
              var c = this,
                ...
                h =
                  (-1 === this.select[0].selectedIndex ? 0 : this.select[0].selectedIndex,
                  this.button
              ...
              (this.setButtonText(),
                d.nativeMenu && b.opera && b.opera.version && h.addClass("ui-select-nativeonly"),
                this.isMultiple &&
                  (this.buttonCount = a("<span>")
                    .addClass("ui-li-count ui-btn-up-c ui-btn-corner-all")
                    .hide()
                    .appendTo(h.addClass("ui-li-has-count"))),
                ...
                return (
                  (e = d.length
                    ? d
                        ...
                        .join(", ")
                    : b.placeholder),
                  f.text(e).addClass(b.select.attr("class")).addClass(d.attr("class"))
                );
              });
            },
    ...
    (function (a, d) {
      ...
      (a.widget("mobile.popup", a.mobile.widget, {
        ...
        _expectResizeEvent: function () {
          ...
          if (this._resizeData) {
            if (
              b.x === this._resizeData.winCoords.x &&
          ...
          return (
            (this._resizeData = { timeoutId: setTimeout(a.proxy(this, "_resizeTimeout"), 200), winCoords: b }),
            !0
          );
        },
        ...
        _handleWindowOrientationchange: function () {
          !this._orientationchangeInProgress &&
            this._isOpen &&
            0 === this._ignoreResizeTo &&
            (this._expectResizeEvent(), (this._orientationchangeInProgress = !0));
        },
        _handleDocumentFocusIn: function (b) {
          ...
          if (this._isOpen) {
            if (e !== f.container[0]) {
              if (((d = a(b.target)), 0 === d.parents().filter(f.container[0]).length))
                return (
                  a(c.activeElement).one("focus", function () {
                    d.blur();
                  }),
        ...
        _create: function () {
          ...
          ((e.history = e.history && a.mobile.ajaxEnabled && a.mobile.hashListeningEnabled),
            0 === c.length && (c = a("body")),
            (e.container = e.container || a.mobile.pageContainer || c),
            c.append(b.screen),
            b.container.insertAfter(b.screen),
            b.placeholder.insertAfter(this.element),
            d &&
              (b.screen.attr("id", d + "-screen"),
              b.container.attr("id", d + "-popup"),
              b.placeholder.html("<!-- placeholder for " + d + " -->")),
            b.container.append(this.element),
            (b.focusElement = b.container),
            ...
            this._applyTheme(this.element, e.theme, "body"),
            this._applyTheme(this._ui.screen, e.overlayTheme, "overlay"),
            this._applyTransition(e.transition),
            this.element.toggleClass("ui-overlay-shadow", e.shadow).toggleClass("ui-corner-all", e.corners),
            this._setTolerance(e.tolerance),
            b.screen.bind("vclick", a.proxy(this, "_eatEventAndClose")),
        ...
        _applyTheme: function (a, b, c) {
          ...
          b !== f &&
            (a.removeClass("ui-" + c + "-" + f), null !== b && "none" !== b && a.addClass("ui-" + c + "-" + g));
        },
        ...
        _applyTransition: function (b) {
          (this._ui.container.removeClass(this._fallbackTransition),
            b &&
              "none" !== b &&
              ((this._fallbackTransition = a.mobile._maybeDegradeTransition(b)),
        ...
        _placementCoords: function (a) {
          ...
          (this._ui.container.css("max-width", h.cx),
            (b = { cx: this._ui.container.outerWidth(!0), cy: this._ui.container.outerHeight(!0) }),
            (d = { x: e(h.cx, b.cx, h.x, a.x), y: e(h.cy, b.cy, h.y, a.y) }),
            (d.y = Math.max(0, d.y)));
        ...
        _animate: function (b) {
          return (
            ...
            b.transition &&
            "none" !== b.transition &&
            (b.applyTransition && this._applyTransition(b.transition), this._fallbackTransition)
              ? (this._ui.container
                  .animationComplete(a.proxy(b.prereqs.container, "resolve"))
                  .addClass(b.containerClassToAdd)
                  .removeClass(b.classToRemove),
                void 0)
              : (this._ui.container.removeClass(b.classToRemove), b.prereqs.container.resolve(), void 0)
          );
        },
        _desiredCoords: function (b) {
          var c,
            ...
            i = b.positionTo;
          if (i && "origin" !== i)
            if ("window" === i) ((g = e.cx / 2 + e.x), (h = e.cy / 2 + e.y));
            else {
              try {
                d = a(i);
              } catch (j) {
          ...
          return (
            d && ((c = d.offset()), (g = c.left + d.outerWidth() / 2), (h = c.top + d.outerHeight() / 2)),
            ("number" !== a.type(g) || isNaN(g)) && (g = e.cx / 2 + e.x),
        ...
        _open: function (b) {
          ...
          (this._createPrereqs(a.noop, a.noop, a.proxy(this, "_openPrereqsComplete")),
            ...
            this.options.theme ||
              this._setTheme(this._page.jqmData("theme") || a.mobile.getInheritedTheme(this._page, "c")),
        ...
        _close: function (b) {
          (this._ui.container.removeClass("ui-popup-active"),
            ...
            (this._isOpen = !1),
            this._createPrereqs(
              a.proxy(this, "_closePrereqScreen"),
              a.proxy(this, "_closePrereqContainer"),
        ...
        _destroy: function () {
          a.mobile.popup.active === this
            ? (this.element.one("popupafterclose", a.proxy(this, "_unenhance")), this.close())
            : this._unenhance();
        },
        _closePopup: function (c, d) {
          ...
          (b.scrollTo(0, this._scrollTop),
            c &&
              ...
              d &&
              ((e = "string" == typeof d.toPage ? d.toPage : d.toPage.jqmData("url")),
        ...
        open: function (c) {
          ...
          if (!a.mobile.popup.active) {
            if (((a.mobile.popup.active = this), (this._scrollTop = a.mobile.window.scrollTop()), !k.history))
              return (
                j._open(c),
                j._bindContainerClose(),
                j.element.delegate(k.closeLinkSelector, k.closeLinkEvents, function (a) {
                  (j.close(), a.preventDefault());
                }),
                void 0
              );
            if (
              ((i = a.mobile.urlHistory),
              (e = a.mobile.dialogHashKey),
              (f = a.mobile.activePage),
              (g = f.is(".ui-dialog")),
              (this._myUrl = d = i.getActive().url),
              (h = d.indexOf(e) > -1 && !g && i.activeIndex > 0))
            )
              return (j._open(c), j._bindContainerClose(), void 0);
            (-1 !== d.indexOf(e) || g
              ? (d = a.mobile.path.parseLocation().hash + e)
              : (d += d.indexOf("#") > -1 ? e : "#" + e),
              0 === i.activeIndex && d === i.initialDst && (d += e),
              a(b).one("beforenavigate", function (a) {
                (a.preventDefault(), j._open(c), j._bindContainerClose());
              }),
              (this.urlAltered = !0),
              a.mobile.navigate(d, { role: "dialog" }));
          }
        },
        close: function () {
          a.mobile.popup.active === this &&
            ((this._scrollTop = a.mobile.window.scrollTop()),
    ...
    (function (a, b) {
      var d = function (d) {
        var e,
          ...
          t = a("<div id='" + k + "' class='ui-selectmenu'>")
            .insertAfter(d.select)
            .popup({ theme: d.options.overlayTheme }),
          u = a("<ul>", { class: "ui-selectmenu-list", id: r, role: "listbox", "aria-labelledby": q })
            .attr("data-" + a.mobile.ns + "theme", d.options.theme)
            .attr("data-" + a.mobile.ns + "divider-theme", d.options.dividerTheme)
            .appendTo(t),
          v = a("<div>", { class: "ui-header ui-bar-" + d.options.theme }).prependTo(t),
          w = a("<h1>", { class: "ui-title" }).appendTo(v);
        (d.isMultiple &&
          (g = a("<a>", { text: d.options.closeText, href: "#", class: "ui-btn-left" })
            .attr("data-" + a.mobile.ns + "iconpos", "notext")
            .attr("data-" + a.mobile.ns + "icon", "delete")
            .appendTo(v)
            .buttonMarkup()),
          a.extend(d, {
            select: d.select,
            ...
            build: function () {
              ...
              (c.refresh(),
                c._origTabIndex === b &&
                  (c._origTabIndex = null === c.select[0].getAttribute("tabindex") ? !1 : c.select.attr("tabindex")),
                ...
                c.button.bind("vclick keydown", function (b) {
                  c.options.disabled ||
                    c.isOpen ||
                    (("vclick" === b.type ||
                      (b.keyCode && (b.keyCode === a.mobile.keyCode.ENTER || b.keyCode === a.mobile.keyCode.SPACE))) &&
                      (c._decideFormat(),
                      "overlay" === c.menuType
                        ? c.button.attr("href", "#" + e(c.popupID)).attr("data-" + (a.mobile.ns || "") + "rel", "popup")
                        : c.button
                            .attr("href", "#" + e(c.dialogID))
                ...
                c.list
                  ...
                  .delegate("li:not(.ui-disabled, .ui-li-divider)", "click", function (b) {
                    ...
                    ((g.selected = c.isMultiple ? !g.selected : !0),
                      c.isMultiple &&
                        a(this)
                          .find(".ui-icon")
                          .toggleClass("ui-icon-checkbox-on", g.selected)
                          .toggleClass("ui-icon-checkbox-off", !g.selected),
                      (c.isMultiple || e !== f) && c.select.trigger("change"),
                      c.isMultiple
                        ? c.list
                            .find("li:not(.ui-li-divider)")
                            .eq(f)
                            .addClass("ui-btn-down-" + d.options.theme)
                            .find("a")
                            .first()
                            .focus()
                        : c.close(),
                  ...
                  .keydown(function (b) {
                    ...
                    switch (b.keyCode) {
                      case 38:
                        return (
                          (c = g.prev().not(".ui-selectmenu-placeholder")),
                          c.is(".ui-li-divider") && (c = c.prev()),
                          c.length &&
                    ...
                    if (a.inArray(b, c) > -1) {
                      ...
                      (e.attr("aria-selected", !0),
                        d.isMultiple
                          ...
                          : e.is(".ui-selectmenu-placeholder")
                            ? e.next().addClass(a.mobile.activeBtnClass)
                            : e.addClass(a.mobile.activeBtnClass));
                    }
                  }));
            },
            close: function () {
            ...
            _decideFormat: function () {
              function b() {
                ...
                (0 === b.length && (b = c.list.find("li.ui-btn:not( :jqmData(placeholder='true') ) a")),
                  b
                    .first()
                    .focus()
                    .closest("li")
              ...
              var c = this,
                ...
                j = e.height();
              (e.width(),
                g > j - 80 || !a.support.scrollTop
                  ? (c.menuPage.appendTo(a.mobile.pageContainer).page(),
                    (c.menuPageContent = s.find(".ui-content")),
                    (c.menuPageClose = s.find(".ui-header a")),
                  ...
                  : ((c.menuType = "overlay"), c.listbox.one("popupafteropen", b)));
            },
            _buildList: function () {
              var b = this,
                d = this.options,
              ...
              for (
                ...
                if (
                  (x.setAttribute("href", "#"),
                  x.appendChild(c.createTextNode(w)),
                  v !== k && "optgroup" === v.nodeName.toLowerCase())
                ) {
                  var z = v.getAttribute("label");
                  if (z !== h) {
                    var A = c.createElement("li");
                    (A.setAttribute(o, "list-divider"),
                      A.setAttribute("role", "option"),
                      A.setAttribute("tabindex", "-1"),
                      A.appendChild(c.createTextNode(z)),
                      q.appendChild(A),
                      (h = z));
                  }
                }
                !f ||
                  (t.getAttribute("value") && 0 !== w.length && !u.jqmData("placeholder")) ||
                  ((f = !1),
                  (r = !0),
                  null === t.getAttribute(p) && (this._removePlaceholderAttr = !0),
                  t.setAttribute(p, !0),
                  d.hidePlaceholderMenuItems && y.push("ui-selectmenu-placeholder"),
                  e !== w && (e = b.placeholder = w));
                var B = c.createElement("li");
                (t.disabled && (y.push("ui-disabled"), B.setAttribute("aria-disabled", !0)),
                  B.setAttribute(m, s),
                  B.setAttribute(n, g),
                  r && B.setAttribute(p, !0),
                  (B.className = y.join(" ")),
              ...
              (b.list[0].appendChild(q),
                this.isMultiple || e.length ? this.headerTitle.text(this.placeholder) : this.header.hide(),
                b.list.listview());
            },
            _button: function () {
              return a("<a>", {
        ...
        a.extend(
          {
            ...
            _create: function () {
              var c = this.element,
                ...
                f = this;
              (c.wrapInner(d.inner),
                e.length && d.legend.append(e).insertBefore(c.children(0)),
                c.addClass("ui-corner-all ui-controlgroup"),
            ...
            _setOption: function (c, d) {
              ...
              (this[e] !== b && this[e](d),
                this._super(c, d),
                this.element.attr("data-" + (a.mobile.ns || "") + c.replace(/([A-Z])/, "-$1").toLowerCase(), d));
            },
            _setType: function (a) {
              (this.element
            ...
            refresh: function () {
              ...
              (a.mobile.checkboxradio && this.element.find(":mobile-checkboxradio").checkboxradio("refresh"),
                this._addFirstLastClasses(b, this.options.excludeInvisible ? this._getVisibles(b, c) : b, c),
        ...
        a(b.target)
          ...
          .each(function () {
            ...
            (b.setAttribute("aria-haspopup", !0),
              b.setAttribute("aria-owns", e),
              b.setAttribute("aria-expanded", !1),
              a(c)
                .on("popupafteropen", d, function () {
      ...
      (a.widget("mobile.fixedtoolbar", a.mobile.widget, {
        ...
        _create: function () {
          var b = this,
            ...
            f = d.closest(".ui-page");
          return c.supportBlacklist()
            ? (b.destroy(), void 0)
            : (d.addClass("ui-" + e + "-fixed"),
              c.fullscreen
                ? (d.addClass("ui-" + e + "-fullscreen"), f.addClass("ui-page-" + e + "-fullscreen"))
                : f.addClass("ui-page-" + e + "-fixed"),
              a.extend(this, { _thisPage: null }),
              b._addTransitionClass(),
              b._bindPageEvents(),
              b._bindToggleHandlers(),
              void 0);
        },
        _addTransitionClass: function () {
          ...
          a &&
            "none" !== a &&
            ("slide" === a && (a = this.element.is(".ui-header") ? "slidedown" : "slideup"), this.element.addClass(a));
        },
        ...
        _handlePageBeforeHide: function (b, c) {
          var d = this.options;
          if (
            (d.disablePageZoom && a.mobile.zoom.enable(!0),
            d.updatePagePadding && this._off(a.mobile.window, "throttledresize"),
            d.trackPersistentToolbars)
          ) {
            var e = a(".ui-footer-fixed:jqmData(id)", this._thisPage),
              f = a(".ui-header-fixed:jqmData(id)", this._thisPage),
              g =
                (e.length && c.nextPage && a(".ui-footer-fixed:jqmData(id='" + e.jqmData("id") + "')", c.nextPage)) ||
                a(),
              h =
                (f.length && c.nextPage && a(".ui-header-fixed:jqmData(id='" + f.jqmData("id") + "')", c.nextPage)) ||
                a();
            (g.length || h.length) &&
              (g.add(h).appendTo(a.mobile.pageContainer),
        ...
        updatePagePadding: function (c) {
          ...
          this.options.fullscreen ||
            ((c = (c && c.type === b && c) || this._thisPage || d.closest(".ui-page")),
        ...
        _useTransition: function (b) {
          ...
          return (
            ...
            ((this.options.transition &&
              ...
              (("header" === i && !this.options.fullscreen && e > f) ||
                ("footer" === i && !this.options.fullscreen && g - f > e + h))) ||
              this.options.fullscreen)
          );
        },
        show: function (a) {
        ...
        _bindToggleHandlers: function () {
          ...
          f.closest(".ui-page")
            ...
            .bind("focusin focusout", function (f) {
              screen.width < 1025 &&
                a(f.target).is(e.hideDuringFocus) &&
                !a(f.target).closest(".ui-header-fixed, .ui-footer-fixed").length &&
                ("focusout" !== f.type || g
                  ? "focusin" === f.type &&
                    g &&
                    (clearTimeout(b),
        ...
        a.mobile.document.bind("pagecreate create", function (b) {
          (a(b.target).jqmData("fullscreen") &&
            a(a.mobile.fixedtoolbar.prototype.options.initSelector, b.target)
              .not(":jqmData(fullscreen)")
              .jqmData("fullscreen", !0),
    ...
    (function (a, d) {
      (a.widget("mobile.panel", a.mobile.widget, {
            ...
            f = function () {
              ...
              return (
                0 === a.length &&
                  (a = c
                    .children()
                    .wrapAll('<div class="' + b.options.classes.panelInner + '" />')
                    .parent()),
                a
              );
            },
              ...
              return (
                0 === c.length &&
                  ((c = d
                    ...
                    .wrapAll('<div class="' + b.options.classes.contentWrap + " " + e() + '" />')
                    .parent()),
                  a.support.cssTransform3d && b.options.animate && c.addClass(b.options.classes.animate)),
                c
              );
            },
            h = function () {
        ...
        _createModal: function () {
          var b = this;
          b._modal = a("<div class='" + b.options.classes.modal + "' data-panelid='" + b._panelID + "'></div>")
        ...
        _positionPanel: function () {
          ...
          d || !b.options.positionFixed
            ? (d && (b._unfixPanel(), a.mobile.resetActivePageHeight(c)), b._scrollIntoView(c))
            : b._fixPanel();
        },
          ...
          b._page.on("click.panel", "a", function (c) {
            if (this.href.split("#")[1] === b._panelID && b._panelID !== d) {
              ...
              return (
                f.hasClass("ui-link") ||
                  ((e = f.parent().parent()),
                  e.hasClass("ui-li") && (f = e.parent()),
                  f.addClass(a.mobile.activeBtnClass),
                  b.element.one("panelopen panelclose", function () {
                    f.removeClass(a.mobile.activeBtnClass);
                  })),
                b.toggle(),
                !1
        ...
        open: function (b) {
          if (!this._open) {
            var c = this,
              d = c.options,
              e = function () {
                (c._page.off("panelclose"),
                  c._page.jqmData("panel", "open"),
                  !b && a.support.cssTransform3d && d.animate
                    ? c.element.add(c._wrapper).on(c._transitionEndEvents, f)
                    : setTimeout(f, 0),
                  c.options.theme &&
                    "overlay" !== c.options.display &&
                    c._page.removeClass(c._pageTheme).addClass("ui-body-" + c.options.theme),
                  c.element.removeClass(d.classes.panelClosed).addClass(d.classes.panelOpen),
                  c._positionPanel(),
                  c.options.theme &&
                    "overlay" !== c.options.display &&
                    c._wrapper.css("min-height", c._page.css("min-height")),
                  (c._contentWrapOpenClasses = c._getPosDisplayClasses(d.classes.contentWrap)),
                  c._wrapper
                    .removeClass(d.classes.contentWrapClosed)
                    .addClass(c._contentWrapOpenClasses + " " + d.classes.contentWrapOpen),
                  (c._fixedToolbarOpenClasses = c._getPosDisplayClasses(d.classes.contentFixedToolbar)),
                  c._fixedToolbar
                    .removeClass(d.classes.contentFixedToolbarClosed)
                    .addClass(c._fixedToolbarOpenClasses + " " + d.classes.contentFixedToolbarOpen),
                  (c._modalOpenClasses = c._getPosDisplayClasses(d.classes.modal) + " " + d.classes.modalOpen),
                  c._modal && c._modal.addClass(c._modalOpenClasses));
              },
              f = function () {
                (c.element.add(c._wrapper).off(c._transitionEndEvents, f),
                  c._page.addClass(d.classes.pagePanelOpen),
                  c._bindFixListener(),
                  c._trigger("open"));
              };
            (this.element.closest(".ui-page-active").length < 0 && (b = !0),
              c._trigger("beforeopen"),
              "open" === c._page.jqmData("panel")
                ? c._page.on("panelclose", function () {
                    e();
                  })
                : e(),
              (c._open = !0));
        ...
        close: function (b) {
          if (this._open) {
            var c = this.options,
              d = this,
              e = function () {
                (!b && a.support.cssTransform3d && c.animate
                  ? d.element.add(d._wrapper).on(d._transitionEndEvents, f)
                  : setTimeout(f, 0),
                  d._page.removeClass(c.classes.pagePanelOpen),
                  d.element.removeClass(c.classes.panelOpen),
                  d._wrapper.removeClass(c.classes.contentWrapOpen),
                  d._fixedToolbar.removeClass(c.classes.contentFixedToolbarOpen),
                  d._modal && d._modal.removeClass(d._modalOpenClasses));
              },
              f = function () {
                (d.options.theme &&
                  "overlay" !== d.options.display &&
                  (d._page.removeClass("ui-body-" + d.options.theme).addClass(d._pageTheme),
                  d._wrapper.css("min-height", "")),
                  d.element.add(d._wrapper).off(d._transitionEndEvents, f),
                  d.element.addClass(c.classes.panelClosed),
                  d._wrapper.removeClass(d._contentWrapOpenClasses).addClass(c.classes.contentWrapClosed),
                  d._fixedToolbar.removeClass(d._fixedToolbarOpenClasses).addClass(c.classes.contentFixedToolbarClosed),
                  d._fixPanel(),
        ...
        _destroy: function () {
          ...
          (d
            ? this._open &&
              (this._wrapper.removeClass(b.contentWrapOpen),
              this._fixedToolbar.removeClass(b.contentFixedToolbarOpen),
              this._page.jqmRemoveData("panel"),
              this._page.removeClass(b.pagePanelOpen),
              c && this._page.removeClass("ui-body-" + c).addClass(this._pageTheme))
            : (this._wrapper.children().unwrap(),
              this._page.find("a").unbind("panelopen panelclose"),
              this._page.removeClass(b.pagePanel),
              this._open &&
                (this._page.jqmRemoveData("panel"),
                this._page.removeClass(b.pagePanelOpen),
                c && this._page.removeClass("ui-body-" + c).addClass(this._pageTheme),
            ...
            this.element
              .removeClass([this._getPanelClasses(), b.panelAnimate].join(" "))
            ...
            this.element
              ...
              .removeClass([b.panelUnfixed, b.panelClosed, b.panelOpen].join(" ")));
        },
      }),
        a(c).bind("pagecreate create", function (b) {
    ...
    (function (a, b) {
      (a.widget("mobile.table", a.mobile.widget, {
        ...
        refresh: function (c) {
          ...
          (c && this.element.addClass(this.options.classes.table),
            (d.headers = this.element.find("tr:eq(0)").children()),
            (d.allHeaders = d.headers.add(e.children())),
            e.each(function () {
              var f = 0;
              a(this)
                .children()
                .each(function () {
                  var g = parseInt(a(this).attr("colspan"), 10),
                    h = ":nth-child(" + (f + 1) + ")";
                  if ((a(this).jqmData("colstart", f + 1), g))
                    for (var i = 0; g - 1 > i; i++) (f++, (h += ", :nth-child(" + (f + 1) + ")"));
                  (c === b && a(this).jqmData("cells", ""),
                    a(this).jqmData("cells", d.element.find("tr").not(e.eq(0)).not(this).children(h)),
                    f++);
                });
            }),
    ...
    (function (a, b) {
      ((a.mobile.table.prototype.options.mode = "columntoggle"),
        ...
        (a.mobile.table.prototype.options.classes = a.extend(a.mobile.table.prototype.options.classes, {
        ...
        a.mobile.document.delegate(":jqmData(role='table')", "tablecreate refresh", function (c) {
          ...
          "columntoggle" === k.mode &&
            ("refresh" !== j &&
              (i.element.addClass(k.classes.columnToggleTable),
              (d = a(
                "<a href='#" +
                  m +
                  "' class='" +
              ...
              (f = a("<fieldset data-" + l + "role='controlgroup'></fieldset>"))),
            i.headers.not("td").each(function (b) {
              var c = a(this).jqmData("priority"),
                d = a(this).add(a(this).jqmData("cells"));
              c &&
                (d.addClass(k.classes.priorityPrefix + c),
                "refresh" !== j
                  ? a("<label><input type='checkbox' checked />" + a(this).text() + "</label>")
                      .appendTo(f)
                      .children(0)
                      .jqmData("cells", d)
                      .checkboxradio({ theme: k.columnPopupTheme })
                  : a("#" + m + " fieldset div:eq(" + b + ")")
                      .find("input")
                      .jqmData("cells", d));
            }),
            "refresh" !== j && f.appendTo(e),
            (g = f === b ? a("#" + m + " fieldset") : f),
            "refresh" !== j &&
              (g.on("change", "input", function () {
                this.checked
                  ? a(this).jqmData("cells").removeClass("ui-table-cell-hidden").addClass("ui-table-cell-visible")
                  : a(this).jqmData("cells").removeClass("ui-table-cell-visible").addClass("ui-table-cell-hidden");
              }),
              d.insertBefore(h).buttonMarkup({ theme: k.columnBtnTheme }),
              e.insertBefore(h).popup()),
            (i.update = function () {
              g.find("input").each(function () {
                (this.checked
                  ? ((this.checked = "table-cell" === a(this).jqmData("cells").eq(0).css("display")),
                    "refresh" === j && a(this).jqmData("cells").addClass("ui-table-cell-visible"))
                  : a(this).jqmData("cells").addClass("ui-table-cell-hidden"),
            ...
            g.each(function () {
              ...
              if ("" !== e)
                if (d) {
                  var g = parseInt(a(this).attr("colspan"), 10),
                    h = "";
                  (g && (h = "td:nth-child(" + g + "n + " + c + ")"),
                    b.filter(h).prepend("<b class='" + f.classes.cellLabels + d + "'>" + e + "</b>"));
    ...
    (function (a, b) {
      function c(a) {
        ((e = a.originalEvent),
          ...
          (g = Math.abs(i.y)),
          (h = Math.abs(i.z)),
          !b.orientation && (f > 7 || (((h > 6 && 8 > g) || (8 > h && g > 6)) && f > 5))
            ? j.enabled && j.disable()
            : j.enabled || j.enable());
      }
      ...
      if (
        !(
          ...
          /OS [1-5]_[0-9_]* like Mac OS X/i.test(d) &&
          d.indexOf("AppleWebKit") > -1
        )
      )
        return ((a.mobile.iosorientationfixEnabled = !1), void 0);
      var e,
        f,
        g,
        h,
      ...
      a.mobile.document.on("mobileinit", function () {
        a.mobile.iosorientationfixEnabled &&
          a.mobile.window
            .bind("orientationchange.iosorientationfix", j.enable)
            ...
            initializePage: function () {
              ...
              (e.length ||
                ...
                e.each(function () {
                  var b = a(this);
                  b.jqmData("url") ||
                    b.attr("data-" + a.mobile.ns + "url", b.attr("id") || location.pathname + location.search);
                }),
                ...
                (a(h).is(':jqmData(role="page")') || a.mobile.path.isPath(g) || g === a.mobile.dialogHashKey)
                  ? a.event.special.navigate.isPushStateEnabled()
                    ? ((a.mobile.navigate.history.stack = []),
                      a.mobile.navigate(a.mobile.path.isPath(location.hash) ? location.hash : location.href))
                    : f.trigger("hashchange", [!0])
                  : (a.mobile.path.isHashValid(location.hash) && (a.mobile.urlHistory.initialDst = g.replace("#", "")),
                    a.event.special.navigate.isPushStateEnabled() &&
                      a.mobile.navigate.navigator.squash(b.parseLocation().href),
          ...
          a(function () {
            (b.scrollTo(0, 1),
              ...
              a.support.cssPointerEvents ||
                a.mobile.document.delegate(".ui-disabled", "vclick", function (a) {
