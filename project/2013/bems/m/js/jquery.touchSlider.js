(function (a) {
  ...
  var b = {
    init: function () {
      ...
      a(this)
        .children()
        .css({ width: this._width + "px", overflow: "visible" });
      ...
      if (this.opts.paging) {
        a(this._list).each(function (g, h) {
          var f = e.opts.paging.eq(0).clone();
          e.opts.paging.before(f);
    ...
    resize: function (f) {
      if (f.opts.flexible) {
        ...
        for (var d = 0; d < f._len; ++d) {
          ...
          f._list.eq(d).css({ left: f._pos[d] + "px", width: f._item_w + "px" });
          if (this.opts.supportsCssTransitions && this.opts.transition) {
            f._list
              .eq(d)
              .css({
    ...
    animate: function (f, c) {
      if (this._drag || !this._scroll || c) {
        ...
        this._list.each(function (j, k) {
          h._pos[j] = h._start[j] + g;
          if (h.opts.supportsCssTransitions && h.opts.transition) {
            var l = e + "ms";
            var d = "translate3d(" + h._pos[j] + "px,0,0)";
            if (c) {
              l = "0ms";
            }
            a(this).css({
            ...
            a(this).animate({ left: h._pos[j] + "px" }, e);
          }
        });
        this.counter();
      }
    ...
    counter: function () {
      if (typeof this.opts.counter == "function") {
        var c = { total: Math.ceil(this._len / this._view), current: a.inArray(0, this._pos) / this._view + 1 };
        this.opts.counter(c);
      }
    },
  };
