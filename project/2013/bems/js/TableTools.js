  ...
  TableTools.prototype = {
    ...
    fnResizeButtons: function () {
      for (var cli in ZeroClipboard_TableTools.clients) {
        if (cli) {
          ...
          if (typeof client.domElement != "undefined" && client.domElement.parentNode) {
    ...
    _fnButtonDefinations: function (buttonSet, wrapper) {
      ...
      for (var i = 0, iLen = buttonSet.length; i < iLen; i++) {
        ...
        wrapper.appendChild(this._fnCreateButton(buttonDef, $(wrapper).hasClass(this.classes.collection.container)));
      }
    },
    ...
    _fnPrintStart: function (oConfig) {
      ...
      // 2014-01-21 프린트 시 불필요한 레이어 보이지 않게 함.
      jQuery("#wrap").attr("id", "wrap1");
      jQuery(".datepicker").css("display", "none");
      jQuery(".modal").css("display", "none"); // 2014-01-29 model 컨텐츠를 인쇄에서 제외함.

      jQuery(".DTTT_print_info").css("display", "");
      jQuery(".DTTT_PrintMessage").css("display", "");
      jQuery(".boxBg").addClass("print");
    ...
    _fnPrintEnd: function (e) {
      ...
      oSetDT.oApi._fnCalculateEnd(oSetDT);
      oSetDT.oApi._fnDraw(oSetDT);
      // 2014-01-21 프린트 종료시 프린트 위해 변경한 부분 원상복귀
      jQuery("#wrap1").attr("id", "wrap");
      jQuery(".boxBg").removeClass("print");
      jQuery(".modal").css("display", ""); // 2014-01-29 model 컨텐츠를 인쇄에서 제외한것 복귀
    ...
    copy: $.extend({}, TableTools.buttonBase, {
      ...
      fnComplete: function (nButton, oConfig, flash, text) {
        var lines = text.split("\n").length,
          ...
          plural = len == 1 ? "" : "s";
        this.fnInfo("<h6>Table copied</h6>" + "<p>Copied " + len + " row" + plural + " to the clipboard.</p>", 1500);
      },
    }),
  ...
  if (
    ...
    $.fn.dataTableExt.aoFeatures.push({
      fnInit: function (oDTSettings) {
        var oOpts = typeof oDTSettings.oInit.oTableTools != "undefined" ? oDTSettings.oInit.oTableTools : {};
