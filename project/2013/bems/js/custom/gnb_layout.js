...
jQuery(document).ready(function () {
  ...
  /*cP ==> currentPosition*/
  var cP = {
    onImg: "/html/2014/bems/images/common/h_select_icon_off.gif",
    outImg: "/html/2014/bems/images/common/h_select_icon.gif",
  };
  ...
  function upDownPos() {
    ...
    if (isState == "down") {
      //최상단일때
      $(".fBtn").stop().fadeOut(100); //2014-02-13 메인 상단바로가기 버튼 수정
      jQuery(".sub footer .btn_top").fadeOut(100); //2014-02-13 서브 상단바로가기 버튼 수정
      if (gnbChange == "user") {
        //사용자
      ...
      $(".fBtn").fadeIn(100); //2014-02-13 메인 상단바로가기 버튼 수정
      jQuery(".sub footer .btn_top").fadeIn(100); //2014-02-13 서브 상단바로가기 버튼 수정
      ...
      if (gnbChange == "user") {
        ...
        if (gnbAlertAll) {
          ...
          userSub.css({
            top: gnbChangeHei.user + gnbChangeHei.alertHei - hiddenTop - 21 + gnbChangeHei.alertHei + "px",
          });
          _conPos.css({
            height: gnbChangeHei.user + gnbChangeHei.alertHei - hiddenTop - 21 + gnbChangeHei.alertHei + "px",
          });
  ...
  function resizeFun() {
    ...
    if (wW < 1600) {
      ...
      if (wW >= 1002) {
        ...
        jQuery(".gnbbgBox").css({
          width: wW - gPW - jQuery(".bookMark").width() - 4 + "px",
          height: jQuery(".menuBox").height() - 1 + "px",
          left: gPW + "px",
        });
  ...
  function gnbWidCalculator(gWid) {
    ...
    for (i = 0; i < gnb.len; i++) {
      ...
      /*//gnb 간격 수정*/
      jQuery(".gnbSubMenu .gSub_section li.one")
        .eq(i)
        .css({ width: widArr[i] + "px", height: gnb.sub.subHei - 70 + "px" }); /*서브*/
      jQuery(".menuBox ul.user>li")
        .eq(i)
        .css({ width: widArr[i] + "px" });
    } //E for
    ...
    if (gnbChange == "admin") {
      ...
      for (j = 0; j < gnb.aLen; j++) {
        ...
        jQuery(".gnbSubMenu2 .gSub_section>li")
          .eq(j)
          .css({ width: widArr[j] + "px", height: gnb.sub.aSubHei - 70 + "px" }); /*서브*/
        jQuery(".menuBox>ul.admin>li")
          .eq(j)
          .css({ width: widArr[j] + "px" });
      } //E for
  ...
  $.fn.extend({
    cPEvent: function () {
      ...
      /*2014-01-10 군관리 추가 및 수정*/
      _this.find(">a").bind("mousedown", function () {
      ...
      /*End // 2014-01-10 군관리 추가 및 수정*/

      op.bind("mousedown", function () {
        /*2014-01-10 군관리 추가 및 수정*/
        if ($(this).attr("class") != "area") {
          op.each(function () {
            jQuery(this).removeClass("on");
          });
          jQuery(this).addClass("on");
          ...
          window.open(
            "/html/gp/gp_realtime001.html",
            "_blank",
            "scrollbars=yes,menubar=no,toolbar=no,status=no,location=no,resizable=yes,channelmode=no,directories=no, copyhistory=no,width=990px,height=500px,left=0,top=0",
          );
          _sub.slideUp(200);
        }
        return false;
    ...
    gnbSubEvent: function () {
      ...
      var tmpNum = -1;
      var leaveOK = false; //2014-01-28 서브 메뉴 닫힐때 버그 해결
          ...
          jQuery(".menuBox>.user").bind("mouseleave", function (e) {
            _sub.bind("mouseenter mouseleave", function (e) {
              if (e.type == "mouseenter") {
                ...
                leaveOK = false; //2014-01-28 서브 메뉴 닫힐때 버그 해결
              } else if (e.type == "mouseleave") {
                //2014-01-28 서브 메뉴 닫힐때 버그 해결
                if (!leaveOK) {
                  leaveOK = true;
                  closeSub();
                }
                //End 2014-01-28 서브 메뉴 닫힐때 버그 해결
              } //E if
            });
      ...
      _subTwo.bind("mouseover", function (e) {
      ...
      function closeSub() {
        _sub.stop().slideUp(100, function () {
    ...
    bookMarkEvent: function () {
      ...
      creaBtn.bind("mousedown mouseover mouseout", function (e) {
        if (e.type == "mousedown") {
          var obj = jQuery(
            "<li class='on'><img src='/html/2014/bems/images/common/icon_forder_over.png' alt=''/><input value='새 폴더' /></li>",
          );
          forLi = jQuery(".bookBox .forder>.fBox>ul>li");
