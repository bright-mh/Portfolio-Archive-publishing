...
function addItemToDiv (title, id, dName){
	jQuery(".choiceList.clear02").append ("<li id='item_"+id+"'><a class='fl itemDel' onclick='removeItem(jQuery(this), "+id+", \""+dName+"\");'><img src='/html/2014/bems/images/common/btn_popup_close02.gif' alt='닫기' /></a><span class='fl txtStyle'>"+title+"</span></li>");
