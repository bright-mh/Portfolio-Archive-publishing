  ...
  (window._gsDefine(
    ...
    function (t, e, i) {
      var s = [].slice,
        ...
        n = function (t) {
          return t.jquery || (t.length && t[0] && t[0].nodeType && t[0].style && !t.nodeType);
        },
            ...
            (t >= u
              ? ((this._totalTime = u),
                ...
                this._yoyo && 0 !== (1 & this._cycle)
                  ...
                  : ((this._time = this._duration), (this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1)),
                this._reversed || ((s = !0), (r = "onComplete")),
                0 === this._duration &&
                  ((0 === t || 0 > this._rawPrevTime) &&
                    this._rawPrevTime !== t &&
                    ((i = !0), this._rawPrevTime > 0 && ((r = "onReverseComplete"), e && (t = -1))),
                  (this._rawPrevTime = t)))
              : 1e-7 > t
                      ...
                      1 === _
                        ...
                        : 2 === _
                          ...
                          : 3 === _
                            ...
                            : 4 === _ && (h *= h * h * h * h),
                      (this.ratio =
                        1 === l ? 1 - h : 2 === l ? h : 0.5 > this._time / this._duration ? h / 2 : 1 - h / 2))
            ...
            this._active || this._paused || (this._active = !0),
              0 === f &&
                ...
                this.vars.onStart &&
                  ...
                  (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || o))),
              n = this._firstPT;
            n;
          )
          ...
          (this._onUpdate &&
            ...
            this._cycle !== c &&
              (e ||
                this._gc ||
                (this.vars.onRepeat &&
                  this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || o))),
            r &&
              (this._gc ||
                ...
                !e &&
                  this.vars[r] &&
                  this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || o))));
        }),
        (r.to = function (t, e, i) {
          return new r(t, e, i);
        }),
        ...
        (r.staggerTo = r.allTo =
          function (t, e, a, h, l, _, u) {
            ...
            var p,
              ...
              g = [],
              v = function () {
                (a.onComplete && a.onComplete.apply(a.onCompleteScope || this, a.onCompleteParams || o),
                  l.apply(u || this, _ || o));
              };
            for (
              t instanceof Array || ("string" == typeof t && (t = i.selector(t) || t), n(t) && (t = s.call(t, 0))),
                p = t.length,
                c = 0;
              p > c;
              c++
      ...
      var h = function (t, e) {
          for (var s = [], r = 0, n = t._first; n; )
            (n instanceof i ? (s[r++] = n) : (e && (s[r++] = n), (s = s.concat(h(n, e))), (r = s.length)),
              (n = n._next));
          return s;
        },
      ...
      ((r.killAll = function (t, i, s, r) {
        ...
        for (o = 0; _ > o; o++)
          ((a = h[o]),
            (u || a instanceof e || ((n = a.target === a.vars.onComplete) && s) || (i && !n)) &&
      ...
      function (t, e, i) {
        ...
        return (
          ...
          (h.staggerTo = function (t, e, r, n, h, l, _, u) {
            var p,
              f = new s({ onComplete: l, onCompleteParams: _, onCompleteScope: u });
            for (
              "string" == typeof t && (t = i.selector(t) || t),
                !(t instanceof Array) && t.length && t[0] && t[0].nodeType && t[0].style && (t = o.call(t, 0)),
                n = n || 0,
                p = 0;
              t.length > p;
              p++
          ...
          (h.add = function (r, n, a, o) {
            ...
            if (("number" != typeof n && (n = this._parseTimeOrLabel(n, 0, !0, r)), !(r instanceof t))) {
              ...
              if ("function" != typeof r)
                throw (
                  "Cannot add " + r + " into the timeline; it is neither a tween, timeline, function, nor a string."
                );
              r = i.delayedCall(0, r);
            }
            if (
          ...
          (h._remove = function (t, i) {
            return (
              ...
              this._last
                ? this._time > this._last._startTime &&
            ...
            if (
                ...
                ? ((this._totalTime = this._time = l),
                  this._reversed ||
                    ...
                    0 === this._duration &&
                      ...
                      this._rawPrevTime !== t &&
                      this._first &&
                      ((h = !0), this._rawPrevTime > 0 && (o = "onReverseComplete"))),
                  (this._rawPrevTime = t),
                  (t = l + 1e-6))
                : 1e-7 > t
                  ? ((this._totalTime = this._time = 0),
                    (0 !== _ || (0 === this._duration && this._rawPrevTime > 0)) &&
                      ((o = "onReverseComplete"), (r = this._reversed)),
                    0 > t
                      ? ((this._active = !1), 0 === this._duration && this._rawPrevTime >= 0 && this._first && (h = !0))
                      : this._initted || (h = !0),
                    (this._rawPrevTime = t),
                    (t = 0))
              ...
              if (
                ...
                0 === _ &&
                  this.vars.onStart &&
                  0 !== this._time &&
                  (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || n)),
                this._time >= _)
              )
                ...
                for (s = this._last; s && ((a = s._prev), !this._paused || f); )
                  ((s._active || (_ >= s._startTime && !s._paused && !s._gc)) &&
                    ...
                    (s = a));
              (this._onUpdate &&
                (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || n)),
                o &&
                  (this._gc ||
                    ((u === this._startTime || p !== this._timeScale) &&
                      ...
                      !e &&
                        this.vars[o] &&
                        this.vars[o].apply(this.vars[o + "Scope"] || this, this.vars[o + "Params"] || n)))));
            }
          }),
          ...
          (h.rawTime = function () {
            return this._paused || (0 !== this._totalTime && this._totalTime !== this._totalDuration)
              ? this._totalTime
      ...
      function (t, e, i) {
        ...
        return (
          ...
          (o.tweenTo = function (t, i) {
            ...
            var s,
              a,
              o = { ease: n, overwrite: 2, useFrames: this.usesFrames(), immediateRender: !1 };
            for (s in i) o[s] = i[s];
            return (
              (o.time = this._parseTimeOrLabel(t)),
              (a = new e(this, Math.abs(Number(o.time) - this._time) / this._timeScale || 0.001, o)),
              (o.onStart = function () {
                (a.target.paused(!0),
          ...
          (o.render = function (t, e, i) {
            ...
            if (
              (t >= _
                ? (this._locked || ((this._totalTime = _), (this._cycle = this._repeat)),
                  this._reversed ||
                    this._hasPausedChild() ||
                    ((n = !0),
                    (o = "onComplete"),
                    0 === u &&
                      ...
                      ((h = !0), this._rawPrevTime > 0 && (o = "onReverseComplete"))),
                  (this._rawPrevTime = t),
                  this._yoyo && 0 !== (1 & this._cycle) ? (this._time = t = 0) : ((this._time = u), (t = u + 1e-6)))
                : 1e-7 > t
                  ? (this._locked || (this._totalTime = this._cycle = 0),
                    (this._time = 0),
                    (0 !== p || (0 === u && this._rawPrevTime > 0 && !this._locked)) &&
                      ((o = "onReverseComplete"), (n = this._reversed)),
                    0 > t
                      ? ((this._active = !1), 0 === u && this._rawPrevTime >= 0 && this._first && (h = !0))
                      : this._initted || (h = !0),
                    (this._rawPrevTime = t),
                    (t = 0))
              ...
              if (
                ...
                e ||
                  this._gc ||
                  (this.vars.onRepeat &&
                    this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || r)),
            ...
            if (!((this._time !== p && this._first) || i || h))
              return (
                f !== this._totalTime &&
                  this._onUpdate &&
                  (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || r)),
                void 0
              );
            if (
              (this._initted || (this._initted = !0),
              0 === f &&
                this.vars.onStart &&
                0 !== this._totalTime &&
                (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || r)),
              this._time >= p)
            )
              ...
              o &&
                (this._locked ||
                  ...
                  ((c === this._startTime || m !== this._timeScale) &&
                    ...
                    !e &&
                      this.vars[o] &&
                      this.vars[o].apply(this.vars[o + "Scope"] || this, this.vars[o + "Params"] || r)))));
          }),
              ...
              ((r = o[s]),
                r._paused ||
                  (r._timeline._time >= r._startTime &&
                    r._timeline._time < r._startTime + r._totalDuration / r._timeScale &&
                    (a(r._timeline) || (n[h++] = r))));
            return n;
          }),
            ...
            ((f = t[b]),
              ...
              o
                ? ((y = i[l]),
                  ...
                  (d = u - (c + (((m - c) * ((3 * y) / (y + T) + 0.5)) / 4 || 0))))
                : ((c = u - 0.5 * (u - _) * e), (m = u + 0.5 * (p - u) * e), (d = u - (c + m) / 2)),
              (c += d),
              (m += d),
              (f.c = g = c),
            ...
            if (
              ((this._beziers =
                "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type
                  ? u(h, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o)
                  : p(h, e.type, l)),
        ...
        var l,
          ...
          G = (a.getStyle = function (t, e, i, s, r) {
            ...
            return z || "opacity" !== e
              ? (!s && t.style[e]
                  ? (n = t.style[e])
                  : (i = i || Z(t, null))
                    ? ((t = i.getPropertyValue(e.replace(P, "-$1").toLowerCase())), (n = t || i.length ? t : i[e]))
              ...
              "%" === s && -1 !== e.indexOf("border")
                ...
                : ((h.cssText = "border-style:solid; border-width:0; position:absolute; line-height:0;"),
                  "%" !== s && o.appendChild
                    ...
                    : ((o = t.parentNode || E.body), (h[a ? "width" : "height"] = i + s)),
                  o.appendChild(N),
          ...
          W = function (t, e) {
            var i,
              ...
              r = {};
            if ((e = e || Z(t, null)))
              if ((i = e.length)) for (; --i > -1; ) r[e[i].replace(k, S)] = e.getPropertyValue(e[i]);
              else for (i in e) r[i] = e[i];
            else if ((e = t.currentStyle || t.style)) for (i in e) r[i.replace(k, S)] = e[i];
            return (
              z || (r.opacity = Y(t)),
              (s = be(t, e, !1)),
              ...
              (r.y = s.y),
              xe &&
                ((r.z = s.z), (r.rotationX = s.rotationX * I), (r.rotationY = s.rotationY * I), (r.scaleZ = s.scaleZ)),
              ...
              null == t
                ...
                : "number" == typeof t
                  ...
                  : ((r = 2 * Math.PI),
                    (n = t.split("_")),
                    (a =
                      Number(n[0].replace(v, "")) * (-1 === t.indexOf("rad") ? M : 1) - ("=" === t.charAt(1) ? 0 : e)),
                    n.length &&
                      (s && (s[i] = e + a),
              ...
              ? "number" == typeof t
                ...
                : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)),
                  ne[t]
                    ...
                    : "#" === t.charAt(0)
                      ? (4 === t.length &&
                          ((e = t.charAt(1)), (i = t.charAt(2)), (s = t.charAt(3)), (t = "#" + e + e + i + i + s + s)),
          ...
          ue =
            ((X._setPluginRatio = function (t) {
              ...
              for (var e, i, s, r, n = this.data, a = n.proxy, o = n.firstMPT, h = 1e-6; o; )
                ((e = a[o.v]),
                  o.r ? (e = e > 0 ? 0 | (e + 0.5) : 0 | (e - 0.5)) : h > e && e > -h && (e = 0),
                  (o.t[o.p] = e),
                  (o = o._next));
            ...
            ((X._parseToProxy = function (t, e, i, s, r, n) {
              ...
              for (
                i._transform = null,
                  ...
                  s = _ = i.parse(t, e, s, r),
                  F = m,
                  n && ((i._transform = c), u && ((u._prev = null), u._prev && (u._prev._next = null)));
                s && s !== u;
              ) {
                if (
                  1 >= s.type &&
              ...
              if (((c = R[u]), (g = S[u]), (T = parseFloat(c)), T || 0 === T))
                ...
                ((k = "," === g.charAt(g.length - 1) ? ")," : ")"),
                  ...
                  w && !z && 0 === g[3]
                    ...
                    : (z || (w = !1),
                      a
                        .appendXtra(w ? "rgba(" : "rgb(", c[0], g[0] - c[0], ",", !0, !0)
                        .appendXtra("", c[1], g[1] - c[1], ",", !0)
                        .appendXtra("", c[2], g[2] - c[2], w ? "," : k, !0),
                      w && ((c = 4 > c.length ? 1 : c[3]), a.appendXtra("", c, (4 > g.length ? 1 : g[3]) - c, k, !1))));
              else if ((v = c.match(m))) {
                ...
                ? (a.l++,
                  ...
                  o > 0
                    ? ((a.data["xn" + o] = e + i),
                      ...
                      (a["xn" + o] = e),
                      a.plugin ||
                        ((a.xfirst = new pe(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)), (a.xfirst.xs0 = 0)),
                      a)
        ...
        ((h = me.prototype),
          (h.parseComplex = function (t, e, i, s, r, n) {
            ...
            if (
              (this.multi &&
                (D.test(i) || D.test(e)
                  ? ((o = e.replace(D, "|").split("|")), (h = i.replace(D, "|").split("|")))
                  : p && ((o = [e]), (h = [i]))),
              h)
            ) {
              for (l = h.length > o.length ? h.length : o.length, a = 0; l > a; a++)
                ((e = o[a] = o[a] || this.dflt),
                  (i = h[a] = h[a] || this.dflt),
                  p &&
                    ((_ = e.indexOf(p)), (u = i.indexOf(p)), _ !== u && ((i = -1 === u ? h : o), (i[a] += " " + p))));
              ((e = o.join(", ")), (i = h.join(", ")));
            }
        ...
        var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
          ...
          be = function (t, e, i, s) {
            ...
            if (16 === n.length) {
              ...
              if (
                (v.zOrigin &&
                  ((D = -v.zOrigin), (A = k * D - n[12]), (O = R * D - n[13]), (D = S * D + v.zOrigin - n[14])),
                ...
                (Q &&
                  ...
                  X && W
                    ...
                    : X && L
                      ...
                      : L && W && (v.rotationY = v.rotationX = 0),
                  (v.scaleX = (0 | (Math.sqrt(U * U + z * z) * w + 0.5)) / w),
                  (v.scaleY = (0 | (Math.sqrt(q * q + R * R) * w + 0.5)) / w),
                  (v.scaleZ = (0 | (Math.sqrt(V * V + S * S) * w + 0.5)) / w),
                  (v.skewX = 0),
                  (v.perspective = $ ? 1 / (0 > $ ? -$ : $) : 0),
                  (v.x = A),
                  (v.y = O),
              ...
              !(
                (xe && !s && n.length && v.x === n[4] && v.y === n[5] && (v.rotationX || v.rotationY)) ||
              ...
              ((v.x = n[4] || 0),
                ...
                Math.abs(f) > Math.PI / 2 &&
                  Math.abs(f) < 1.5 * Math.PI &&
                  (y
                    ? ((_ *= -1), (f += 0 >= p ? Math.PI : -Math.PI), (p += 0 >= p ? Math.PI : -Math.PI))
                    : ((u *= -1), (f += 0 >= f ? Math.PI : -Math.PI))),
                ...
                (void 0 === v.skewX ||
                  ...
                  (d > x && b > d && false | (d * w)) ||
                  (g > x && b > g && false | (g * w))) &&
                  ((v.scaleX = _), (v.scaleY = u), (v.rotation = p), (v.skewX = f)),
                xe &&
              ...
              if (
                ...
                for (
                  ...
                  ((k = J[ce]),
                    ...
                    (R =
                      i !== s[k] ? (2 > ce ? -s.ieOffsetX : -s.ieOffsetY) : 2 > ce ? f - s.ieOffsetX : m - s.ieOffsetY),
                    (u[k] = (s[k] = Math.round(i - R * (0 === ce || 2 === ce ? 1 : S))) + "px"));
              ...
              ((u.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(O, w) : w + " " + e),
                (0 === t || 1 === t) &&
                  ...
                  ((v && -1 === w.indexOf("Dx=0, Dy=0")) ||
                    ...
                    (-1 === e.indexOf("gradient(") && u.removeAttribute("filter"))));
            }
          },
          ke = function () {
            var t,
            ...
            if (
              (p &&
                ((a = _.top ? "top" : _.bottom ? "bottom" : parseFloat(G(this.t, "top", null, !1)) ? "bottom" : "top"),
                (i = G(this.t, a, null, !1)),
                (o = parseFloat(i) || 0),
            ...
            ((A = l.rotationY),
              ...
              (d = (i = (d += l.x) - (d |= 0)) ? (0 | (i * O + (0 > i ? -0.5 : 0.5))) / O + d : d),
              (T = (i = (T += l.y) - (T |= 0)) ? (0 | (i * O + (0 > i ? -0.5 : 0.5))) / O + T : T),
              (P = (i = (P += l.z) - (P |= 0)) ? (0 | (i * O + (0 > i ? -0.5 : 0.5))) / O + P : P),
              (_[ye] =
                "matrix3d(" +
                [
                  (0 | (f * O)) / O,
          ...
          Re = function () {
            var t,
              ...
              u = _.style;
            (p &&
              ((t = u.top ? "top" : u.bottom ? "bottom" : parseFloat(G(_, "top", null, !1)) ? "bottom" : "top"),
              (e = G(_, t, null, !1)),
              (i = parseFloat(e) || 0),
              ...
              l.rotation || l.skewX
                ? ((r = l.rotation),
                  ...
                  (u[ye] =
                    ...
                    l.y +
                    ")"))
                : (u[ye] = "matrix(" + l.scaleX + ",0,0," + l.scaleY + "," + l.x + "," + l.y + ")"));
          };
        (de(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform",
          {
            parser: function (t, e, i, s, n, a, o) {
              ...
              for (
                p = m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective,
                  ...
                  (ye
                    ? ((f = !0),
                      ...
                      xe
                        ? ((_ = m.zOrigin),
                          (u = u.split(" ")),
                          (m.zOrigin = (u.length > 2 ? parseFloat(u[2]) : _) || 0),
          ...
          de("borderRadius", {
            ...
            parser: function (t, e, i, n, a) {
              ...
              var o,
                ...
                P = t.style;
              for (
                m = parseFloat(t.offsetWidth), d = parseFloat(t.offsetHeight), o = e.split(" "), h = 0;
                b.length > h;
                h++
              )
                  ...
                  g !== v &&
                    ...
                    "%" === g
                      ...
                      : "em" === g
                        ...
                        : ((u = T + "px"), (_ = w + "px")),
                    y && ((p = parseFloat(u) + c + g), (l = parseFloat(_) + c + g))),
            ...
            parser: function (t, e, i, s, n, a) {
              var o,
                ...
                d = this.format(
                  (m
                    ? c
                      ? m.getPropertyValue(f + "-x") + " " + m.getPropertyValue(f + "-y")
              ...
              if (
                ...
                ((p = G(t, "backgroundImage").replace(R, "")), p && "none" !== p)
              ) {
                for (o = d.split(" "), h = g.split(" "), L.setAttribute("src", p), l = 2; --l > -1; )
                  ((d = o[l]),
                    (_ = -1 !== d.indexOf("%")),
                    _ !== (-1 !== h[l].indexOf("%")) &&
                      ((u = 0 === l ? t.offsetWidth - L.width : t.offsetHeight - L.height),
            ...
            for (a in e)
              ((f = e[a]),
                ...
                h
                  ...
                  : ((p = G(t, a, r) + ""),
                    (d = "string" == typeof f),
                    "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (d && b.test(f))
                      ? (d || ((f = oe(f)), (f = (f.length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")")),
                        ...
                        ? ((_ = parseFloat(p)),
                          ...
                          g
                            ? ((u = parseInt(f.charAt(0) + "1", 10)),
                              ...
                              (u *= parseFloat(f)),
                              (m = f.replace(y, "")))
                            : ((u = parseFloat(f)), (m = d ? f.substr((u + "").length) || "" : "")),
                          "" === m && (m = s[a] || c),
                          ...
                          (!_ && 0 !== _) || (!u && 0 !== u)
                            ? void 0 !== v[a] && (f || ("NaN" != f + "" && null != f))
                              ? ((i = new pe(v, a, u || _ || 0, 0, i, -1, a, !1, 0, p, f)),
                                (i.xs0 = "none" !== f || ("display" !== a && -1 === a.indexOf("Style")) ? f : p))
            ...
            if (1 !== t || (this._tween._time !== this._tween._duration && 0 !== this._tween._time))
              if (
                ...
                for (; r; ) {
                  if (
                    ((e = r.c * t + r.s),
                    r.r ? (e = e > 0 ? 0 | (e + 0.5) : 0 | (e - 0.5)) : n > e && e > -n && (e = 0),
                    r.type)
                  )
                    if (1 === r.type)
      ...
      ((e._onInitAllProps = function () {
        for (
          var t,
            ...
            i,
            s = this._tween,
            r = s.vars.roundProps instanceof Array ? s.vars.roundProps : s.vars.roundProps.split(","),
            n = r.length,
            a = {},
          ...
          "useRadians" !== i &&
            ...
            o.length &&
              ...
              -1 !== s.indexOf("_cw") && 0 > a
                ...
                : -1 !== s.indexOf("ccw") && a > 0 && (a = ((a - 9999999999 * h) % h) - (0 | (a / h)) * h)),
                    ...
                    : "out" === h
                      ...
                      : "in" === h
                        ...
                        : 0.5 > i
                          ? ((n = 2 * i), (r = 0.5 * n * n * g))
                          : ((n = 2 * (1 - i)), (r = 0.5 * n * n * g)),
                  c ? (s += Math.random() * r - 0.5 * r) : f % 2 ? (s += 0.5 * r) : (s -= 0.5 * r),
                  m && (s > 1 ? (s = 1) : 0 > s && (s = 0)),
                  (l[_++] = { x: i, y: s }));
              for (
                l.sort(function (t, e) {
  ...
  (function (t) {
    ...
    var m = [0, 0, 1, 1],
      ...
      y = (g.register = function (t, e, i, s) {
        for (
          var r, n, a, o, l = e.split(","), _ = l.length, u = (i || "easeIn,easeOut,easeInOut").split(",");
          --_ > -1;
        )
    ...
    (c("Ticker", function (t, e) {
      var i,
        ...
        f = function (t) {
          ...
          var e = a,
            r = l.time - h;
          ((!i || r > 0 || t === !0) && (l.frame++, (h += r + (r >= o ? 0.004 : o - r)), l.dispatchEvent("tick")),
            t !== !0 && e === a && (a = s(f)));
        };
      (T.call(l),
        ...
        if (this._timeline) {
          if ((0 > t && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming)) {
            ...
            if (
              (t > s && !i && (t = s),
              (this._startTime =
                (this._paused ? this._pauseTime : a._time) - (this._reversed ? s - t : t) / this._timeScale),
      ...
      (s.paused = function (t) {
        ...
        if (t != this._paused && this._timeline) {
          ...
          var e = this._timeline.rawTime(),
            i = e - this._pauseTime;
          (!t && this._timeline.smoothChildTiming && ((this._startTime += i), this._uncache(!1)),
            (this._pauseTime = t ? e : null),
            (this._paused = t),
            (this._active = !t && this._totalTime > 0 && this._totalTime < this._totalDuration),
            t || 0 === i || 0 === this._duration || this.render(this._totalTime, !0, !0));
        }
    ...
    var R = c(
        ...
        function (t, e, i) {
          ...
          var s,
            r,
            n,
            a = t.jquery || (t.length && t[0] && t[0].nodeType && t[0].style && !t.nodeType),
            o = this.vars.overwrite;
          if (
            ((this._overwrite = o = null == o ? F[R.defaultOverwrite] : "number" == typeof o ? o >> 0 : F[o]),
            ...
            for (this._targets = n = l.call(t, 0), this._propLookup = [], this._siblings = [], s = 0; n.length > s; s++)
              ((r = n[s]),
                r
                  ? "string" != typeof r
                    ? r.length && r[0] && r[0].nodeType && r[0].style && !r.nodeType
                      ? (n.splice(s--, 1), (this._targets = n = n.concat(l.call(r, 0))))
                      : ((this._siblings[s] = L(r, this, !1)),
                        1 === o && this._siblings[s].length > 1 && X(r, this, null, 1, this._siblings[s]))
                    : ((r = n[s--] = R.selector(r)), "string" == typeof r && n.splice(s + 1, 1))
                  : n.splice(s--, 1));
          else
            ((this._propLookup = {}),
              (this._siblings = L(t, this, !1)),
              1 === o && this._siblings.length > 1 && X(t, this, null, 1, this._siblings));
          (this.vars.immediateRender || (0 === e && 0 === this._delay && this.vars.immediateRender !== !1)) &&
      ...
      A = function (t, e) {
        ...
        for (i in t)
          I[i] ||
            (i in e && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i) ||
    ...
    var L = function (t, e, i) {
        var s,
          ...
          n = t._gsTweenID;
        if (
          (D[n || (t._gsTweenID = n = "t" + M++)] || (D[n] = { target: t, tweens: [] }),
          ...
          (o = r[n]) === e ||
            ...
            (o._timeline !== e._timeline
              ...
              : _ >= o._startTime &&
                ...
                (((f || !o._initted) && 2e-10 >= _ - o._startTime) || (u[p++] = o)));
        for (n = p; --n > -1; )
          ((o = u[n]),
            2 === s && o._kill(i, t) && (a = !0),
    ...
    ((s._init = function () {
      ...
      if (r.startAt) {
        if (
          ...
          r.immediateRender && ((this._startAt = null), 0 === this._time && 0 !== a))
        )
          return;
      ...
      (s._initProps = function (t, e, i, s) {
        ...
        for (r in this.vars) {
          if (I[r]) {
            ...
            for (
              this._firstPT = l =
                { _next: this._firstPT, t: o, p: "setRatio", s: 0, c: 1, f: !0, n: r, pg: !0, pr: o._priority },
                n = o._overwriteProps.length;
              --n > -1;
            )
              e[o._overwriteProps[n]] = this._firstPT;
            ((o._priority || o._onInitAllProps) && (a = !0),
              (o._onDisable || o._onEnable) && (this._notifyPluginsOfEnabled = !0));
          } else
            ((this._firstPT =
              e[r] =
              l =
                { _next: this._firstPT, t: t, p: r, f: "function" == typeof t[r], n: r, pg: !1, pr: 0 }),
              (l.s = l.f
        ...
        return s && this._kill(s, t)
          ...
          : this._overwrite > 1 && this._firstPT && i.length > 1 && X(t, this, e, this._overwrite, i)
      ...
      (s.render = function (t, e, i) {
        ...
        if (t >= this._duration)
          ...
          ((1 === h || (3 === h && o >= 0.5)) && (o = 1 - o),
            ...
            (this.ratio = 1 === h ? 1 - o : 2 === h ? o : 0.5 > t / this._duration ? o / 2 : 1 - o / 2));
            ...
            this._active || this._paused || (this._active = !0),
              0 === a &&
                ...
                this.vars.onStart &&
                  ...
                  (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || d))),
              n = this._firstPT;
            n;
          )
            (n.f ? n.t[n.p](n.c * this.ratio + n.s) : (n.t[n.p] = n.c * this.ratio + n.s), (n = n._next));
          (this._onUpdate &&
            ...
            r &&
              (this._gc ||
                ...
                !e &&
                  this.vars[r] &&
                  this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || d))));
        }
      }),
            ...
            for (r in h)
              ((n = a[r]) &&
                ...
                (n.pg && 0 !== n.t._overwriteProps.length) ||
                  (n._prev ? (n._prev._next = n._next) : n === this._firstPT && (this._firstPT = n._next),
      ...
      (s._enabled = function (t, e) {
        if ((n || r.wake(), t && this._gc)) {
          var i,
            s = this._targets;
          if (s) for (i = s.length; --i > -1; ) this._siblings[i] = L(s[i], this, !0);
      ...
      (R.getTweensOf = function (t) {
        ...
        } else for (i = L(t).concat(), e = i.length; --e > -1; ) i[e]._gc && i.splice(e, 1);
        return i;
      }));
    var z = c(
      "plugins.TweenPlugin",
    ...
    if (
      ...
      (s.setRatio = function (t) {
        for (var e, i = this._firstPT, s = 1e-6; i; )
          ((e = i.c * t + i.s),
            i.r ? (e = (e + (e > 0 ? 0.5 : -0.5)) >> 0) : s > e && e > -s && (e = 0),
