          ...
          (a.focus(),
            a.is(":visible") &&
              ...
              (b.setSelectionRange
                ...
                : b.createTextRange && ((d = b.createTextRange()), d.collapse(!1), d.select())));
        }, 0);
    }
    function z(b) {
      b = a(b)[0];
    ...
    function M(a, c, d, e) {
      ...
      for (;;) {
        ...
        if (
          ...
          h.length > 0 &&
            ((h = e.createSearchChoice.call(this, h, c)), h !== b && null !== h && e.id(h) !== b && null !== e.id(h)))
        ) {
      ...
      ((j = a(document)),
        ...
        (d = N(Object, {
            ...
            ((this.opts = c = this.prepareOpts(c)),
              ...
              this.dropdown.on(
                ...
                this.bind(function (b) {
                  a(b.target).closest(".select2-result-selectable").length > 0 &&
          ...
          destroy: function () {
            ...
            (this.close(),
              ...
              c !== b &&
                ...
                this.elementTabIndex ? a.attr({ tabindex: this.elementTabIndex }) : a.removeAttr("tabindex"),
                a.show()));
          },
                    ...
                    ((g = function (d, e, j) {
                      ...
                      for (d = c.sortResults(d, e, f), k = 0, l = d.length; l > k; k += 1)
                        ((m = d[k]),
                          ...
                          (q = a("<li></li>")),
                          q.addClass("select2-results-dept-" + j),
                ...
                ? ((c.query = this.bind(function (a) {
                    ...
                    ((i = function (b, c) {
                      ...
                      this.getPlaceholder() !== b &&
                        f.length > 0 &&
                        ((g = this.getPlaceholderOption()), g && (f = f.not(g))),
          ...
          monitorSource: function () {
            ...
            (a.on(
              ...
              d !== b &&
                (this.propertyObserver && (delete this.propertyObserver, (this.propertyObserver = null)),
                (this.propertyObserver = new d(this.mutationCallback)),
          ...
          enable: function (a) {
            (a === b && (a = !0),
              this._enabled !== a &&
                ((this._enabled = a), this.opts.element.prop("disabled", !a), this.enableInterface()));
          },
          disable: function () {
            this.enable(!1);
          },
          readonly: function (a) {
            return (
              ...
              this._readonly === a
                ? !1
                : ((this._readonly = a), this.opts.element.prop("readonly", a), this.enableInterface(), !0)
            );
          },
          opened: function () {
            ...
            (s ? ((u = !0), !p && o && ((v = !0), (u = !1))) : ((u = !1), !o && p && ((v = !0), (u = !0))),
              ...
              this.opts.dropdownAutoWidth
                ? ((x = a(".select2-results", b)[0]),
                  ...
                  b.css("width", ""),
                  (q = b.outerWidth(!1) + (x.scrollHeight === x.clientHeight ? 0 : k.width)),
                  q > e ? (e = q) : (q = e),
                  (r = j >= n + q))
              ...
              (w = a.extend(w, K(this.opts.dropdownCss))),
              b.css(w));
          },
          shouldOpen: function () {
            var b;
            return this.opened()
              ...
              : this._enabled === !1 || this._readonly === !0
                ? !1
                : ((b = a.Event("select2-opening")), this.opts.element.trigger(b), !b.isDefaultPrevented());
          },
          ...
          ensureHighlightVisible: function () {
            ...
            if (((d = this.highlight()), !(0 > d))) {
              ...
              ((c = this.findHighlightableChoices().find(".select2-result-label")),
                ...
                d === c.length - 1 &&
                  ((i = b.find("li.select2-more-results")), i.length > 0 && (f = i.offset().top + i.outerHeight(!0))),
          ...
          highlight: function (b) {
            ...
            return 0 === arguments.length
              ...
              : (b >= c.length && (b = c.length - 1),
                ...
                e && this.opts.element.trigger({ type: "select2-highlight", val: this.id(e), choice: e }),
                void 0);
          },
          ...
          updateResults: function (c) {
            ...
            if (
              ...
              if (
                o >= 1 &&
                ((g = this.data()),
                a.isArray(g) && g.length >= o && J(f.formatSelectionTooBig, "formatSelectionTooBig"))
              )
              ...
              (f.formatSearching &&
                ...
                n("<li class='select2-searching'>" + f.formatSearching() + "</li>"),
                    ...
                    if (l == this.queryCount) {
                      ...
                      if (
                        ...
                        this.opts.createSearchChoice &&
                          "" !== d.val() &&
                          ((i = this.opts.createSearchChoice.call(h, d.val(), g.results)),
                          i !== b &&
                            null !== i &&
                            h.id(i) !== b &&
                            null !== h.id(i) &&
                      ...
                      (e.empty(),
                        ...
                        g.more === !0 &&
                          ...
                          (e.append(
                            "<li class='select2-more-results'>" +
                              h.opts.escapeMarkup(f.formatLoadMore(this.resultsPage)) +
                              "</li>",
                          ),
                          window.setTimeout(function () {
                            h.loadMoreIfNeeded();
                        ...
                        m(),
                        this.opts.element.trigger({ type: "select2-loaded", items: g }));
                    }
                  }),
                }));
            }
              ...
              if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                if (((c = this.opts.element.attr("style")), c !== b))
                  for (d = c.split(";"), f = 0, g = d.length; g > f; f += 1)
                    if (
                      ((h = d[f].replace(/\s/g, "")),
                      (e = h.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i)),
                      null !== e && e.length >= 1)
                    )
                      return e[1];
        ...
        (e = N(d, {
          ...
          opening: function () {
            ...
            (this.opts.minimumResultsForSearch >= 0 && this.showSearch(!0),
              ...
              c.createTextRange
                ...
                : c.setSelectionRange && ((e = this.search.val().length), c.setSelectionRange(e, e)),
              "" === this.search.val() &&
                this.nextSearchTerm != b &&
          ...
          clear: function (b) {
            ...
            if (c) {
              ...
              (this.opts.element.val(e ? e.val() : ""),
                ...
                this.setPlaceholder(),
                b !== !1 &&
                  (this.opts.element.trigger({ type: "select2-removed", val: this.id(c), choice: c }),
          ...
          isPlaceholderOptionSelected: function () {
            ...
            return this.getPlaceholder()
              ? ((a = this.getPlaceholderOption()) !== b && a.prop("selected")) ||
          ...
          onSelect: function (a, b) {
            if (this.triggerSelect(a)) {
              ...
              (this.opts.element.val(this.id(a)),
                ...
                this.opts.element.trigger({ type: "select2-selected", val: this.id(a), choice: a }),
                (this.nextSearchTerm = this.opts.nextSearchTerm(a, this.search.val())),
                this.close(),
                (b && b.noFocus) || this.focusser.focus(),
                q(c, this.id(a)) || this.triggerChange({ added: a, removed: d }));
            }
          },
          ...
          data: function (a) {
            var c,
              d = !1;
            return 0 === arguments.length
              ? ((c = this.selection.data("select2-data")), c == b && (c = null), c)
        ...
        (f = N(d, {
              ...
              this.search.on(
                ...
                this.bind(function (a) {
                  if (this.isInterfaceEnabled()) {
                      ...
                      return (
                        a.which == c.LEFT && e.length
                          ...
                          : a.which == c.RIGHT
                            ? (h = f.length ? f : null)
                            : a.which === c.BACKSPACE
                              ? (this.unselect(b.first()), this.search.width(10), (h = e.length ? e : f))
                              : a.which == c.DELETE
                                ? (this.unselect(b.first()), this.search.width(10), (h = f.length ? f : null))
                    ...
                    if (
                      ((a.which === c.BACKSPACE && 1 == this.keydowns) || a.which == c.LEFT) &&
                      0 == g.offset &&
                      !g.length
                    )
                      return (
                        this.selectChoice(d.find(".select2-search-choice:not(.select2-locked)").last()),
                        A(a),
                        void 0
                      );
          ...
          clearSearch: function () {
            ...
            a !== b && 0 === this.getVal().length && this.search.hasClass("select2-focused") === !1
          ...
          onSelect: function (a, b) {
            this.triggerSelect(a) &&
              ...
              this.opts.element.trigger({ type: "selected", val: this.id(a), choice: a }),
            ...
            if ((d = b.data("select2-data"))) {
              ...
              ((f.val = this.id(d)),
                ...
                f.isDefaultPrevented() ||
                  (b.remove(),
                  this.opts.element.trigger({ type: "select2-removed", val: this.id(d), choice: d }),
            ...
            (e.each2(function (a, b) {
              ...
              f.each2(function (a, b) {
                b.is(".select2-result-selectable") ||
                  0 !== b.find(".select2-result-selectable:not(.select2-selected)").length ||
                  b.addClass("select2-selected");
              }),
              -1 == this.highlight() && c !== !1 && g.highlight(0),
              !this.opts.createSearchChoice &&
                !e.filter(".select2-result:not(.select2-selected)").length > 0 &&
                (!a || (a && !a.more && 0 === this.results.find(".select2-no-results").length)) &&
                J(g.opts.formatNoMatches, "formatNoMatches") &&
                this.results.append(
                  "<li class='select2-no-results'>" + g.opts.formatNoMatches(g.search.val()) + "</li>",
                ));
          },
              ...
              if (0 === c.length || "object" == typeof c[0])
                ((d = 0 === c.length ? {} : a.extend({}, c[0])),
                  ...
                  "select" === d.element.get(0).tagName.toLowerCase()
                    ...
                    : ((j = d.multiple || !1), "tags" in d && (d.multiple = j = !0)),
                  (g = j ? new f() : new e()),
                  g.init(d));
              else {
        ...
        (a.fn.select2.ajaxDefaults = { transport: a.ajax, params: { type: "GET", cache: !1, dataType: "json" } }),
        (window.Select2 = {
