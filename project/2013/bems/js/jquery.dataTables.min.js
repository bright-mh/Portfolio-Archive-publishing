    ...
    /** @lends <global> */ function ($) {
      ...
      var DataTable = function (oInit) {
          ...
          if (oSettings.iInitDisplayStart !== undefined && oSettings.iInitDisplayStart != -1) {
            if (oSettings.oFeatures.bServerSide) {
              ...
              oSettings._iDisplayStart =
                oSettings.iInitDisplayStart >= oSettings.fnRecordsDisplay() ? 0 : oSettings.iInitDisplayStart;
            }
        ...
        function _fnPageChange(oSettings, mAction) {
          ...
          if (typeof mAction === "number") {
            ...
            oSettings._iDisplayStart =
              oSettings._iDisplayLength >= 0 ? oSettings._iDisplayStart - oSettings._iDisplayLength : 0;
        ...
        function _fnFeatureHtmlTable(oSettings) {
          ...
          nScrollHeadInner.style.width =
            oSettings.oScroll.sXInner !== "" ? oSettings.oScroll.sXInner : "100%"; /* will be overwritten */
        ...
        function _fnScrollDraw(o) {
          ...
          if ($(o.nTable).outerWidth() < iSanityWidth) {
            ...
            var iCorrection =
              nScrollBody.scrollHeight > nScrollBody.offsetHeight || $(nScrollBody).css("overflow-y") == "scroll"
          ...
          if (o.oScroll.sY !== "" && o.oScroll.bCollapse) {
            ...
            var iExtra =
              o.oScroll.sX !== "" && o.nTable.offsetWidth > nScrollBody.offsetWidth ? o.oScroll.iBarWidth : 0;
          ...
          var bScrolling =
            $(o.nTable).height() > nScrollBody.clientHeight || $(nScrollBody).css("overflow-y") == "scroll";
              ...
              for (i = 0; i < oSettings.aoColumns.length; i++) {
                if (oSettings.aoColumns[i].bVisible) {
                  if (oSettings.aoColumns[i].sWidthOrig === null) {
                    ...
                    iTotal +=
                      parseInt(oSettings.aoColumns[i].sWidth.replace("px", ""), 10) +
          ...
          for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
            ...
            if (aoColumns[i].bSortable) {
              if (aaSort.length > 0 && aaSort[0][0] == i) {
                ...
                nTh.setAttribute(
                  "aria-label",
                  sTitle + (aoColumns[i].asSorting[0] == "asc" ? oAria.sSortAscending : oAria.sSortDescending),
                );
              }
            } else {
          ...
          for (i = 0; i < iColumns; i++) {
            if (oSettings.aoColumns[i].bSortable) {
              $(oSettings.aoColumns[i].nTh).removeClass(
                oClasses.sSortAsc + " " + oClasses.sSortDesc + " " + oSettings.aoColumns[i].sSortingClass,
              );
            }
          }
        ...
        this.fnDestroy = function (bRemove) {
          ...
          if (oSettings.bJUI) {
            $(
              "th span." + oSettings.oClasses.sSortIcon + ", td span." + oSettings.oClasses.sSortIcon,
              oSettings.nTHead,
            ).remove();
      ...
      DataTable.defaults = {
        ...
        oLanguage: {
          ...
          //"sInfo": "총 _START_ to _END_ of _TOTAL_ entries",
          sInfo: "총 _TOTAL_ 개의 데이터 중 _START_~_END_ 개",
           ...
           *    } );
           */
          sZeroRecords: "일치하는 자료가 존재하지 않습니다. ",
        },
          ...
          fnUpdate: function (oSettings, fnCallbackDraw) {
            ...
            for (i = 0, iLen = an.length; i < iLen; i++) {
              ...
              $(anStatic).removeClass(
                oClasses.sPageButton + " " + oClasses.sPageButtonActive + " " + oClasses.sPageButtonStaticDisabled,
              );
