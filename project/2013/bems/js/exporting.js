...
(function(f){
	...
	p( x.lang, {
		printChart:"차트 인쇄",
		downloadPNG:"PNG 저장",
		downloadJPEG:"JPEG 저장",
		downloadPDF:"PDF 저장",
		downloadSVG:"SVG 벡터이미지 저장",
		contextButtonTitle:""
	});
	x.navigation={
		menuStyle:{
	...
	f.post=function(c,a){
		...
		for(d in a) k("input",{type:"hidden",name:d,value:a[d]},null,b);b.submit();n(b)};p(A.prototype,{getSVG:function(c){var a=this,d,b,z,h,g=o(a.options,c);if(!j.createElementNS)j.createElementNS=function(a,b){return j.createElement(b)};c=k("div",null,{position:"absolute",top:"-9999em",width:a.chartWidth+"px",height:a.chartHeight+"px"},j.body);b=a.renderTo.style.width;h=a.renderTo.style.height;b=g.exporting.sourceWidth||g.chart.width||/px$/.test(b)&&
