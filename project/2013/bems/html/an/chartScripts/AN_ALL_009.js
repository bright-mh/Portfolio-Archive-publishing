  ...
  jQuery("#chart01").highcharts({
    ...
    series: [
      ...
      },
      {
        ...
        marker: BC.marker01,
        yAxis: 1,
        data: [7.06, 3.605, 7.471, 10.322, 7.238, 3.221, 6.129, 8.089, 8.339, 7.399, 8.538, 7.643],
        tooltip: {
          valueSuffix: " ℃",
          dateTimeLabelFormats: BC.dateFormat.full,
          shared: false,
      ...
      },
      {
        ...
        yAxis: 1,
        data: [8.06, 8.605, 8.471, 7.322, 8.238, 8.221, 8.129, 8.089, 8.339, 8.399, 8.538, 8.643],
        tooltip: {
          valueSuffix: " ℃",
          dateTimeLabelFormats: BC.dateFormat.full,
          shared: false,
