        ...
        $('#chart01').highcharts({
            ...
            series: [
                ...
                , 
                {
                    name: '흡수식 냉동기2호 - COP',
                    data: [
                        [0.6,5.6], [0.5,6.6], [0.7,5.8], [0.8,5.8], [0.4,6.7], [0.5,7.2], [0.8,8.6], [0.4,8.5],
                        [0.8,5.5], [0.7,7.6], [0.7,8.6], [0.7,7.6], [0.6,5.6], [0.9,5.4], [0.8,5.2], [0.3,7.6],
                        [0.6,7.3], [0.6,5.7], [0.6,7.4], [0.6,7.4], [0.7,8.5], [0.8,5.6], [0.6,5.6], [0.2,5.3],
                        [0.8,5.7], [0.6,7.4], [0.5,5.6], [0.8,5.6], [0.5,5.3], [0.7,7.6], [0.5,8.3], [0.1,7.6],
                        [0.7,7.6], [0.7,5.6], [0.7,5.2], [0.5,7.2], [0.6,5.6], [0.8,6.6], [0.6,7.4], [0.5,7.3],
                        [0.5,5.3], [0.5,5.4], [0.5,7.6], [0.6,5.6], [0.7,7.1], [0.6,6.2], [0.5,7.6], [0.3,5.6]
                    ],
					yAxis: 3
                }
            ],
