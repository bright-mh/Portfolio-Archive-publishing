...
(function (l, C) {
    ...
    if (c.polar) {
      if (c.renderer.isSVG)
        if ((d === !0 && (d = {}), b)) {
          ...
          ((c = { translateX: i, translateY: o, scaleX: 1, scaleY: 1 }),
            g.animate(c, d),
            f && f.animate(c, d),
            (this.animate = null));
    } else a.call(this, b);
  ...
  F(J.prototype, {
    init: function (a, b, c) {
      ...
      d.options = a = p(g, a);
      (a = a.background) &&
        r([].concat(M(a)).reverse(), function (a) {
    ...
    O = {
        ...
        if (this.isRadial)
          ((this.center = this.pane.center = h.pie.prototype.getCenter.call(this.pane)),
            (this.len =
              this.width =
              this.height =
                this.isCircular ? (this.center[2] * (this.endAngleRad - this.startAngleRad)) / 2 : this.center[2] / 2));
      },
      ...
      getPlotBandPath: function (a, b, c) {
        var d = this.center,
          ...
          f = d[2] / 2,
          e = [q(c.outerRadius, "100%"), c.innerRadius, q(c.thickness, 10)],
          i = /%$/,
          o,
          k = this.isCircular;
        this.options.gridLineInterpolation === "polygon"
          ? (d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)))
          : (k || ((e[0] = this.translate(a)), (e[1] = this.translate(b))),
            (e = R(e, function (a) {
              i.test(a) && (a = (v(a, 10) * f) / 100);
              return a;
            })),
            c.shape === "circle" || !k
              ? ((a = -Math.PI / 2), (b = Math.PI * 1.5), (o = !0))
  ...
  n(G, "init", function (a, b, c) {
    ...
    if (d) {
      ...
      (F(this, O),
        (this.defaultRadialOptions = (i = f)
          ? this.defaultRadialXOptions
          : p(this.defaultYAxisOptions, this.defaultRadialYOptions)));
    a.call(this, b, c);
    if (!e && (d || g)) {
      a = this.options;
      if (!b.panes) b.panes = [];
      ...
      if ((this.isCircular = i) && c.max === C && o - b === 2 * Math.PI) this.autoConnect = !0;
    }
  });
  ...
  n(u, "getLabelPosition", function (a, b, c, d, g, f, e, i, o) {
    var k = this.axis,
      j = f.y,
      h = f.align,
      l = (((k.translate(this.pos) + k.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360;
    k.isRadial
      ? ((a = k.getPosition(this.pos, k.center[2] / 2 + q(f.distance, -25))),
        f.rotation === "auto"
          ? d.attr({ rotation: l })
          : j === null && (j = v(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2),
        h === null &&
          ((h = k.isCircular ? (l > 20 && l < 160 ? "left" : l > 200 && l < 340 ? "right" : "center") : "center"),
          d.attr({ align: h })),
        (a.x += f.x),
        (a.y += j))
      : (a = a.call(this, b, c, d, g, f, e, i, o));
    return a;
  });
  ...
  h.arearange = l.extendClass(h.area, {
    type: "arearange",
  ...
  u = {
    type: "gauge",
    pointClass: l.extendClass(l.Point, {
      setState: function (a) {
        this.state = a;
      },
    }),
    ...
    translate: function () {
      ...
      r(this.points, function (d) {
        var g = p(b.dial, d.dial),
          f = (v(q(g.radius, 80)) * c[2]) / 200,
          e = (v(q(g.baseLength, 70)) * f) / 100,
          i = (v(q(g.rearLength, 10)) * f) / 100,
          o = g.baseWidth || 3,
          k = g.topWidth || 1,
          j = a.startAngleRad + a.translate(d.y, null, null, null, !0);
        b.wrap === !1 && (j = Math.max(a.startAngleRad, Math.min(a.endAngleRad, j)));
        j = (j * 180) / Math.PI;
        d.shapeType = "path";
        d.shapeArgs = {
          d: g.path || ["M", -i, -o / 2, "L", e, -o / 2, f, -k / 2, f, k / 2, e, o / 2, -i, o / 2, "z"],
          translateX: c[0],
          translateY: c[1],
          rotation: j,
        };
  ...
  h.gauge = l.extendClass(h.line, u);
      ...
      r(b, function (b) {
        ...
        if (b.plotY !== C)
          if (
            ...
            (i = A(b.highPlot)),
            (o = A(b.lowPlot)),
            (n.stroke = b.stemColor || c.stemColor || y),
            (n["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth)),
            (n.dashstyle = b.stemDashStyle || c.stemDashStyle),
            (E.stroke = b.whiskerColor || c.whiskerColor || y),
            (E["stroke-width"] = q(b.whiskerWidth, c.whiskerWidth, c.lineWidth)),
            (t.stroke = b.medianColor || c.medianColor || y),
            (t["stroke-width"] = q(b.medianWidth, c.medianWidth, c.lineWidth)),
            (t["stroke-linecap"] = "round"),
            (j = (n["stroke-width"] % 2) / 2),
            (h = s + u + j),
            (m = ["M", h, e, "L", h, i, "M", h, f, "L", h, o, "z"]),
            x &&
              ((j = (g["stroke-width"] % 2) / 2),
              (h = A(h) + j),
              (f = A(f) + j),
              (e = A(e) + j),
              (s += j),
              (v += j),
              (H = ["M", s, e, "L", s, f, "L", v, f, "L", v, e, "L", s, e, "z"])),
            B &&
              ((j = (E["stroke-width"] % 2) / 2),
              (i += j),
              (o += j),
              (p = ["M", h - u * B, i, "L", h + u * B, i, "M", h - u * B, o, "L", h + u * B, o])),
            ...
            if (B) b.whiskers = d.path(p).attr(E).add(l);
            if (x) b.box = d.path(H).attr(g).add(l);
    ...
    translate: function () {
      ...
      for (d = 0, c = g.length; d < c; d++) {
        ...
        f.isSum || f.isIntermediateSum
          ? ((e.y = b.translate(j[1], 0, 1)), (e.height = b.translate(j[0], 0, 1) - e.y))
          : (k += i.total);
  ...
  N.prototype.beforePadding = function () {
    var a = this,
      ...
      i = this.min,
      h = {},
      k = s.min(c.plotWidth, c.plotHeight),
      j = Number.MAX_VALUE,
      l = -Number.MAX_VALUE,
      m = this.max - i,
      n = b / m,
      ...
      (r(this.series, function (b) {
        ...
        if (b.bubblePadding && b.visible && ((a.allowZoomOutside = !0), p.push(b), f))
          (r(["minSize", "maxSize"], function (a) {
            ...
            (b = b.zData),
            b.length &&
              ((j = s.min(j, s.max(P(b), c.displayNegative === !1 ? c.zThreshold : -Number.MAX_VALUE))),
              (l = s.max(l, Q(b)))));
      }),
      r(p, function (a) {
        var b = a[e],
        ...
        if (m > 0)
          for (; c--; )
            b[c] !== null &&
              ((k = a.radii[c]), (d = Math.min((b[c] - i) * n - k, d)), (g = Math.max((b[c] - i) * n + k, g)));
      }),
      p.length &&
        m > 0 &&
        q(this.options.min, this.userMin) === C &&
        q(this.options.max, this.userMax) === C &&
        ((g -= b), (n *= (b + d - g) / b), (this.min += d / n), (this.max += g / n)));
  };
  var y = z.prototype,
    m = l.Pointer.prototype;
  y.toXY = function (a) {
    var b,
      c = this.chart;
    b = a.plotX;
    ...
    if (this.chart.polar) {
      ...
      if (a && e)
        ((i = a.plotX),
          ...
          (k = Math.sqrt(Math.pow(e - g, 2) + Math.pow(j - f, 2))),
          (i = Math.atan2(h - f, i - g)),
          (h = Math.atan2(j - f, e - g)),
          (j = Math.PI / 2 + (i + h) / 2),
          Math.abs(i - j) > Math.PI / 2 && (j -= Math.PI),
          (i = g + Math.cos(j) * b),
          (h = f + Math.sin(j) * b),
          (e = g + Math.cos(Math.PI + j) * k),
          (j = f + Math.sin(Math.PI + j) * k),
          (c.rightContX = e),
          (c.rightContY = j));
      d
