...
var ZeroClipboard_TableTools = {
  ...
  getDOMObjectPosition: function (obj) {
    ...
    if (obj.style.width != "") info.width = obj.style.width.replace("px", "");
...
ZeroClipboard_TableTools.Client.prototype = {
  ...
  getHTML: function (width, height) {
    ...
    if (navigator.userAgent.match(/MSIE/)) {
      ...
      html +=
        '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="/js/' +
        protocol +
        ...
        '" id="' +
        this.movieId +
        '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="/js/' +
