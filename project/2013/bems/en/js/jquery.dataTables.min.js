  ...
  var L = function (h) {
    var j = function (e) {
      ...
      function m(a, b, c) {
        ...
        !d.bSortable || (-1 == h.inArray("asc", d.asSorting) && -1 == h.inArray("desc", d.asSorting))
          ? ((d.sSortingClass = a.oClasses.sSortableNone), (d.sSortingClassJUI = ""))
          : -1 == h.inArray("asc", d.asSorting) && -1 == h.inArray("desc", d.asSorting)
            ? ((d.sSortingClass = a.oClasses.sSortable), (d.sSortingClassJUI = a.oClasses.sSortJUI))
            : -1 != h.inArray("asc", d.asSorting) && -1 == h.inArray("desc", d.asSorting)
              ? ((d.sSortingClass = a.oClasses.sSortableAsc), (d.sSortingClassJUI = a.oClasses.sSortJUIAscAllowed))
              : -1 == h.inArray("asc", d.asSorting) &&
                -1 != h.inArray("desc", d.asSorting) &&
                ((d.sSortingClass = a.oClasses.sSortableDesc), (d.sSortingClassJUI = a.oClasses.sSortJUIDescAllowed));
      }
      function k(a) {
      ...
      function H(a, b) {
        ...
        for (var f, i = 0, g = a.aoColumns.length; i < g; i++)
          ((c = a.aoColumns[i]),
            "function" === typeof c.fnRender && c.bUseRendered && null !== c.mData
              ? F(a, d, i, S(a, d, i))
              : F(a, d, i, v(a, d, i)),
            c._bAutoType &&
              "string" != c.sType &&
            ...
            a.iDrawError != a.iDraw &&
              ...
              (D(
                ...
                "Requested unknown parameter " +
                  ("function" == typeof i.mData ? "{mData function}" : "'" + i.mData + "'") +
      ...
      function S(a, b, c) {
        var d = a.aoColumns[c];
        return d.fnRender(
          { iDataRow: b, iDataColumn: c, oSettings: a, aData: a.aoData[b]._aData, mDataProp: d.mData },
          v(a, b, c, "display"),
        );
      }
      function ea(a, b) {
        ...
        if (null === c.nTr) {
          ...
          for (var i = 0, f = a.aoColumns.length; i < f; i++) {
            ...
            d.innerHTML =
              "function" === typeof g.fnRender && (!g.bUseRendered || null === g.mData)
                ? S(a, b, i)
                : v(a, b, i, "display");
          ...
          for (d = a.aoColumns.length; b < d; b++)
            if (
              ...
              a.aoColumns[b].bSortable &&
                (c.setAttribute("tabindex", a.iTabIndex), c.setAttribute("aria-controls", a.sTableId)),
          ...
          if (0 !== a.aiDisplay.length) {
            ...
            ((b[0] = l.createElement("tr")),
              ...
              1 == a.iDraw && null !== a.sAjaxSource && !a.oFeatures.bServerSide
                ? (f = c.sLoadingRecords)
                : c.sEmptyTable && 0 === a.fnRecordsTotal() && (f = c.sEmptyTable),
      ...
      function xa(a) {
        ...
        a.nTableWrapper = h(
          '<div id="' + a.sTableId + '_wrapper" class="' + a.oClasses.sWrapper + '" role="grid"></div>',
        )[0];
        ...
        for (var c = a.nTableWrapper, d = a.sDom.split(""), i, f, g, e, w, o, k, m = 0; m < d.length; m++) {
          ...
          if ("<" == g) {
            ...
            if ("'" == w || '"' == w) {
              ...
              -1 != o.indexOf(".")
                ? ((w = o.split(".")), (e.id = w[0].substr(1, w[0].length - 1)), (e.className = w[1]))
                : "#" == o.charAt(0)
      ...
      function Ea(a) {
        ...
        for (f = 0; f < b; f++)
          ((d = a.aoColumns[f].mData),
            c.push({ name: "mDataProp_" + f, value: "function" === typeof d ? "function" : d }));
      ...
      function za(a) {
        ...
        c.bind("keyup.DT", function () {
          ...
          d != b.sSearch &&
            K(a, { sSearch: d, bRegex: b.bRegex, bSmart: b.bSmart, bCaseInsensitive: b.bCaseInsensitive });
        });
      ...
      function la(a, b) {
        if (!a.oFeatures.bServerSide) {
          a.asDataSearch = [];
          for (
            var c = r(a, "bSearchable"), d = 1 === b ? a.aiDisplayMaster : a.aiDisplay, i = 0, f = d.length;
            i < f;
            i++
          )
      ...
      function y(a) {
        a._iDisplayEnd =
          !1 === a.oFeatures.bPaginate
            ? a.aiDisplay.length
            : a._iDisplayStart + a._iDisplayLength > a.aiDisplay.length || -1 == a._iDisplayLength
              ? a.aiDisplay.length
      ...
      function qa(a, b) {
        ...
        if ("number" === typeof b)
          ...
          0 <= a._iDisplayLength
            ? a._iDisplayStart + a._iDisplayLength < a.fnRecordsDisplay() && (a._iDisplayStart += a._iDisplayLength)
            : (a._iDisplayStart = 0);
        else if ("last" == b)
        ...
        a.oScroll.bInfinite &&
          h(i).scroll(function () {
            if (
              !a.bDrawing &&
              h(this).scrollTop() !== 0 &&
              h(this).scrollTop() + h(this).height() > h(a.nTable).height() - a.oScroll.iLoadGap &&
          ...
          "" !== a.oScroll.sXInner
            ...
            : i == h(d).width() && h(d).height() < h(a.nTable).height()
              ? ((a.nTable.style.width = q(i - a.oScroll.iBarWidth)),
                h(a.nTable).outerWidth() > i - a.oScroll.iBarWidth && (a.nTable.style.width = q(i)))
      ...
      function da(a) {
        ...
        for (f = 0; f < i; f++)
          a.aoColumns[f].bVisible &&
            ...
            null !== a.aoColumns[f].sWidth &&
              ((c = Ma(a.aoColumns[f].sWidthOrig, e)), null !== c && (a.aoColumns[f].sWidth = q(c)), b++));
        if (i == j.length && 0 === b && d == i && "" === a.oScroll.sX && "" === a.oScroll.sY)
          ...
          "" !== a.oScroll.sX && "" !== a.oScroll.sXInner
            ...
            : "" !== a.oScroll.sX
              ? ((b.style.width = ""), h(b).width() < e.offsetWidth && (b.style.width = q(e.offsetWidth)))
              : "" !== a.oScroll.sY
          ...
          for (f = d = 0; f < a.aoColumns.length; f++)
            a.aoColumns[f].bVisible &&
              ((e = h(i[d]).width()), null !== e && 0 < e && (a.aoColumns[f].sWidth = q(e)), d++);
          i = h(b).css("width");
      ...
      function O(a, b) {
        ...
        for (d = a.aoColumns.length; c < d; c++)
          ((e = q[c].sTitle.replace(/<.*?>/g, "")),
            ...
            q[c].bSortable
              ? 0 < o.length && o[0][0] == c
                ? (i.setAttribute("aria-sort", "asc" == o[0][1] ? "ascending" : "descending"),
                  i.setAttribute(
                    "aria-label",
                    e +
                      ("asc" == (q[c].asSorting[o[0][2] + 1] ? q[c].asSorting[o[0][2] + 1] : q[c].asSorting[0])
                        ? G.sSortAscending
                        : G.sSortDescending),
                  ))
                : i.setAttribute("aria-label", e + ("asc" == q[c].asSorting[0] ? G.sSortAscending : G.sSortDescending))
              : i.setAttribute("aria-label", e));
        a.bSorted = !0;
        h(a.oInstance).trigger("sort", a);
        a.oFeatures.bFilter
          ? K(a, a.oPreviousSearch, 1)
          : ((a.aiDisplay = a.aiDisplayMaster.slice()), (a._iDisplayStart = 0), y(a), x(a));
      }
      function ia(a, b, c, d) {
        Ra(b, {}, function (b) {
              ...
              if (b.shiftKey) {
                for (var f = !1, h = 0; h < a.aaSorting.length; h++)
                  if (a.aaSorting[h][0] == c) {
                    ...
                    a.aoColumns[d].asSorting[e]
                      ? ((a.aaSorting[h][1] = a.aoColumns[d].asSorting[e]), (a.aaSorting[h][2] = e))
                ...
                1 == a.aaSorting.length && a.aaSorting[0][0] == c
                  ? ((d = a.aaSorting[0][0]),
                    ...
                    (a.aaSorting[0][2] = e))
                  : (a.aaSorting.splice(0, a.aaSorting.length), a.aaSorting.push([c, a.aoColumns[c].asSorting[0], 0]));
              O(a);
            };
      ...
      function P(a) {
        ...
        for (b = 0; b < g; b++)
          a.aoColumns[b].bSortable &&
            h(a.aoColumns[b].nTh).removeClass(j.sSortAsc + " " + j.sSortDesc + " " + a.aoColumns[b].sSortingClass);
        ...
        for (b = 0; b < a.aoColumns.length; b++)
          if (a.aoColumns[b].bSortable) {
            ...
            a.bJUI &&
              ...
              f.addClass(
                -1 == e ? a.aoColumns[b].sSortingClassJUI : "asc" == c[e][1] ? j.sSortJUIAsc : j.sSortJUIDesc,
              ));
          ...
          for (c = a.length; b < c; b++)
            ((j = b % g),
              ...
              j != d
                ...
                : 0 < o.length && -1 == d.indexOf(o) && (a[b].className = d + " " + o));
        }
      }
      function ra(a) {
      ...
      this.fnDeleteRow = function (a, b, c) {
        ...
        d._iDisplayStart >= d.fnRecordsDisplay() &&
          ((d._iDisplayStart -= d._iDisplayLength), 0 > d._iDisplayStart && (d._iDisplayStart = 0));
        if (c === n || c) (y(d), x(d));
        return g;
      };
      this.fnDestroy = function (a) {
        ...
        b.nTFoot &&
          ...
          (h(b.nTable).children("tfoot").remove(), b.nTable.appendChild(b.nTFoot));
        ...
        h("th, td", b.nTHead).removeClass(
          [b.oClasses.sSortable, b.oClasses.sSortableAsc, b.oClasses.sSortableDesc, b.oClasses.sSortableNone].join(" "),
        );
        b.bJUI &&
          (h("th span." + b.oClasses.sSortIcon + ", td span." + b.oClasses.sSortIcon, b.nTHead).remove(),
      ...
      this.fnFilter = function (a, b, c, d, e, f) {
        ...
        if (g.oFeatures.bFilter) {
          ...
          if (b === n || null === b) {
            ...
            (h.extend(g.aoPreSearchCols[b], { sSearch: a + "", bRegex: c, bSmart: d, bCaseInsensitive: f }),
        ...
        if (g[a].bVisible != b) {
          if (b) {
            ...
            for (f = h.length; e < f; e++)
              null !== h[e].nTr &&
                (m ? h[e].nTr.appendChild(h[e]._anHidden[a]) : h[e].nTr.insertBefore(h[e]._anHidden[a], J(d, e)[o]));
          } else {
            e = 0;
            for (f = h.length; e < f; e++)
      ...
      this.oApi = {
        ...
        _fnCreateCookie: function (a, b, c, d, e) {
          ...
          var c = X.location.pathname.split("/"),
            ...
            g;
          null !== e
            ? ((g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")")),
              (b = e(a, g, f.toGMTString(), c.join("/") + "/")))
            : (b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("/") + "/");
          a = l.cookie.split(";");
          e = b.split(";")[0].length;
          f = [];
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          g.oFeatures.bServerSide && g.oFeatures.bSort && g.oFeatures.bSortClasses
            ? z(g, "aoDrawCallback", P, "server_side_sort_classes")
            : g.oFeatures.bDeferRender && z(g, "aoDrawCallback", P, "defer_sort_classes");
          e.bJQueryUI
            ? (h.extend(g.oClasses, j.ext.oJUIClasses),
              e.sDom === j.defaults.sDom && "lfrtip" === j.defaults.sDom && (g.sDom = '<"H"lfr>t<"F"ip>'))
      ...
      fnDisplayEnd: function () {
        return this.oFeatures.bServerSide
          ? !1 === this.oFeatures.bPaginate || -1 == this._iDisplayLength
            ...
            : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay)
          : this._iDisplayEnd;
      },
      oInstance: null,
      sInstance: null,
        ...
        fnUpdate: function (e, o) {
          if (e.aanFeatures.p) {
            ...
            for (m = r; m <= k; m++)
              t +=
                n !== m
                  ? '<a tabindex="' + e.iTabIndex + '" class="' + B.sPageButton + '">' + e.fnFormatNumber(m) + "</a>"
                  : '<a tabindex="' +
                    e.iTabIndex +
                    '" class="' +
                    B.sPageButtonActive +
            ...
            for (k = M.length; m < k; m++)
              ((u = M[m]),
                u.hasChildNodes() &&
                  ...
                  h([u[2], u[3]]).addClass(
                    0 === l || n === l || -1 === e._iDisplayLength ? B.sPageButtonStaticDisabled : B.sPageButton,
                  )));
          }
        },
      },
