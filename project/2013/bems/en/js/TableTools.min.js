...
(function (e, n, g) {
  ...
  TableTools.prototype = {
    ...
    fnSelect: function (a) {
      "single" == this.s.select.type
        ? (this.fnSelectNone(), this._fnRowSelect(a))
        : "multi" == this.s.select.type && this._fnRowSelect(a);
    },
    ...
    fnGetTitle: function (a) {
      ...
      "undefined" != typeof a.sTitle && "" !== a.sTitle
        ? (b = a.sTitle)
        : ((a = g.getElementsByTagName("title")), 0 < a.length && (b = a[0].innerHTML));
    ...
    fnCalcColRatios: function (a) {
      var b = this.s.dt.aoColumns,
        ...
        g;
      e = 0;
      for (g = a.length; e < g; e++) a[e] && ((d = b[e].nTh.offsetWidth), (f += d), c.push(d));
      e = 0;
      for (g = c.length; e < g; e++) c[e] /= f;
      return c.join("\t");
    },
    ...
    _fnCreateButton: function (a, b) {
      ...
      a.sAction.match(/flash/)
        ? this._fnFlashConfig(c, a)
        : "text" == a.sAction
          ? this._fnTextConfig(c, a)
          : "div" == a.sAction
            ? this._fnTextConfig(c, a)
            : "collection" == a.sAction && (this._fnTextConfig(c, a), this._fnCollectionConfig(c, a));
      return c;
    },
    _fnButtonBase: function (a, b) {
      var c, d, f;
      b
        ? ((c = "default" !== a.sTag ? a.sTag : this.s.tags.collection.button),
          (d = "default" !== a.sLinerTag ? a.sLiner : this.s.tags.collection.liner),
          (f = this.classes.collection.buttons.normal))
        : ((c = "default" !== a.sTag ? a.sTag : this.s.tags.button),
          (d = "default" !== a.sLinerTag ? a.sLiner : this.s.tags.liner),
    ...
    _fnCollectionShow: function (a, b) {
      ...
      m = e(f).outerWidth();
      k = e(f).outerHeight();
      j + m > o && (f.style.left = o - m + "px");
      d + k > h && (f.style.top = d - k - e(a).outerHeight() + "px");
    ...
    _fnRowSelectConfig: function () {
      if (this.s.master) {
        ...
        e(b.nTBody).on("click.DTTT_Select", "tr", function (c) {
          this.parentNode == b.nTBody &&
            null !== b.oInstance.fnGetData(this) &&
            (a.fnIsSelected(this)
              ? a._fnRowDeselect(this, c)
              : "single" == a.s.select.type
                ? (a.fnSelectNone(), a._fnRowSelect(this, c))
                : "multi" == a.s.select.type && a._fnRowSelect(this, c));
        });
    ...
    _fnSelectData: function (a) {
      ...
      if (a.nodeName) ((c = this.s.dt.oInstance.fnGetPosition(a)), b.push(this.s.dt.aoData[c]));
        ...
        for (f = a.length; d < f; d++)
          a[d].nodeName
            ? ((c = this.s.dt.oInstance.fnGetPosition(a[d])), b.push(this.s.dt.aoData[c]))
            : "number" === typeof a[d]
    ...
    _fnGetDataTablesData: function (a) {
      ...
      var p = k.aiDisplay;
      f = this.fnGetSelected();
      if ("none" !== this.s.select.type && d && 0 !== f.length) {
        p = [];
        b = 0;
        for (c = f.length; b < c; b++) p.push(k.oInstance.fnGetPosition(f[b]));
      }
      d = 0;
      for (f = p.length; d < f; d++) {
        ...
        for (c = k.aoColumns.length; b < c; b++)
          n[b] &&
            ((h = k.oApi._fnGetCellData(k, p[d], b, "display")),
            a.fnCellRender
              ? (h = a.fnCellRender(h, b, o, p[d]) + "")
              : "string" == typeof h
                ? ((h = h.replace(/\n/g, " ")),
        ...
        g.push(j.join(a.sFieldSeperator));
        a.bOpenRows &&
          ((b = e.grep(k.aoOpenRows, function (a) {
            return a.nParent === o;
          })),
          1 === b.length && ((h = this._fnBoundData(e("td", b[0].nTr).html(), a.sFieldBoundary, l)), g.push(h)));
      }
      if (a.bFooter && null !== k.nTFoot) {
        ...
        for (c = k.aoColumns.length; b < c; b++)
          n[b] &&
            null !== k.aoColumns[b].nTf &&
            ((h = k.aoColumns[b].nTf.innerHTML.replace(/\n/g, " ").replace(/<.*?>/g, "")),
            (h = this._fnHtmlDecode(h)),
            j.push(this._fnBoundData(h, a.sFieldBoundary, l)));
        g.push(j.join(a.sFieldSeperator));
      }
    ...
    _fnPrintStart: function (a) {
      ...
      for (f in d)
        if ("i" != f && "t" != f && 1 == f.length)
          for (var j = 0, m = d[f].length; j < m; j++)
            (this.dom.print.hidden.push({ node: d[f][j], display: "block" }), (d[f][j].style.display = "none"));
      e(g.body).addClass(this.classes.print.body);
      "" !== a.sInfo && this.fnInfo(a.sInfo, 3e3);
      a.sMessage &&
        ((this.dom.print.message = g.createElement("div")),
        (this.dom.print.message.className = this.classes.print.message),
        (this.dom.print.message.innerHTML = a.sMessage),
        g.body.insertBefore(this.dom.print.message, g.body.childNodes[0]));
      this.s.print.saveScroll = e(n).scrollTop();
      n.scrollTo(0, 0);
      e(g).bind("keydown.DTTT", function (a) {
        if (a.keyCode == 27) {
          a.preventDefault();
    ...
    _fnPrintHideNodes: function (a) {
      for (var b = this.dom.print.hidden, c = a.parentNode, d = c.childNodes, f = 0, g = d.length; f < g; f++)
        if (d[f] != a && 1 == d[f].nodeType) {
          var m = e(d[f]).css("display");
          "none" != m && (b.push({ node: d[f], display: m }), (d[f].style.display = "none"));
        }
  ...
  TableTools.BUTTONS = {
    ...
    copy: e.extend({}, TableTools.buttonBase, {
      ...
      fnComplete: function (a, b, c, d) {
        ...
        this.fnInfo(
          "<h6>테이블이 복사되었습니다.</h6><p> " +
            a +
            " " +
            (1 == a ? "" : "") +
            "개 행이 클립보드에 저장 되었습니다.</p>",
          1500,
        );
      },
    }),
    ...
    print: e.extend({}, TableTools.buttonBase, {
      sInfo:
        "<h6>인쇄 미리보기</h6><p>인쇄를 원할 경우, 브라우저의 인쇄 기능을 통해 인쇄 할 수 있습니다.<br/>미리보기를 끝내시려면 ‘ESC 키’를 누르세요 .",
      sMessage: null,
      bShowAll: !0,
