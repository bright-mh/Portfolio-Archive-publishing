...
(function (root, doc, factory) {
    ...
    $.widget("mobile.widget", {
      ...
      _getCreateOptions: function () {
        ...
        $.each(this.options, function (option) {
          var value = elem.jqmData(
            option.replace(/[A-Z]/g, function (c) {
  ...
  (function ($, window) {
    ...
    $.widget("mobile.loader", {
      ...
      defaultHtml:
        "<div class='" + loaderClass + "'>" + "<span class='ui-icon ui-icon-loading'></span>" + "<h1></h1>" + "</div>",
      ...
      fakeFixLoader: function () {
        ...
        this.element.css({
          top:
            ($.support.scrollTop && $window.scrollTop() + $window.height() / 2) ||
  ...
  */
  ...
  (function ($, undefined) {
    ...
    function removeActiveLinkClass(forceRemoval) {
      if (
        !!$activeClickedLink &&
        (!$activeClickedLink.closest("." + $.mobile.activePageClass).length || forceRemoval)
      ) {
      ...
      if (!($.mobile.allowCrossDomainPages || path.isSameDomain(documentUrl, absUrl))) {
        ...
        $.ajax({
          ...
          success: function (html, textStatus, xhr) {
            ...
            if (!page.length) {
              page = $(
                "<div data-" + $.mobile.ns + "role='page'>" + (html.split(/<\/?body[^>]*>/gim)[1] || "") + "</div>",
              );
            }
    ...
    $.mobile.changePage = function (toPage, options) {
      ...
      var newPageTitle = !active
        ? pageTitle
        : toPage.jqmData("title") || toPage.children(":jqmData(role='header')").find(".ui-title").text();
      ...
      transitionPages(toPage, fromPage, settings.transition, settings.reverse).done(
    ...
    $.mobile._registerInternalEvents = function () {
      ...
      $.mobile._handleHashChange = function (url, data) {
        ...
        if (to) {
          ...
          if (
            to === path.makeUrlAbsolute("#" + urlHistory.initialDst, documentBase) &&
            urlHistory.stack.length &&
            urlHistory.stack[0].url !== urlHistory.initialDst.replace(dialogHashKey, "")
          ) {
            to = $.mobile.firstPage;
          }
            ...
            $.fn.buttonMarkup.defaults,
            {
              ...
              theme:
                options.theme !== undefined
                  ? options.theme
                  : getAttrFixed(e, nsKey + "theme") || $.mobile.getInheritedTheme(el, "c"),
        ...
        "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart": function (event) {
          ...
          if ($btn.length) {
            ...
            if (evt === "vmousedown") {
              ...
              updateButtonClass(
                $btn,
                "ui-btn-hover-" + theme + " ui-btn-down-" + theme,
                "ui-btn-up-" + theme,
                false,
                "up",
              );
      ...
      _create: function () {
        var $el = this.element,
          ...
          collapsibleContent = collapsible
            .wrapInner("<div class='ui-collapsible-content'></div>")
        ...
        if (collapsibleHeading.is("legend")) {
          collapsibleHeading = $("<div role='heading'>" + collapsibleHeading.html() + "</div>").insertBefore(
            collapsibleHeading,
          );
      ...
      $.extend(
        {
            ...
            for (i = 0; i < len; i++) {
              ...
              if (img.length) {
                ...
                $(this._findFirstElementByTagName(img[0].parentNode, "parentNode", "li", "LI")).addClass(
                  img.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb",
                );
              }
            }
          },
          ...
          _createSubPages: function () {
            ...
            $(parentList.find("li>ul, li>ol").toArray().reverse())
              .each(function (i) {
                var self = this,
                  list = $(this),
                  ...
                  nodeEls = nodeElsFull.length
                    ? nodeElsFull
                    : $("<span>" + $.trim(parent.contents()[0].nodeValue) + "</span>"),
                ...
                newPage = list
                  ...
                  .after(
                    persistentFooterID
                      ? $("<div " + dns + "role='footer' " + dns + "id='" + persistentFooterID + "'>")
                      : "",
                  )
                  .parent()
      ...
      $.extend(
        {
          ...
          refresh: function () {
            var input = this.element[0],
              ...
              checkedClass =
                this.checkedClass + (this.element.parents(".ui-controlgroup-horizontal").length ? active : ""),
              label = this.label;

            if (input.checked) {
              label
                .removeClass(this.uncheckedClass + active)
                .addClass(checkedClass)
                .buttonMarkup({ icon: this.checkedicon });
            } else {
      ...
      $.extend(
        {
          ...
          _create: function () {
            ...
            handle.buttonMarkup({ corners: true, theme: theme, shadow: true }).attr({
              role: "slider",
              "aria-valuemin": min,
              "aria-valuemax": max,
  ...
  (function ($, undefined) {
    ...
    $.widget("mobile.popup", $.mobile.widget, {
      ...
      _create: function () {
        ...
        this.element.toggleClass("ui-overlay-shadow", o.shadow).toggleClass("ui-corner-all", o.corners);
  ...
  (function ($, undefined) {
    var extendSelect = function (widget) {
      var select = widget.select,
        ...
        listbox = $("<div id='" + popupID + "' class='ui-selectmenu'>")
          .insertAfter(widget.select)
          .popup({ theme: widget.options.overlayTheme }),
        list = $("<ul>", {
      ...
      $.extend(widget, {
        ...
        build: function () {
          ...
          if (self._origTabIndex === undefined) {
            ...
            // none present.
            self._origTabIndex =
              self.select[0].getAttribute("tabindex") === null ? false : self.select.attr("tabindex");
          }
          ...
          self.button.bind("vclick keydown", function (event) {
            ...
            if (
              ...
              if (self.menuType === "overlay") {
                self.button
                  .attr("href", "#" + escapeId(self.popupID))
                  .attr("data-" + ($.mobile.ns || "") + "rel", "popup");
              } else {
                self.button
                  .attr("href", "#" + escapeId(self.dialogID))
            ...
            .delegate("li:not(.ui-disabled, .ui-li-divider)", "click", function (event) {
              ...
              if (self.isMultiple) {
                self.list
                  ...
                  .eq(newIndex)
                  .addClass("ui-btn-down-" + widget.options.theme)
                  .find("a")
                  .first()
                  .focus();
              } else {
        ...
        _buildList: function () {
          ...
          for (var i = 0; i < numOptions; i++, isPlaceholderItem = false) {
            ...
            if (
              needPlaceholder &&
              (!option.getAttribute("value") || text.length === 0 || $option.jqmData("placeholder"))
            ) {
    ...
    $.mobile.document.bind("selectmenubeforecreate", function (event) {
      ...
      if (
        !selectmenuWidget.options.nativeMenu &&
  ...
  (function ($, undefined) {
    $.widget("mobile.fixedtoolbar", $.mobile.widget, {
      options: {
        ...
        tapToggle: true,
        tapToggleBlacklist:
          "a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed, .ui-popup, .ui-panel, .ui-panel-dismiss-open",
      ...
      _destroy: function () {
        ...
        $el
          .closest(".ui-page")
          .removeClass("ui-page-header-fixed ui-page-footer-fixed ui-page-header-fullscreen ui-page-footer-fullscreen");
      },
    });
    ...
    $.mobile.document.bind("pagecreate create", function (e) {
      ...
      if ($(e.target).jqmData("fullscreen")) {
        $($.mobile.fixedtoolbar.prototype.options.initSelector, e.target)
          .not(":jqmData(fullscreen)")
          .jqmData("fullscreen", true);
      }
  ...
  (function ($, undefined) {
    $.widget("mobile.panel", $.mobile.widget, {
        ...
        var self = this,
          ...
          _getPanelInner = function () {
            ...
            if ($panelInner.length === 0) {
              $panelInner = $el
                .children()
                .wrapAll('<div class="' + self.options.classes.panelInner + '" />')
                .parent();
            }
            return $panelInner;
          },
          _getWrapper = function () {
            ...
            if ($wrapper.length === 0) {
              $wrapper = page
                ...
                .wrapAll('<div class="' + self.options.classes.contentWrap + " " + _getPageTheme() + '" />')
                .parent();
          ...
          _getFixedToolbar = function () {
            ...
            if ($fixedToolbar.length === 0) {
              $fixedToolbar = page
                ...
                .addClass(self.options.classes.contentFixedToolbar);
              if ($.support.cssTransform3d && !!self.options.animate) {
      ...
      _destroy: function () {
        ...
        this.element
          .removeClass([this._getPanelClasses(), classes.panelAnimate].join(" "))
  ...
  (function ($, undefined) {
    ...
    $.mobile.document.delegate(":jqmData(role='table')", "tablecreate refresh", function (e) {
      ...
      if (event !== "refresh") {
        ...
        $menuButton.insertBefore($table).buttonMarkup({
