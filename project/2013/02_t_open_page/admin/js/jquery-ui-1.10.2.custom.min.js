...
(function (e, t) {
  function i(t, i) {
    ...
    return "area" === o
      ? ((a = t.parentNode),
        (n = a.name),
        t.href && n && "map" === a.nodeName.toLowerCase() ? ((r = e("img[usemap=#" + n + "]")[0]), !!r && s(r)) : !1)
  ...
  ((e.cleanData = function (t) {
    ...
    (e.widget = function (i, s, n) {
      ...
      ((i = i.split(".")[1]),
        ...
        e.extend(o, r, { version: n.version, _proto: e.extend({}, n), _childConstructors: [] }),
        (h = new s()),
            ...
            ? this.each(function () {
                ...
                return n
                  ? e.isFunction(n[r]) && "_" !== r.charAt(0)
                    ? ((s = n[r].apply(n, h)),
                      s !== n && s !== t ? ((l = s && s.jquery ? l.pushStack(s.get()) : s), !1) : t)
      ...
      _on: function (i, s, n) {
        ...
        ("boolean" != typeof i && ((n = s), (s = i), (i = !1)),
          ...
          e.each(n, function (n, o) {
            function h() {
              return i || (r.options.disabled !== !0 && !e(this).hasClass("ui-state-disabled"))
      ...
      return (
        ...
        t.each(["my", "at"], function () {
          var t,
            ...
            s = (e[this] || "").split(" ");
          (1 === s.length &&
            (s = l.test(s[0]) ? s.concat(["center"]) : c.test(s[0]) ? ["center"].concat(s) : ["center", "center"]),
        ...
        top: function (t, e) {
          ...
          0 > c
            ? ((s = t.top + p + f + m + e.collisionHeight - o - a),
              t.top + p + f + m > c && (0 > s || r(c) > s) && (t.top += p + f + m))
            : u > 0 &&
  ...
  (e.widget("ui.draggable", e.ui.mouse, {
    ...
    _mouseStop: function (t) {
      var i,
        ...
        a = !1;
      for (
        e.ui.ddmanager && !this.options.dropBehaviour && (a = e.ui.ddmanager.drop(this, t)),
      ...
      return n || "original" !== this.options.helper
        ? (("invalid" === this.options.revert && !a) ||
          ...
          (e.isFunction(this.options.revert) && this.options.revert.call(this.element, a))
    ...
    _setContainment: function () {
      ...
      if (
        ...
        ("document" === n.containment || "window" === n.containment) &&
          (this.containment = [
            ...
            ("document" === n.containment ? 0 : e(window).scrollTop()) +
              (e("document" === n.containment ? document : window).height() || document.body.parentNode.scrollHeight) -
        ...
        ((t = "hidden" !== e(s).css("overflow")),
          (this.containment = [
            (parseInt(e(s).css("borderLeftWidth"), 10) || 0) + (parseInt(e(s).css("paddingLeft"), 10) || 0),
            (parseInt(e(s).css("borderTopWidth"), 10) || 0) + (parseInt(e(s).css("paddingTop"), 10) || 0),
    ...
    _convertPositionTo: function (t, i) {
      ...
      var s = "absolute" === t ? 1 : -1,
        n =
          "absolute" !== this.cssPosition ||
          (this.scrollParent[0] !== document && e.contains(this.scrollParent[0], this.offsetParent[0]))
            ? this.scrollParent
            : this.offsetParent,
    ...
    _generatePosition: function (t) {
      ...
      return (
        this.originalPosition &&
          ...
          o.grid &&
            ((n = o.grid[1]
              ? this.originalPageY + Math.round((u - this.originalPageY) / o.grid[1]) * o.grid[1]
              : this.originalPageY),
            (u = i
            ...
            this.instance._intersectsWith(this.instance.containerCache) &&
              ...
              e.each(s.sortables, function () {
                return (
                  ...
                  this !== o &&
                    this.instance._intersectsWith(this.instance.containerCache) &&
                    e.contains(o.instance.element[0], this.instance.element[0]) &&
                    (a = !1),
                  a
                );
              })),
        ...
        (i.scrollParent[0] !== document && "HTML" !== i.scrollParent[0].tagName
          ...
          : ((s.axis && "x" === s.axis) ||
              (t.pageY - e(document).scrollTop() < s.scrollSensitivity
                ? (n = e(document).scrollTop(e(document).scrollTop() - s.scrollSpeed))
                : e(window).height() - (t.pageY - e(document).scrollTop()) < s.scrollSensitivity &&
                  (n = e(document).scrollTop(e(document).scrollTop() + s.scrollSpeed))),
            (s.axis && "y" === s.axis) ||
              (t.pageX - e(document).scrollLeft() < s.scrollSensitivity
                ? (n = e(document).scrollLeft(e(document).scrollLeft() - s.scrollSpeed))
                : e(window).width() - (t.pageX - e(document).scrollLeft()) < s.scrollSensitivity &&
                  (n = e(document).scrollLeft(e(document).scrollLeft() + s.scrollSpeed)))),
          ...
          ((r = p.snapElements[c].left),
            ...
            (v > r - m && h + m > v && b > l - m && u + m > b)
              ? ("inner" !== f.snapMode &&
                  ...
                  s &&
                    (i.position.top =
                      p._convertPositionTo("relative", { top: l - p.helperProportions.height, left: 0 }).top -
                      p.margins.top),
                  n && (i.position.top = p._convertPositionTo("relative", { top: u, left: 0 }).top - p.margins.top),
                  a &&
                    (i.position.left =
                      p._convertPositionTo("relative", { top: 0, left: r - p.helperProportions.width }).left -
                      p.margins.left),
                  o && (i.position.left = p._convertPositionTo("relative", { top: 0, left: h }).left - p.margins.left)),
                (d = s || n || a || o),
                "outer" !== f.snapMode &&
                  ((s = m >= Math.abs(l - y)),
                  (n = m >= Math.abs(u - b)),
                  (a = m >= Math.abs(r - g)),
                  (o = m >= Math.abs(h - v)),
                  s && (i.position.top = p._convertPositionTo("relative", { top: l, left: 0 }).top - p.margins.top),
                  n &&
                    (i.position.top =
                      p._convertPositionTo("relative", { top: u - p.helperProportions.height, left: 0 }).top -
                      p.margins.top),
                  a && (i.position.left = p._convertPositionTo("relative", { top: 0, left: r }).left - p.margins.left),
                  o &&
                    (i.position.left =
                      p._convertPositionTo("relative", { top: 0, left: h - p.helperProportions.width }).left -
                      p.margins.left)),
                !p.snapElements[c].snapping &&
                  (s || n || a || o || d) &&
                  p.options.snap.snap &&
                  p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), { snapItem: p.snapElements[c].item })),
  ...
  (e.widget("ui.droppable", {
    ...
    (e.ui.intersect = function (e, i, s) {
      ...
      switch (s) {
        ...
        case "pointer":
          return (
            (n = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left),
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              r &&
                (this.options.greedy &&
                  ...
                  a.length && ((s = e.data(a[0], "ui-droppable")), (s.greedyChild = "isover" === r))),
      ...
      resize: function (t) {
        ...
        (d[0] !== document && /static/.test(d.css("position")) && (c = h),
          ...
          i + o.size.width >= o.parentData.width &&
            ((o.size.width = o.parentData.width - i), u && (o.size.height = o.size.width / o.aspectRatio)),
          s + o.size.height >= o.parentData.height &&
            ((o.size.height = o.parentData.height - s), u && (o.size.width = o.size.height * o.aspectRatio)));
      },
      stop: function () {
        ...
        this.position = this._generatePosition(e),
          ...
          this.options.scroll &&
            (this.scrollParent[0] !== document && "HTML" !== this.scrollParent[0].tagName
              ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < o.scrollSensitivity
              ...
              : (e.pageY - t(document).scrollTop() < o.scrollSensitivity
                  ...
                  : t(window).height() - (e.pageY - t(document).scrollTop()) < o.scrollSensitivity &&
                    (r = t(document).scrollTop(t(document).scrollTop() + o.scrollSpeed)),
                e.pageX - t(document).scrollLeft() < o.scrollSensitivity
                  ? (r = t(document).scrollLeft(t(document).scrollLeft() - o.scrollSpeed))
                  : t(window).width() - (e.pageX - t(document).scrollLeft()) < o.scrollSensitivity &&
                    (r = t(document).scrollLeft(t(document).scrollLeft() + o.scrollSpeed))),
          ...
          for (n = t(d[i]), s = n.length - 1; s >= 0; s--)
            ((a = t.data(n[s], this.widgetFullName)),
              a &&
                ...
                (u.push([
                  t.isFunction(a.options.items)
                    ? a.options.items.call(a.element[0], e, { item: this.currentItem })
      ...
      for (i = u.length - 1; i >= 0; i--)
        for (o = u[i][1], r = u[i][0], s = 0, l = r.length; l > s; s++)
          ((h = t(r[s])),
            ...
            c.push({ item: h, instance: o, width: 0, height: 0, left: 0, top: 0 }));
    },
        ...
        if (!t.contains(this.currentItem[0], this.containers[n].element[0]))
          if (this._intersectsWith(this.containers[n].containerCache)) {
            ...
            this.containers[n].containerCache.over &&
              (this.containers[n]._trigger("out", s, this._uiHash(this)), (this.containers[n].containerCache.over = 0));
      if (f)
        if (1 === this.containers.length)
          ...
          for (
            ...
            t.contains(this.containers[m].element[0], this.items[a].item[0]) &&
              ...
              (!p || e(this.positionAbs.top + this.offset.click.top, this.items[a].top, this.items[a].height)) &&
              ((u = this.items[a].item.offset()[h]),
              (d = !1),
              Math.abs(u - c) > Math.abs(u + this.items[a][l] - c) && ((d = !0), (u += this.items[a][l])),
              o > Math.abs(u - c) &&
                ((o = Math.abs(u - c)), (r = this.items[a]), (this.direction = d ? "up" : "down")));
    ...
    t.widget("ui.accordion", {
      ...
      _eventHandler: function (e) {
        var i = this.options,
          ...
          r = o ? t() : n.next(),
          h = s.next(),
          l = { oldHeader: s, oldPanel: h, newHeader: o ? t() : n, newPanel: r };
        (e.preventDefault(),
          (a && !i.collapsible) ||
                    ...
                    ((i.now = Math.round(t)),
                      "height" !== i.prop
                        ...
                        : "content" !== h.options.heightStyle &&
                          ((i.now = Math.round(a - e.outerHeight() - l)), (l = 0)));
                  },
                }),
                undefined)
              : e.animate(i, r, o, p)
    ...
    e.widget("ui.autocomplete", e.ui.autocomplete, {
      ...
      __response: function (e) {
        ...
        (this._superApply(arguments),
          this.options.disabled ||
            this.cancelSearch ||
            ((t = e && e.length ? this.options.messages.results(e.length) : this.options.messages.noResults),
    ...
    _resetButton: function () {
      ...
      (s.primary || s.secondary
        ? (this.options.text && a.push("ui-button-text-icon" + (n ? "s" : s.primary ? "-primary" : "-secondary")),
          ...
          this.options.text ||
            (a.push(n ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || e.attr("title", t.trim(i))))
        ...
        switch (e.keyCode) {
          ...
          case 13:
            return (
              ...
              i
                ? ((s = t.datepicker._formatDate(a)), i.apply(a.input ? a.input[0] : null, [s, a]))
                : t.datepicker._hideDatepicker(),
              !1
            );
          case 27:
          ...
          case 33:
            t.datepicker._adjustDate(
              e.target,
              e.ctrlKey ? -t.datepicker._get(a, "stepBigMonths") : -t.datepicker._get(a, "stepMonths"),
              "M",
            );
            break;
          case 34:
    ...
    parseDate: function (i, s, n) {
      ...
      if (
        (-1 === g
          ...
          : 100 > g && (g += new Date().getFullYear() - (new Date().getFullYear() % 100) + (u >= g ? 0 : -100)),
        b > -1)
      )
        for (v = 1, _ = b; ; ) {
        ...
        for (x = "", this.maxRows = 4, D = 0; K[1] > D; D++) {
          ...
          for (
            S +=
              ...
              this._generateMonthYearHeader(t, Z, te, G, $, k > 0 || D > 0, f, m) +
          ...
          (Z++,
            ...
            (S +=
              "</tbody></table>" +
              (q ? "</div>" + (K[0] > 0 && D === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")),
            (x += S));
        }
        y += x;
      }
            ...
            t.ui.dialog.overlayInstances &&
              this.document.bind("focusin.dialog", function (s) {
                e._allowInteraction(s) ||
                  (s.preventDefault(), t(".ui-dialog:visible:last .ui-dialog-content").data(i)._focusTabbable());
              });
          }),
  ...
  t.widget("ui.slider", t.ui.mouse, {
    ...
    value: function (t) {
      return arguments.length
        ? ((this.options.value = this._trimAlignValue(t)), this._refreshValue(), this._change(null, 0), undefined)
        : this._value();
    },
    values: function (e, i) {
      var s, n, a;
        ...
        switch (i.keyCode) {
          ...
          case t.ui.keyCode.LEFT:
            if (
              (i.preventDefault(),
              !this._keySliding &&
                ((this._keySliding = !0), t(i.target).addClass("ui-state-active"), (s = this._start(i, r)), s === !1))
            )
              return;
        }
        switch (
...
(function (t, e) {
  ...
  function s(t) {
    return (
      t.hash.length > 1 &&
      decodeURIComponent(t.href.replace(a, "")) === decodeURIComponent(location.href.replace(a, ""))
    );
  }
  var n = 0,
    a = /#.*$/;
            ...
            return (
              ...
              f(a.props, function (t, n) {
                ...
                null !== l &&
                  (null === o
                    ? (h[a] = l)
                    : (c.mod && (l - o > c.mod / 2 ? (o += c.mod) : o - l > c.mod / 2 && (o -= c.mod)),
                      (h[a] = i((l - o) * e + o, n))));
              }),
              this[n](h)
            );
                  ...
                  return "undefined" === o
                    ...
                    : ("function" === o && ((n = n.call(this, c)), (o = t.type(n))),
                      null == n && i.empty
                        ? this
                        : ("string" === o &&
                            ((a = r.exec(n)), a && (n = c + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))),
                          (l[i.idx] = n),
                          this[h](l)));
                });
            }));
...
(function (t) {
  t.effects.effect.bounce = function (e, i) {
    ...
    (l && ((n = { opacity: 0 }), (n[v] = (_ ? "-=" : "+=") + d), o.animate(n, m, g)),
      o.queue(function () {
      ...
      for (h = g.top + a * _, c = a - (u - 1) / 2, o = 0; d > o; o++)
        ((r = g.left + o * v),
          ...
          p
            ...
            .animate(
              { left: r + (m ? 0 : l * v), top: h + (m ? 0 : c * _), opacity: m ? 1 : 0 },
              e.duration || 500,
              e.easing,
              s,
            ));
  ...
  ((t.effects.effect.puff = function (e, i) {
    ...
    (t.effects.effect.scale = function (e, i) {
      ...
      ((n.effect = "size"),
        ...
        (n.from = e.from || ("show" === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : l)),
        (n.to = {
          height: l.height * c.y,
          width: l.width * c.x,
