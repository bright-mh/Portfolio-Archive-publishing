...
(function (a, b) {
  ...
  (f.extend({
    ...
    (f.support = (function () {
      ...
      (!a.addEventListener &&
        ...
        (m = { visibility: "hidden", width: 0, height: 0, border: 0, margin: 0, background: "none" }));
      ...
      (l.appendChild(a),
        ...
        c.defaultView &&
          ...
          (j.reliableMarginRight =
            (parseInt((c.defaultView.getComputedStyle(i, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0)),
        (l.innerHTML = ""),
        b.removeChild(l));
      if (a.attachEvent)
      ...
      promise: function (a, c) {
        ...
        while (g--)
          if (
            (l =
              f.data(e[g], i, b, !0) ||
              ((f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f._Deferred(), !0)))
          )
            (h++, l.done(m));
        m();
        return d.promise();
  ...
  (f.fn.extend({
    ...
    f.extend({
        ...
        select: {
          get: function (a) {
            ...
            for (var h = g ? c : 0, i = g ? c + 1 : e.length; h < i; h++) {
              ...
              if (
                j.selected &&
                (f.support.optDisabled ? !j.disabled : j.getAttribute("disabled") === null) &&
                (!j.parentNode.disabled || !f.nodeName(j.parentNode, "optgroup"))
              ) {
                b = f(j).val();
                if (g) return b;
                d.push(b);
      ...
      attr: function (a, c, d, e) {
        ...
        ((c = (j && f.attrFix[c]) || c),
          (i = f.attrHooks[c]),
          i ||
            (!t.test(c) || (typeof d != "boolean" && d !== b && d.toLowerCase() !== c.toLowerCase())
    ...
    (w = {
      ...
      set: function (a, b, c) {
        ...
        b === !1
          ? f.removeAttr(a, c)
          : ((d = f.propFix[c] || c), d in a && (a[d] = b), a.setAttribute(c, c.toLowerCase()));
        return c;
      },
    }),
    (f.attrHooks.value = {
      ...
      if (a.nodeType !== 3 && a.nodeType !== 8) {
        ...
        while ((l = c[m++])) {
          ((h = g ? f.extend({}, g) : { handler: d, data: e }),
            l.indexOf(".") > -1
              ? ((n = l.split(".")), (l = n.shift()), (h.namespace = n.slice(0).sort().join(".")))
              : ((n = []), (h.namespace = "")),
            (h.type = l),
        ...
        while ((h = c[k++])) {
          ((r = h),
            ...
            l ||
              ((m = h.split(".")),
              (h = m.shift()),
              (n = new RegExp("(^|\\.)" + f.map(m.slice(0).sort(), D).join("\\.(?:.*\\.)?") + "(\\.|$)"))),
            (p = t[h]));
          if (!p) continue;
          if (!d) {
      ...
      (a && a.type
        ? ((this.originalEvent = a),
          ...
          (this.isDefaultPrevented =
            a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? F : E))
        : (this.type = a),
        b && f.extend(this, b),
      ...
      clean: function (a, b, d, e) {
        ...
        for (var j = 0, k; (k = a[j]) != null; j++) {
          ...
          if (!f.support.appendChecked)
            if (k[0] && typeof (r = k.length) == "number") for (i = 0; i < r; i++) bm(k[i]);
            else bm(k);
  ...
  ((f.fn.css = function (a, c) {
    ...
    f.support.opacity ||
      (f.cssHooks.opacity = {
        get: function (a, b) {
          return bp.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "")
    ...
    f.expr &&
      ...
      ((f.expr.filters.hidden = function (a) {
        ...
        return (
          (b === 0 && c === 0) ||
          (!f.support.reliableHiddenOffsets && (a.style.display || f.css(a, "display")) === "none")
        );
      }),
        ...
        (h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              ...
              (r[1] == bX[1] &&
                r[2] == bX[2] &&
                (r[3] || (r[1] === "http:" ? 80 : 443)) == (bX[3] || (bX[1] === "http:" ? 80 : 443)))
            ))),
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (cd.test(b.url) || (e && cd.test(b.data))))) {
        ...
        (b.jsonp !== !1 &&
          ((j = j.replace(cd, l)),
          b.url === j &&
            (e && (k = k.replace(cd, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
              ...
              : ((l = cn.exec(h)),
                ...
                l
                  ? ((n = parseFloat(l[2])),
                    ...
                    o !== "px" &&
                      (f.style(this, i, (n || 1) + o), (m = ((n || 1) / k.cur()) * m), f.style(this, i, m + o)),
                    l[1] && (n = (l[1] === "-=" ? -1 : 1) * n + m),
                    k.custom(m, n, o))
                  : k.custom(m, h, "")));
        return !0;
          ...
          ((c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              f.offset.doesNotAddBorder &&
                (!f.offset.doesAddBorderForTableAndCells || !cw.test(b.nodeName)) &&
