...
(function (a, b) {
      ...
      (o.appendChild(a),
        ...
        c.defaultView &&
          ...
          (k.reliableMarginRight =
            (parseInt((c.defaultView.getComputedStyle(j, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0)),
        (o.innerHTML = ""),
        n.removeChild(o));
      if (a.attachEvent)
      ...
      (a && a.type
        ? ((this.originalEvent = a),
          ...
          (this.isDefaultPrevented =
            a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? E : D))
        : (this.type = a),
        b && f.extend(this, b),
      ...
      clean: function (a, b, d, e) {
        ...
        for (var j = 0, k; (k = a[j]) != null; j++) {
          ...
          if (!f.support.appendChecked)
            if (k[0] && typeof (r = k.length) == "number") for (i = 0; i < r; i++) bl(k[i]);
            else bl(k);
  ...
  ((f.fn.css = function (a, c) {
    ...
    f.support.opacity ||
      (f.cssHooks.opacity = {
        get: function (a, b) {
          return bo.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "")
        ...
        (h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              ...
              (r[1] == bU[1] &&
                r[2] == bU[2] &&
                (r[3] || (r[1] === "http:" ? 80 : 443)) == (bU[3] || (bU[1] === "http:" ? 80 : 443)))
            ))),
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (ca.test(b.url) || (e && ca.test(b.data))))) {
        ...
        (b.jsonp !== !1 &&
          ((j = j.replace(ca, l)),
          b.url === j &&
            (e && (k = k.replace(ca, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
            ...
            send: function (e, g) {
              ...
              (h.send((c.hasContent && c.data) || null),
                ...
                !c.async || h.readyState === 4
                  ? d()
                  : ((i = ++cc), cb && (cd || ((cd = {}), f(a).unload(cb)), (cd[i] = d)), (h.onreadystatechange = d)));
            },
            abort: function () {
              d && d(0, 1);
            },
          ...
          ((c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              f.offset.doesNotAddBorder &&
                (!f.offset.doesAddBorderForTableAndCells || !ct.test(b.nodeName)) &&
