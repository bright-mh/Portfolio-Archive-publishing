...
function selectBoxFocusMyMenu(thisId, classNameFocus) {
  //MyMeny
  var objId = thisId;
  var obj = document.getElementById(objId + "selectBoxSelectedValue");
...
function makeSelectBoxGlobal(
  ...
  newSelect =
    "<table id='" +
    objId +
    "selectBoxOptionLayer' cellpadding='0' cellspacing='0' border='0' style='position:absolute;z-index:100;display:none;' onMouseOver=\"viewOptionLayer('" +
    objId +
  ...
  newSelect +=
    "		<td height='" +
    (selectBoxHeight - 1) +
    "' style='cursor:pointer;' onClick=\"hideOptionLayer('" +
    objId +
    "')\" onMouseOut=\"hideOptionLayer('" +
    objId +
    "')\"></td>";
  newSelect += "	</tr>";
  newSelect += "	<tr>";
  ...
  newSelect +=
    "		<div id='" +
    objId +
    "SelectBoxOptionArea' class='selectBoxOptionInnerLayer' style='margin-top:1px; padding:3px 5px 4px 0; width:" +
    (selectBoxWidth - 2) +
    "px;" +
  ...
  newSelect += "</table>";
  newSelect +=
    "<table cellpadding='0' cellspacing='0' border='0' onClick=\"viewOptionLayer('" +
    objId +
    "')\" style='cursor:pointer;' onMouseOut=\"setMousePosition('out')\">";
  newSelect += "	<tr>";
  ...
  newSelect +=
    "				<td><div id='" +
    objId +
    "selectBoxSelectedValue' class='" +
    selectBoxSelectedArea +
    "' style='width:" +
    (selectBoxWidth - downArrowSrcWidth - 2) +
    "px;height:" +
    (selectBoxHeight - 2) +
    "px;overflow:hidden;' onBlur=\"selectBoxBlurMyMenu('" +
    objId +
    "', '" +
    selectBoxSelectedAreaFocus +
    "')\"></div></td>";
