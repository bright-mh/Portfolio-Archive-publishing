((function (a, b) {
  ...
  function e(a, b) {
    var c = {};
    return (
      K.each(cr.concat.apply([], cr.slice(0, b)), function () {
        c[this] = a;
      }),
      c
    );
        ...
        c !== "border" &&
          K.each(e, function () {
            (c || (d -= parseFloat(K.css(a, "padding" + this)) || 0),
              c === "margin"
                ? (d += parseFloat(K.css(a, c + this)) || 0)
                : (d -= parseFloat(K.css(a, "border" + this + "Width")) || 0));
          }),
        d + "px"
      );
    d = bJ(a, b, b);
  ...
  function q(a, b) {
    (b.src
      ? K.ajax({ url: b.src, async: !1, dataType: "script" })
  ...
  function A(a) {
    ...
    if (!(a.liveFired === this || !q || !q.live || a.target.disabled || (a.button && a.type === "click"))) {
      ...
      for (h = 0; h < r.length; h++)
        ((f = r[h]), f.origType.replace(Y, "") === a.type ? p.push(f.selector) : r.splice(h--, 1));
        ...
        for (h = 0; h < r.length; h++) {
          ...
          if (l.selector === f.selector && (!m || m.test(f.namespace)) && !l.elem.disabled) {
            ...
            if (f.preType === "mouseenter" || f.preType === "mouseleave")
              ((a.type = f.preType), (d = K(a.relatedTarget).closest(f.selector)[0]), d && K.contains(g, d) && (d = g));
  ...
  function E(a, c, d) {
    var e = c + "defer",
      ...
      h = K.data(a, e, b, !0);
    h &&
      (d === "queue" || !K.data(a, f, b, !0)) &&
      (d === "mark" || !K.data(a, g, b, !0)) &&
      setTimeout(function () {
      ...
      return (
        (d.fn = d.prototype =
          {
                ...
                if (f && (f[1] || !c)) {
                  if (f[1])
                    return (
                      ...
                      i
                        ? d.isPlainObject(c)
                          ? ((a = [H.createElement(i[1])]), d.fn.attr.call(a, c, !0))
            ...
            pushStack: function (a, b, c) {
              ...
              return (
                d.isArray(a) ? E.apply(e, a) : d.merge(e, a),
                (e.prevObject = this),
              ...
              if ((a = arguments[j]) != null)
                for (c in a) {
                  ...
                  l && f && (d.isPlainObject(f) || (g = d.isArray(f)))
                    ? (g ? ((g = !1), (h = e && d.isArray(e) ? e : [])) : (h = e && d.isPlainObject(e) ? e : {}),
                      (i[c] = d.extend(l, h, f)))
                    : f !== b && (i[c] = f);
                }
            return i;
        ...
        d.extend({
          ...
          bindReady: function () {
            if (!A) {
              ...
              if (H.addEventListener)
                (H.addEventListener("DOMContentLoaded", B, !1), a.addEventListener("load", d.ready, !1));
          ...
          parseXML: function (c) {
            ...
            try {
              a.DOMParser
                ? ((f = new DOMParser()), (e = f.parseFromString(c, "text/xml")))
                : ((e = new ActiveXObject("Microsoft.XMLDOM")), (e.async = "false"), e.loadXML(c));
            } catch (g) {
              e = b;
            }
            return (
              (!e || !e.documentElement || e.getElementsByTagName("parsererror").length) &&
          ...
          map: function (a, c, e) {
            var f,
              ...
              k =
                a instanceof d ||
                (j !== b && typeof j == "number" && ((j > 0 && a[0] && a[j - 1]) || j === 0 || d.isArray(a)));
        ...
        (z = d.uaMatch(y)),
        z.browser && ((d.browser[z.browser] = !0), (d.browser.version = z.version)),
        ...
        e = {
            ...
            if (!d) {
              ...
              for (f = 0, g = c.length; f < g; f++)
                ((h = c[f]), (i = K.type(h)), i === "array" ? e.done.apply(e, h) : i === "function" && a.push(h));
                ...
                K.isFunction(e)
                  ? b[a](function () {
                      ((g = e.apply(this, arguments)),
                        g && K.isFunction(g.promise)
                          ? g.promise().then(d.resolve, d.reject)
                          : d[f + "With"](this === b ? d : this, [g]));
                    })
                  : b[a](d[f]);
              });
            }).promise();
    ...
    (K.support = (function () {
      ...
      (m.appendChild(a),
        ...
        H.defaultView &&
          ...
          a.appendChild(h),
          (i.reliableMarginRight =
            (parseInt((H.defaultView.getComputedStyle(h, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0)),
        (m.innerHTML = ""),
        l.removeChild(m));
      if (a.attachEvent)
        for (r in { submit: 1, change: 1, focusin: 1 })
          ((q = "on" + r),
            (s = q in a),
            s || (a.setAttribute(q, "return;"), (s = typeof a[q] == "function")),
            (i[r + "Bubbles"] = s));
    ...
    data: function (a, c, d, e) {
      if (!!K.acceptData(a)) {
        ...
        return (
          ...
          c === "events" && !f[c]
            ? f[h] && f[h].events
            : (i ? ((g = f[c]), g == null && (g = f[K.camelCase(c)])) : (g = f), g)
        );
      }
    },
    removeData: function (a, b, c) {
      if (!!K.acceptData(a)) {
        ...
        (K.support.deleteExpando || !g.setInterval ? delete g[h] : (g[h] = null),
          i
            ? ((g[h] = {}), f || (g[h].toJSON = K.noop), (g[h][e] = i))
            : f &&
    ...
    K.fn.extend({
      data: function (a, c) {
          ...
          if (this.length) {
            ...
            if (this[0].nodeType === 1) {
              ...
              for (var g = 0, h = e.length; g < h; g++)
                ((f = e[g].name), f.indexOf("data-") === 0 && ((f = K.camelCase(f.substring(5))), G(this[0], f, d[f])));
            }
          }
          return d;
        }
        ...
        return (
          (i[1] = i[1] ? "." + i[1] : ""),
          c === b
            ? ((d = this.triggerHandler("getData" + i[1] + "!", [i[0]])),
              d === b && this.length && ((d = K.data(this[0], a)), (d = G(this[0], a, d))),
              d === b && i[1] ? this.data(i[0]) : d)
            : this.each(function () {
                var b = K(this),
                  d = [i[0], c];
      ...
      promise: function (a, c) {
        ...
        while (g--)
          if (
            (l =
              K.data(f[g], i, b, !0) ||
              ((K.data(f[g], j, b, !0) || K.data(f[g], k, b, !0)) && K.data(f[g], i, K._Deferred(), !0)))
          )
            (h++, l.done(d));
        return (d(), e.promise());
      },
  ...
  (K.fn.extend({
    ...
    val: function (a) {
      ...
      if (!arguments.length)
        return e
          ? ((c = K.valHooks[e.nodeName.toLowerCase()] || K.valHooks[e.type]),
            c && "get" in c && (d = c.get(e, "value")) !== b
              ? d
              : ((d = e.value), typeof d == "string" ? d.replace(R, "") : d == null ? "" : d))
          : b;
    ...
    K.extend({
        ...
        select: {
          get: function (a) {
            ...
            for (var g = f ? c : 0, h = f ? c + 1 : e.length; g < h; g++) {
              ...
              if (
                i.selected &&
                (K.support.optDisabled ? !i.disabled : i.getAttribute("disabled") === null) &&
                (!i.parentNode.disabled || !K.nodeName(i.parentNode, "optgroup"))
              ) {
                b = K(i).val();
                if (f) return b;
                d.push(b);
      ...
      attr: function (a, c, d, e) {
        ...
        if ("getAttribute" in a) {
          var g,
            ...
            i = f !== 1 || !K.isXMLDoc(a);
          return (
            i && ((c = K.attrFix[c] || c), (h = K.attrHooks[c]), h || (V.test(c) ? (h = X) : W && (h = W))),
            d !== b
              ? d === null
                ? (K.removeAttr(a, c), b)
              ...
              : h && "get" in h && i && (g = h.get(a, c)) !== null
                ? g
                : ((g = a.getAttribute(c)), g === null ? b : g)
          );
        }
        return K.prop(a, c, d);
      },
      ...
      prop: function (a, c, d) {
        ...
        var f,
          ...
          h = e !== 1 || !K.isXMLDoc(a);
        return (
          h && ((c = K.propFix[c] || c), (g = K.propHooks[c])),
          d !== b
            ? g && "set" in g && (f = g.set(a, d, c)) !== b
              ? f
              : (a[c] = d)
            : g && "get" in g && (f = g.get(a, c)) !== null
              ? f
              : a[c]
        );
      },
        ...
        tabIndex: {
          get: function (a) {
            ...
            return c && c.specified
              ? parseInt(c.value, 10)
              : T.test(a.nodeName) || (U.test(a.nodeName) && a.href)
                ? 0
                : b;
          },
        },
    ...
    (X = {
      ...
      set: function (a, b, c) {
        ...
        return (
          b === !1
            ? K.removeAttr(a, c)
            : ((d = K.propFix[c] || c), d in a && (a[d] = !0), a.setAttribute(c, c.toLowerCase())),
          c
        );
      },
    }),
    K.support.getSetAttribute ||
      ((W = K.valHooks.button =
        {
          get: function (a, c) {
            var d;
    ...
    K.support.hrefNormalized ||
      K.each(["href", "src", "width", "height"], function (a, c) {
  ...
  ((K.event = {
      ...
      if (a.nodeType !== 3 && a.nodeType !== 8) {
        ...
        (i || (h.events = i = {}),
          j ||
            (h.handle = j =
              function (a) {
                return typeof K != "undefined" && (!a || K.event.triggered !== a.type)
                  ? K.event.handle.apply(j.elem, arguments)
                  : b;
              }),
          (j.elem = a),
          (c = c.split(" ")));
        var k,
          ...
          m;
        while ((k = c[l++])) {
          ((g = f ? K.extend({}, f) : { handler: d, data: e }),
            k.indexOf(".") > -1
              ? ((m = k.split(".")), (k = m.shift()), (g.namespace = m.slice(0).sort().join(".")))
              : ((m = []), (g.namespace = "")),
            (g.type = k),
          ...
          (o.add && (o.add.call(a, g), g.handler.guid || (g.handler.guid = d.guid)),
            n.push(g),
            (K.event.global[k] = !0));
        }
        a = null;
      ...
      if (a.nodeType !== 3 && a.nodeType !== 8) {
        ...
        while ((g = c[j++])) {
          ...
          if (o.length === 0 || (e != null && o.length === 1))
            ((!n.teardown || n.teardown.call(a, l) === !1) && K.removeEvent(a, g, r.handle), (f = null), delete s[g]);
        }
    ...
    trigger: function (c, d, e, f) {
      ...
      if ((!!e && !K.event.customEvent[g]) || !!K.event.global[g]) {
        ...
        do {
          ...
          ((c.currentTarget = j),
            l && l.apply(j, d),
            k && K.acceptData(j) && j[k] && j[k].apply(j, d) === !1 && ((c.result = !1), c.preventDefault()),
        ...
        if (!c.isDefaultPrevented()) {
          var m,
            n = K.event.special[g] || {};
          if (
            (!n._default || n._default.call(e.ownerDocument, c) === !1) &&
            (g !== "click" || !K.nodeName(e, "a")) &&
            K.acceptData(e)
          ) {
            try {
    ...
    proxy: K.proxy,
    special: {
      ready: { setup: K.bindReady, teardown: K.noop },
      live: {
        add: function (a) {
      ...
      (a && a.type
        ? ((this.originalEvent = a),
          ...
          (this.isDefaultPrevented =
            a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? C : D))
        : (this.type = a),
        b && K.extend(this, b),
  ...
  var bc = function (a) {
      var b = a.relatedTarget,
        ...
        d = a.type;
      ((a.type = a.data),
        b !== this && (b && (c = K.contains(this, b)), c || (K.event.handle.apply(this, arguments), (a.type = d))));
    },
    bd = function (a) {
            ...
            (K.event.add(this, "click.specialSubmit", function (a) {
              ...
              K.event.add(this, "keypress.specialSubmit", function (a) {
                var b = a.target,
                  c = K.nodeName(b, "input") || K.nodeName(b, "button") ? b.type : "";
                (c === "text" || c === "password") &&
                  K(b).closest("form").length &&
                  a.keyCode === 13 &&
                  B("submit", this, arguments);
              }));
          else return !1;
        },
        teardown: function (a) {
        ...
        return (
          b === "radio" || b === "checkbox"
            ...
            : b === "select-multiple"
              ? (c =
                  a.selectedIndex > -1
                    ? K.map(a.options, function (a) {
                        return a.selected;
                      }).join("-")
                    : "")
              : K.nodeName(a, "select") && (c = a.selectedIndex),
          c
        );
      },
      bg = function (a) {
    ...
    ((K.event.special.change = {
      filters: {
        ...
        keydown: function (a) {
          var b = a.target,
            c = K.nodeName(b, "input") ? b.type : "";
          ((a.keyCode === 13 && !K.nodeName(b, "textarea")) ||
      ...
      K.fn[c] = function (a, d, e) {
        ...
        c === "one"
          ? ((f = function (a) {
            ...
            (f.guid = e.guid || K.guid++))
          : (f = e);
        if (a === "unload" && c !== "one") this.one(a, d, e);
        else for (var h = 0, i = this.length; h < i; h++) K.event.add(this[h], a, f, d);
        return this;
      };
    }),
    K.fn.extend({
      unbind: function (a, b) {
        ...
        else for (var d = 0, e = this.length; d < e; d++) K.event.remove(this[d], a, b);
        return this;
      },
      ...
      var k = function (a, b, c, e) {
        ...
        if (w.length > 1 && m.exec(a))
          ...
          !e &&
            ...
            !v &&
            l.match.ID.test(w[0]) &&
            !l.match.ID.test(w[w.length - 1]) &&
            ((o = k.find(w.shift(), b, v)), (b = o.expr ? k.filter(o.expr, o.set)[0] : o.set[0]));
          if (b) {
            ((o = e
              ? { expr: w.pop(), set: p(e) }
              : k.find(
                  w.pop(),
                  w.length === 1 && (w[0] === "~" || w[0] === "+") && b.parentNode ? b.parentNode : b,
                  v,
                )),
          ...
          relative: {
            ...
            "": function (b, d, f) {
              var g,
                h = e++,
                i = a;
              (typeof d == "string" && !j.test(d) && ((d = d.toLowerCase()), (g = d), (i = c)),
  ...
  var bi = /Until$/,
    ...
    bn = K.expr.match.POS,
    bo = { children: !0, contents: !0, next: !0, prev: !0 };
  (K.fn.extend({
    find: function (a) {
      var b = this,
        c,
      ...
      if (K.isArray(a)) {
        ...
        if (f && a.length) {
          ...
          while (f && f.ownerDocument && f !== b) {
            for (h in i)
              ((g = i[h]), (g.jquery ? g.index(f) > -1 : K(f).is(g)) && c.push({ selector: h, elem: f, level: j }));
            ((f = f.parentNode), j++);
          }
        }
        return c;
    ...
    index: function (a) {
      return a
        ? typeof a == "string"
          ? K.inArray(this[0], K(a))
          : K.inArray(a.jquery ? a[0] : a, this)
    ...
    K.fn.extend({
      text: function (a) {
        return K.isFunction(a)
          ...
          : typeof a != "object" && a !== b
            ? this.empty().append(((this[0] && this[0].ownerDocument) || H).createTextNode(a))
            : K.text(this);
      },
      wrapAll: function (a) {
        if (K.isFunction(a))
      ...
      remove: function (a, b) {
        for (var c = 0, d; (d = this[c]) != null; c++)
          if (!a || K.filter(a, [d]).length)
            (!b && d.nodeType === 1 && (K.cleanData(d.getElementsByTagName("*")), K.cleanData([d])),
      ...
      html: function (a) {
        ...
        if (
          typeof a == "string" &&
          !bv.test(a) &&
          (K.support.leadingWhitespace || !bq.test(a)) &&
          !bz[(bs.exec(a) || ["", ""])[1].toLowerCase()]
        ) {
          a = a.replace(br, "<$1></$2>");
          try {
            for (var c = 0, d = this.length; c < d; c++)
              this[c].nodeType === 1 && (K.cleanData(this[c].getElementsByTagName("*")), (this[c].innerHTML = a));
          } catch (e) {
            this.empty().append(a);
          }
        } else
      ...
      replaceWith: function (a) {
        return this[0] && this[0].parentNode
          ...
          : this.length
            ? this.pushStack(K(K.isFunction(a) ? a() : a), "replaceWith", a)
            : this;
      },
      detach: function (a) {
      ...
      domManip: function (a, c, d) {
        ...
        if (this[0]) {
          ((h = i && i.parentNode),
            K.support.parentNode && h && h.nodeType === 11 && h.childNodes.length === this.length
              ? (e = { fragment: h })
    ...
    (K.buildFragment = function (a, b, c) {
      ...
      return (
        ...
        a.length === 1 &&
          ...
          a[0].charAt(0) === "<" &&
          !bv.test(a[0]) &&
          (K.support.checkClone || !bw.test(a[0])) &&
          ((e = !0), (f = K.fragments[a[0]]), f && f !== 1 && (d = f)),
          ...
          if (typeof i == "string")
            if (!bu.test(i)) i = b.createTextNode(i);
              ...
              (!K.support.leadingWhitespace &&
                bq.test(i) &&
                m.insertBefore(b.createTextNode(bq.exec(i)[0]), m.firstChild),
                (i = m.childNodes));
            }
          var p;
          if (!K.support.appendChecked)
            if (i[0] && typeof (p = i.length) == "number") for (g = 0; g < p; g++) r(i[g]);
            else r(i);
  ...
  var bA = /alpha\([^)]*\)/i,
    ...
    bE = /^-?\d/,
    bF = /^([\-+])=([\-+.\de]+)/,
    bG = { position: "absolute", visibility: "hidden", display: "block" },
    bH = ["Left", "Right"],
    bI = ["Top", "Bottom"],
    bJ,
    bK,
  ...
  ((K.fn.css = function (a, c) {
      ...
      style: function (a, c, d, e) {
        if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
          ...
          ((g = typeof d),
            g === "string" &&
              (f = bF.exec(d)) &&
              ((d = +(f[1] + 1) * +f[2] + parseFloat(K.css(a, c))), (g = "number")));
    ...
    K.support.opacity ||
      (K.cssHooks.opacity = {
        get: function (a, b) {
          return bB.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "")
      ...
      K.support.reliableMarginRight ||
        (K.cssHooks.marginRight = {
          get: function (a, b) {
            var c;
            return (
              K.swap(a, { display: "inline-block" }, function () {
    ...
    K.expr &&
      ...
      ((K.expr.filters.hidden = function (a) {
        ...
        return (
          (b === 0 && c === 0) ||
          (!K.support.reliableHiddenOffsets && (a.style.display || K.css(a, "display")) === "none")
        );
      }),
  ...
  ((cd = b$.exec(cc.toLowerCase()) || []),
    K.fn.extend({
      load: function (a, c, d) {
        ...
        c &&
          (K.isFunction(c)
            ? ((d = c), (c = b))
            : typeof c == "object" && ((c = K.param(c, K.ajaxSettings.traditional)), (g = "POST")));
        var h = this;
        return (
          K.ajax({
            url: a,
    ...
    K.each(["get", "post"], function (a, c) {
      K[c] = function (a, d, e, f) {
        return (
          K.isFunction(d) && ((f = f || e), (e = d), (d = b)),
          K.ajax({ type: c, url: a, data: d, success: e, dataType: f })
        );
      };
    }),
    K.extend({
      ...
      ajax: function (a, c) {
        ...
        (h.promise(y),
          ...
          (e.dataTypes = K.trim(e.dataType || "*")
            .toLowerCase()
            .split(bY)),
          e.crossDomain == null &&
            ((u = b$.exec(e.url.toLowerCase())),
            (e.crossDomain = !(
              !u ||
              (u[1] == cd[1] &&
                u[2] == cd[2] &&
                (u[3] || (u[1] === "http:" ? 80 : 443)) == (cd[3] || (cd[1] === "http:" ? 80 : 443)))
            ))),
        ...
        (((e.data && e.hasContent && e.contentType !== !1) || c.contentType) &&
          ...
          y.setRequestHeader(
            ...
            e.dataTypes[0] && e.accepts[e.dataTypes[0]]
              ? e.accepts[e.dataTypes[0]] + (e.dataTypes[0] !== "*" ? ", " + ce + "; q=0.01" : "")
              : e.accepts["*"],
          ));
  ...
  (K.ajaxSetup({
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (ch.test(b.url) || (e && ch.test(b.data))))) {
        ...
        return (
          b.jsonp !== !1 &&
            ((i = i.replace(ch, k)),
            b.url === i &&
              (e && (j = j.replace(ch, k)), b.data === j && (i += (/\?/.test(i) ? "&" : "?") + b.jsonp + "=" + g))),
          (b.url = i),
          (b.data = j),
          (a[g] = function (a) {
            f = [a];
    ...
    K.ajaxTransport("script", function (a) {
      if (a.crossDomain) {
        var c,
          d = H.head || H.getElementsByTagName("head")[0] || H.documentElement;
        return {
          send: function (e, f) {
            ...
            send: function (e, f) {
              ...
              (g.send((c.hasContent && c.data) || null),
                ...
                !c.async || g.readyState === 4
                  ? d()
                  : ((h = ++cj), ci && (ck || ((ck = {}), K(a).unload(ci)), (ck[h] = d)), (g.onreadystatechange = d)));
            },
            abort: function () {
              d && d(0, 1);
            },
  ...
  (K.fn.extend({
          ...
          this[f.queue === !1 ? "each" : "queue"](function () {
            ...
            for (i in a) {
              ...
              c &&
                ...
                K.css(this, "display") === "inline" &&
                  K.css(this, "float") === "none" &&
                  ...
                  : ((l = cp.exec(h)),
                    ...
                    l
                      ? ((n = parseFloat(l[2])),
                        ...
                        o !== "px" &&
                          (K.style(this, i, (n || 1) + o), (m = ((n || 1) / k.cur()) * m), K.style(this, i, m + o)),
                        l[1] && (n = (l[1] === "-=" ? -1 : 1) * n + m),
                        k.custom(m, n, o))
                      : k.custom(m, h, "")));
            return !0;
    ...
    K.extend(K.fx, {
      ...
      speeds: { slow: 600, fast: 200, _default: 0 },
      step: {
        opacity: function (a) {
  ...
  var ct = /^t(?:able|d|h)$/i,
    cu = /^(?:body|html)$/i;
  ("getBoundingClientRect" in H.documentElement
    ...
    : (K.fn.offset = function (a) {
        ...
        while ((b = b.parentNode) && b !== h && b !== g) {
          ...
          ((c = i ? i.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ((k += b.offsetTop),
              (l += b.offsetLeft),
              K.offset.doesNotAddBorder &&
                (!K.offset.doesAddBorderForTableAndCells || !ct.test(b.nodeName)) &&
                ((k += parseFloat(c.borderTopWidth) || 0), (l += parseFloat(c.borderLeftWidth) || 0)),
              (e = d),
              (d = b.offsetParent)),
            K.offset.subtractsBorderForOverflowNotVisible &&
              c.overflow !== "visible" &&
              ((k += parseFloat(c.borderTopWidth) || 0), (l += parseFloat(c.borderLeftWidth) || 0)),
            (j = c));
        }
        ...
        return (
          K.offset.supportsFixedPosition &&
            j.position === "fixed" &&
            ((k += Math.max(g.scrollTop, h.scrollTop)), (l += Math.max(g.scrollLeft, h.scrollLeft))),
          { top: k, left: l }
        );
      }),
    (K.offset = {
      initialize: function () {
        var a = H.body,
          ...
          e,
          f,
          g = parseFloat(K.css(a, "marginTop")) || 0,
          h =
      ...
      bodyOffset: function (a) {
        ...
        return (
          K.offset.initialize(),
          K.offset.doesNotIncludeMarginInBodyOffset &&
            ((b += parseFloat(K.css(a, "marginTop")) || 0), (c += parseFloat(K.css(a, "marginLeft")) || 0)),
          { top: b, left: c }
        );
      },
    ...
    K.fn.extend({
      position: function () {
        ...
        return (
          (c.top -= parseFloat(K.css(a, "marginTop")) || 0),
              ...
              ? ((g = c(f)),
                g
                  ? "pageXOffset" in g
                    ...
                    : (K.support.boxModel && g.document.documentElement[e]) || g.document.body[e]
                  : f[e])
              : null)
          : this.each(function () {
  ...
  (function (a, b) {
    ...
    function o(d, h) {
        ...
        ((b.type = "onShow"),
          ...
          a(document).bind("keydown.d", function (b) {
            ...
            if (a(e).index(c) >= 0) {
              ...
              return (
                h > 41
                  ? (i.addMonth(), (g = a("#" + p.weeks + " a:eq(" + (h - 42) + ")")))
                  : h < 0
                    ? (i.addMonth(-1), (g = a("#" + p.weeks + " a:eq(" + (h + 42) + ")")))
                    : (g = f.eq(h)),
                g.addClass(p.focus),
                b.preventDefault()
              );
      ...
      var G = d.add(i);
      if (!r.length) {
        ((r = a("<div><div><a/><div/><a/></div><div><div/><div/></div></div>")
          .hide()
      ...
      ((I = r.find("#" + p.year)),
        ...
        a.extend(i, {
          show: function (b) {
            ...
            return (
              ...
              r.css({ top: e.top + d.outerHeight({ margins: !0 }) + h.offset[0], left: e.left + h.offset[1] }),
              h.speed
                ? r.show(h.speed, function () {
                    N(b);
                  })
                : (r.show(), N(b)),
              i
          ...
          setValue: function (c, d, e) {
            ...
            if (h.selectors) {
              (H.empty(),
                a.each(q.months, function (b, d) {
                  A < new Date(c, b + 1, 1) &&
                    B > new Date(c, b, 0) &&
                    H.append(a("<option/>").html(d).attr("value", b));
                }),
                I.empty());
              var E = j.getFullYear();
            ...
            for (var G = o ? 0 : -7, J, K; G < (o ? 42 : 35); G++)
              ((J = a("<a/>")),
                ...
                G < o
                  ? (J.addClass(p.off), (K = t - o + G + 1), (f = new Date(c, d - 1, K)))
                  : G >= o + r
                    ? (J.addClass(p.off), (K = G - r - o + 1), (f = new Date(c, d + 1, K)))
                    : ((K = G - o + 1),
                      (f = new Date(c, d, K)),
              ...
              L.find("a").click(function (b) {
                ...
                return (
                  c.hasClass(p.disabled) ||
                    (a("#" + p.current).removeAttr("id"), c.attr("id", p.current), M(c.data("date"), h, b)),
                  !1
                );
              }),
              p.sunday &&
                L.find(p.week).each(function () {
        ...
        h.editable ||
          d.bind("focus.d click.d", i.show).keydown(function (b) {
            var c = b.keyCode;
            return !C && a(e).index(c) >= 0
              ? (i.show(b), b.preventDefault())
              : b.shiftKey || b.ctrlKey || b.altKey || c == 9
                ? !0
                : b.preventDefault();
          }),
        n(d.val()) && M(z, h));
      ...
      (d &&
        ...
        a.extend(f, {
          load: function (d) {
            ...
            return (
              typeof n == "string" &&
                (n = n == "center" ? Math.max((h.height() - q) / 2, 0) : (parseInt(n, 10) / 100) * h.height()),
              ...
              e.closeOnClick &&
                a(document).bind("click." + m, function (b) {
                  a(b.target).parents(j).length || f.close(b);
                }),
              e.closeOnEsc &&
                a(document).bind("keydown." + m, function (a) {
  ...
  (function (a) {
    ...
    var e = function (b, e) {
        ...
        (g.fixed
          ...
          k.css({ position: "absolute", top: n, left: o, width: 0, zIndex: g.zIndex }).show(),
          (b.position = l),
          f.css(b),
          k
            .animate({ top: f.css("top"), left: f.css("left"), width: j }, g.speed, function () {
      ...
      f = function (b) {
        ...
        (g && a.extend(i, d(g)),
          f.fixed &&
            h.css({ position: "absolute" }).animate({ top: "+=" + c.scrollTop(), left: "+=" + c.scrollLeft() }, 0),
  ...
  (function (a) {
    ...
    function h(b, c) {
      function y(a, f, g, h) {
        ...
        return (
          j
            ? (o.animate({ top: f }, l, t), c.progress && p.animate({ height: m - f + o.height() / 2 }, l))
            : (o.animate({ left: f }, l, t), c.progress && p.animate({ width: f + o.width() / 2 }, l)),
          (k = g),
          (n = f),
          b.val(g),
          d
      ...
      function z() {
        ((j = c.vertical || f(i, "height") > f(i, "width")),
          j
            ? ((m = f(i, "height") - f(o, "height")), (l = i.offset().top + m))
            : ((m = f(i, "width") - f(o, "width")), (l = i.offset().left)));
      }
      function A() {
        ...
        c.keyboard &&
          b.keydown(function (c) {
            ...
            if ((f || g) && !(c.shiftKey || c.altKey || c.ctrlKey))
              return (f ? d.step(e == 33 ? 10 : 1, c) : g && d.step(e == 34 ? -10 : -1, c), c.preventDefault());
          }),
        b.blur(function (b) {
          var c = a(this).val();
          c !== k && d.setValue(c, b);
    ...
    ((a.fn.drag = function (b) {
      return (
        ...
        (b = a.extend({ x: !0, y: !0, drag: !0 }, b)),
        (c =
          c ||
          a(document).bind("mousedown mouseup", function (e) {
            var f = a(e.target);
        ...
        a.extend(f, {
          ...
          addItem: function (b) {
            return (
              (b = a(b)),
              e.circular
                ? (h.children().last().before(b), h.children().first().replaceWith(b.clone().addClass(e.clonedClass)))
        ...
        (f.onBeforeSeek(function (a, b) {
          setTimeout(function () {
            a.isDefaultPrevented() ||
              (n.toggleClass(e.disabledClass, b <= 0), o.toggleClass(e.disabledClass, b >= f.getSize() - 1));
          }, 1);
        }),
  ...
  (function (a) {
    ...
    var b = a.tools.scrollable;
    ((b.navigator = {
      conf: { navi: ".navi", naviItem: null, activeClass: "active", indexed: !1, idPrefix: null, history: !1 },
    }),
      ...
      (h.length || (h = c.children()),
        ...
        a.extend(this, {
          click: function (c, d) {
            ...
            typeof c == "string" &&
              c.replace("#", "") &&
              ((i = h.filter("[href*=" + c.replace("#", "") + "]")), (c = Math.max(h.index(i), 0)));
            if (e.rotate) {
              var k = h.length - 1;
        ...
        location.hash && e.tabs == "a" && c.find("[href=" + location.hash + "]").length
          ? f.click(location.hash)
          : (e.initialIndex === 0 || e.initialIndex > 0) && f.click(e.initialIndex));
    }
    ((a.tools = a.tools || { version: "1.2.6" }),
      (a.tools.tabs = {
        conf: {
    ...
    function c(b, c) {
      ...
      (a.extend(d, {
        ...
        play: function () {
          ...
          return (
            e.trigger(b),
            b.isDefaultPrevented() ? d : ((h = !1), e.trigger("onPlay"), e.bind("onClick", l), l(), d)
          );
        },
        pause: function () {
          if (!g) return d;
          ...
          return (
            e.trigger(b),
            b.isDefaultPrevented() ? d : ((g = clearTimeout(g)), e.trigger("onPause"), e.unbind("onClick", l), d)
          );
        },
        resume: function () {
          h || d.play();
      ...
      load: function (j, k) {
        ...
        return (
          ...
          d(j.onBeforeLoad) === !1
            ? this
            : (j.closeOnEsc &&
                a(document).bind("keydown.mask", function (b) {
                  b.keyCode == 27 && a.mask.close(b);
                }),
              j.closeOnClick &&
                e.bind("click.mask", function (b) {
                  a.mask.close(b);
                }),
              ...
              k &&
                ...
                (f = k.css({ zIndex: Math.max(j.zIndex + 1, i == "auto" ? 0 : i) }))),
              e.css({ display: "block" }).fadeTo(j.loadSpeed, j.opacity, function () {
  ...
  (function () {
    ...
    function j(c, d, e) {
      if (h.isSupported(d.version)) c.innerHTML = h.getHTML(d, e);
        ...
        c.innerHTML = h.getHTML(f(d, { src: d.expressInstall }), {
          MMredirectURL: location.href,
          MMplayerType: "PlugIn",
          MMdoctitle: document.title,
        });
      else {
        c.innerHTML.replace(/\s/g, "") ||
          ((c.innerHTML =
            "<h2>Flash version " +
            d.version +
            ...
            (c.tagName == "A"
              ...
              : "<p>Download latest version from <a href='" + b + "'>here</a></p>")),
          c.tagName == "A" &&
            (c.onclick = function () {
              location.href = b;
            }));
    ...
    var h = f(window.flashembed, {
        ...
        getHTML: function (b, c) {
          ...
          (b.cachebusting && (b.src += (b.src.indexOf("?") != -1 ? "&" : "?") + Math.random()),
            b.w3c || !a
              ? (d += ' data="' + b.src + '" type="application/x-shockwave-flash"')
    ...
    c &&
      ...
      (jQuery.tools.flashembed = { conf: e }),
  ...
  (function (a) {
    ...
    ((a.tools = a.tools || { version: "1.2.6" }),
      (a.tools.history = {
        init: function (g) {
          if (e) return;
          (a.browser.msie && a.browser.version < "8"
            ? c ||
              ((c = a("<iframe/>").attr("src", "javascript:false;").hide().get(0)),
              a("body").prepend(c),
            ...
            if (!h) {
              l
                ...
                : e.tip
                  ? (h = a(e.tip).eq(0))
                  : k
                    ? (h = a(e.layout).addClass(e.tipClass).appendTo(document.body).hide().append(k))
            ...
            return (
              h.data("__set") ||
                ...
                p[1] &&
                  ...
                  h.unbind(p[1]).bind(p[1], function (a) {
            ...
            var b = a(this)
              ...
              .onBeforeShow(function (b, e) {
                ...
                (h || (h = [j.position[0], j.position[1], j.offset[0], j.offset[1], a.extend({}, j)]),
                  ...
                  (j.position = [h[0], h[1]]),
                  (j.offset = [h[2], h[3]]),
                  i.css({ visibility: "hidden", position: "absolute", top: e.top, left: e.left }).show());
                var k = a.extend(!0, {}, f),
                  l = c(i);
                if (!d(l)) {
      ...
      ((b = b.not(":button, :image, :reset, :submit")),
        ...
        a.extend(f, {
          ...
          checkValidity: function (c, g) {
            ...
            return h.length
              ? (f.invalidate(h, g), !1)
              : (m[1].call(f, c, g), (g.type = "onSuccess"), i.trigger(g, [c]), c.unbind(e.errorInputEvent + ".v"), !0);
          },
        }),
