  ...
  i.prototype = {
    ...
    buttonBefore: function (e) {
      if (e === !0)
        this.options.buttonBefore ||
          ...
          this.options.input && (this.$elementjFilestyle.remove(), this.constructor(), this.pushNameFiles()));
      else {
    ...
    input: function (e) {
      if (e === !0)
        ...
        if (this.options.input) {
          ...
          t.length > 0 &&
            this.$elementjFilestyle.find("label").append(' <span class="count-jfilestyle">' + t.length + "</span>");
        }
      }
    },
    text: function (e) {
      return void 0 === e
        ? this.options.text
        : ((this.options.text = e), void this.$elementjFilestyle.find("label span").html(this.options.text));
    },
    theme: function (e) {
      return void 0 === e
        ? this.options.theme
    ...
    inputSize: function (e) {
      return void 0 === e
        ...
        : ((this.options.inputSize = e),
          void this.$elementjFilestyle.find(":text").css("width", this.options.inputSize));
    },
    placeholder: function (e) {
      return void 0 === e
        ? this.options.placeholder
        : ((this.options.placeholder = e), void this.$elementjFilestyle.find(":text").attr("placeholder", e));
    },
    htmlInput: function () {
    ...
    pushNameFiles: function () {
      ...
      return (
        "" !== e
          ? this.$elementjFilestyle.find(":text").val(e.replace(/\, $/g, ""))
          : this.$elementjFilestyle.find(":text").val(""),
        t
      );
    },
    constructor: function () {
      ...
      (("" !== l && l) || ((l = "jfilestyle-" + t), i.$element.attr({ id: l }), t++),
        ...
        i.$element
          ...
          .attr("tabindex", "-1")
          .after(i.$elementjFilestyle),
        i.options.disabled && i.$element.attr("disabled", "true"),
        i.$elementjFilestyle
          .find('[name="filedrag"]')
          .css({ position: "absolute", width: "100%", height: i.$elementjFilestyle.height() + "px", "z-index": -1 }),
