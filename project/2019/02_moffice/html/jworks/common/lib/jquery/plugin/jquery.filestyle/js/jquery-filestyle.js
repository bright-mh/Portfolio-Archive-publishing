  ...
  JFilestyle.prototype = {
    ...
    theme: function (value) {
      if (value !== undefined) {
        ...
        this.$elementjFilestyle.removeClass(
          this.$elementjFilestyle.attr("class").replace(/.*(jfilestyle-theme-.*).*/, "$1"),
        );
      ...
      _self.$element.change(function () {
        ...
        if (_self.options.input == false) {
          if (_self.$elementjFilestyle.find(".count-jfilestyle").length == 0) {
            _self.$elementjFilestyle
              .find("label")
              .append(' <span class="count-jfilestyle">' + files.length + "</span>");
