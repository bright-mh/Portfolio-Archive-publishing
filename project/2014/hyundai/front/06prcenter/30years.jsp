			...
			<div class="s_container">
				<div class="location bg5">
					<ul>
						...
						<li class="gt last"><a href="/front/06prcenter/30years.jsp">30년사</a></li>
					</ul>
				</div>

				<div class="contents">
					<h1 class="pb20">30년사</h1>

					<div class="years">
						<img src="/front/images/06prcenter/30years.jpg" alt="30th. since 1976. Value &amp; Innovation 원칙과 소신으로 걸어온 현대산업개발의 지난 30년의 역사를 만나보세요"/>
						<a href="http://www.hyundai-dvp.com/ex/ageofhdc_0102/form.html" target="blank" title="새 창 열림">30년사 바로가기</a>
					</div>
				</div>
