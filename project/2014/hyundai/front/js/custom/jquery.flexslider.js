      ...
      pausePlay: {
        setup: function () {
          var pausePlayScaffold = $(
            '<div class="' + namespace + 'pauseplay"><a class="" href="#PauseAndPlay"></a></div>',
          );
    ...
    slider.setup = function (type) {
      ...
      if (!fade) {
        ...
        if (slider.vars.animationLoop && !carousel) {
          ...
          methods
            .uniqueID(slider.slides.first().clone().addClass("clone").attr("aria-hidden", "true"))
            .appendTo(slider.container);
          methods
            .uniqueID(slider.slides.last().clone().addClass("clone").attr("aria-hidden", "true"))
