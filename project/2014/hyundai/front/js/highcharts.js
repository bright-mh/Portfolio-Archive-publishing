...
(function () {
      ...
      if (d) {
        ...
        if (f.length)
          ((f = f.join(":")),
            ...
            /f$/.test(f)
              ? ((i = (i = f.match(g)) ? i[1] : -1),
                e !== null && (e = Ga(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")))
              : (e = cb(f, e)));
      }
      j.push(e);
      a = a.slice(c + 1);
  ...
  var jb = N.adapterRun,
    ...
    kb = N.animate,
    bb = N.stop,
    N = { enabled: !0, x: 0, y: 15, style: { color: "#606060", cursor: "default", fontSize: "11px" } };
  E = {
  ...
  ta.prototype = {
          ...
          p(e, function (e, f) {
            ...
            p(g, function (e) {
              if (e !== "" || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (H(m, "onclick", 'location.href="' + e.match(i)[1] + '"'), G(m, { cursor: "pointer" }));
    ...
    symbol: function (a, b, c, d, e, f) {
      var g,
        ...
        j,
        k;
      if (h) ((g = this.path(h)), q(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && q(g, f));
      else if (i.test(a))
        ((k = function (a, b) {
          a.element &&
        ...
        h && h > c && i > b + g && i < b + d - g
          ...
          : h && h < 0 && i > b + g && i < b + d - g
            ...
            : i && i > d && h > a + g && h < a + c - g
              ...
              : i && i < 0 && h > a + g && h < a + c - g && e.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6, b, c - f, b);
        return e;
      },
    },
    ...
    text: function (a, b, c, d) {
      var e = fa || (!aa && this.forExport),
        f = {};
      if (d && !this.forExport) return this.jsp(a, b, c);
      f.x = Math.round(b || 0);
    ...
    html: function (a, b, c) {
      ...
      if (f.isSVG)
        d.add = function (a) {
          ...
          b.appendChild(e);
          d.added = !0;
          d.alignOnAdd && d.jspUpdateTransform();
          return d;
        };
      return d;
    },
  ...
  if (!aa && !fa) {
    R.VMLElement = X = {
      ...
      updateTransform: P.prototype.jspUpdateTransform,
      ...
      dashstyleSetter: function (a, b, c) {
        (c.getElementsByTagName("stroke")[0] || Y(this.renderer.prepVML(["<stroke/>"]), null, null, c))[b] =
          a || "solid";
        this[b] = a;
      },
      dSetter: function (a, b, c) {
      ...
      visibilitySetter: function (a, b, c) {
        ...
        c.nodeName === "DIV" &&
          ((a = a === "hidden" ? "-999em" : 0), hb || (c.style[b] = a ? "visible" : "hidden"), (b = "top"));
        c.style[b] = a;
      },
        ...
        return q(e, {
          ...
          getCSS: function (a) {
            var b = a.element,
              ...
              d = {
                clip:
                  "rect(" + u(a ? e : d) + "px," + u(a ? f : b) + "px," + u(a ? b : f) + "px," + u(a ? d : e) + "px)",
              };
      ...
      if (i && !isNaN(y))
        ((i.xy = w = this.getLabelPosition(y, w, i, g, k, u, a, v)),
          ...
          (this.isLast && !this.isFirst && !m(e.showLastLabel, 1))
            ? (q = !1)
            : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (q = this.handleOverflow(a, w)),
          v && a % v && (q = !1),
          q && !isNaN(w.y)
  ...
  la.prototype = {
    ...
    init: function (a, b) {
      ...
      Da(this, a.axes) === -1 &&
        (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
    ...
    setTickPositions: function (a) {
      ...
      if (b.range && r(b.max)) ((b.userMin = b.min = v(b.min, b.max - b.range)), (b.userMax = b.max), (b.range = null));
      ...
      if (L)
        ((b = a.getLinePath(L)),
          a.axisLine
            ...
            : (a.axisLine = e.path(b).attr({ stroke: f.lineColor, "stroke-width": L, zIndex: 7 }).add(a.axisGroup)),
  ...
  la.prototype.getTimeTicks = function (a, b, c, d) {
    ...
    if (r(b)) {
      ...
      h = i[gb]();
      for (
        var d = i.getTime(), l = i[fb](), o = i[Xa](), n = g ? Ra : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5;
        d < c;
      )
        (e.push(d),
          j === A.year
  ...
  la.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) ((a = u(a)), (g = this.getLinearTickPositions(a, b, c)));
      ...
      for (
        var f = T(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
        f < c + 1 && !l;
        f++
      ) {
        i = e.length;
  ...
  Mb.prototype = {
    ...
    getAnchor: function (a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === t && (b = d.pointer.normalize(b)), (c = [b.chartX - d.plotLeft, b.chartY - f]));
      c ||
        (p(a, function (a) {
          i = a.series.yAxis;
          g += a.plotX;
    ...
    onContainerClick: function (a) {
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, "highcharts-tracker")
          ...
          : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && D(b, "click", a)));
    },
    ...
    renderItem: function (a) {
      ...
      if (!q)
        ((a.legendGroup = c.g("legend-item").attr({ zIndex: 1 }).add(this.scrollGroup)),
          ...
          (a.legendItem = q =
            c
              .text(d.labelFormat ? Ia(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline, t)
              .css(w(a.visible ? h : i))
    ...
    render: function () {
      ...
      e.items &&
        p(e.items, function (b) {
          ...
          delete d.left;
          delete d.top;
          c.text(b.jsp, f, g).attr({ zIndex: 2 }).css(d).add();
        });
      ...
      for (o = 0; o < g; o++)
        ((i = h + o),
          j
            ...
            : (b[i] ? (k = b[i]) : a[i] !== t && (b[i] = k = new f().init(this, a[i], d[o])), (l[o] = k)));
      if (b && (g !== (c = b.length) || j))
        for (o = 0; o < c; o++) if ((o === h && !j && (o += g), b[o])) (b[o].destroyElements(), (b[o].plotX = t));
      this.data = b;
      this.points = l;
    },
  ...
  q(Ya.prototype, {
    ...
    showLoading: function (a) {
      ...
      if (!c)
        ((this.loadingDiv = c =
          Y(Ja, { className: "highcharts-loading" }, q(d.style, { zIndex: 10, display: Q }), this.container)),
      ...
      b.grouping === !1
        ...
        : p(a.chart.series, function (b) {
            ...
            if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
              (c.stacking ? ((f = b.stackKey), g[f] === t && (g[f] = i++), (h = g[f])) : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h));
          });
        ...
        p(e, function (b) {
          ...
          if (l && !e) b.dataLabel = l.destroy();
            ...
            if (l)
              ...
              l = b.dataLabel = a.chart.renderer[e ? "text" : "label"](h, 0, -999, null, null, null, d.useHTML)
                .attr(l)
  ...
  O.prototype.alignDataLabel = function (a, b, c, d, e) {
    ...
    if (
      ...
      ((d = q({ x: g ? f.plotWidth - i : h, y: u(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
        ...
        c.rotation
          ...
          : (b.align(c, null, d),
            ...
            m(c.overflow, "justify") === "justify"
              ...
              : m(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height))));
      ...
      if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
        ...
        for (i = 0; i < a; i++)
          if (((e = b[i]), (c = e.x), c >= f.min && c <= f.max)) {
            ...
            c = d === t ? 0 : d + 1;
            for (
              d = b[i + 1] ? C(v(0, T((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g;
              c >= 0 && c <= d;
            )
              j[c++] = e;
          }
