		...
		<div class="wrap">
			...
			<div class="s_container">
				...
				<div class="contents">
					...
					<div class="tab tab2">
						<ul>
							<li class="on"><a href="/front/03rnd/research_01.jsp"><span>주요연구분야</span></a></li>
							<li><a href="/front/03rnd/experiment.jsp"><span>관련실험분야</span></a></li>
						</ul>
					</div>

					<div class="tech_group">
						<img src="/front/images/03rnd/tech03.gif" alt=""/>
						<div class="blind">
							<dl>
