			...
			<div class="contents">
				...
				<div class="business">
					<div class="civil_tab">
						<ul>
							<li class="civil01"><a
								href="/front/02business/civil_biz.jsp?grp_cd=1" <% if (grp_cd==1) {%> class="on"<%}%>><i></i><br>도로/교량</a></li>
							<li class="civil02"><a
								href="/front/02business/civil_biz.jsp?grp_cd=2" <% if (grp_cd==2) {%> class="on"<%}%>><i></i><br>철도/지하철</a></li>
							<li class="civil03"><a
								href="/front/02business/civil_biz.jsp?grp_cd=3" <% if (grp_cd==3) {%> class="on"<%}%>><i></i><br>매립/항만/해양시설</a></li>
							<li class="civil04"><a
								href="/front/02business/civil_biz.jsp?grp_cd=4" <% if (grp_cd==4) {%> class="on"<%}%>><i></i><br>플랜트/기타</a></li>
							<li class="civil05"><a
								href="/front/02business/civil_biz.jsp?grp_cd=5" <% if (grp_cd==5) {%> class="on"<%}%>><i></i><br>해외사업</a></li>
						</ul>
					</div>

					<!-- [D] 각 탭이 선택될 때, h3태그가 각 탭 이름으로 보이게 해주세요! -->
					<% if (grp_cd==1) {%><h3 class="hidden">도로/교량</h3><%}%>
					<% if (grp_cd==2) {%><h3 class="hidden">철도/지하철</h3><%}%>
					<% if (grp_cd==3) {%><h3 class="hidden">매립/항만/해양시설</h3><%}%>
					<% if (grp_cd==4) {%><h3 class="hidden">플랜트/기타</h3><%}%>
					<% if (grp_cd==5) {%><h3 class="hidden">해외사업</h3><%}%>
					...
					<div class="newsDetail civill">
						...
						%>							
							<li class="news <% if (i==0) out.println ("on"); %>""><a href="#viewDetail"> <span class="title"><%=h.get("NAME")%></span>
							</a>
								<div class="txt_box">
					...
					<jsp:include page="/front/inc/paging.jsp" flush="true" >
						...
						<jsp:param name="link" value="/front/02business/civil_biz.jsp" />
					</jsp:include>
