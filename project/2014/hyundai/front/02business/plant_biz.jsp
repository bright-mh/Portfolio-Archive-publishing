...
%><%
	...
	ArrayList<HashMap<String,Object>> list = service.getList(request, "plant");
		...
		<div class="s_container">
			<div class="location bg1">
				<ul>
					...
					<li class="gt last"><a href="/front/02business/plant_info.jsp">플랜트사업</a></li>
				</ul>
			</div>
			...
			<div class="contents">
				...
				<div class="tab tab2">
					<ul>
						<li><a href="/front/02business/plant_info.jsp"><span>개요</span></a></li>
						<li class="on"><a href="/front/02business/plant_biz.jsp"><span>주요실적</span></a></li>
					</ul>
				</div>
