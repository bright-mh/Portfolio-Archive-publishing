...
%><%
	...
	ArrayList<HashMap<String,Object>> list = service.getList(request, "house");
	...
	<div class="wrap">
		...
		<div class="s_container">
			...
			<div class="contents">
				...
				<div class="tab tab2">
					<ul>
						<li><a href="/front/02business/housing_info.jsp"><span>개요</span></a></li>
						<li class="on"><a href="/front/02business/housing_biz.jsp"><span>주요실적</span></a></li>
					</ul>
				</div>
				...
				<div class="business">
					<div class="newsDetail">
						...
						%>
							...
							<li class="news <% if (i==0) out.println ("on"); %>"><a href="#viewDetail"> <span
									class="title"><%=h.get("NAME")%></span>
							</a>
								<div class="txt_box">
