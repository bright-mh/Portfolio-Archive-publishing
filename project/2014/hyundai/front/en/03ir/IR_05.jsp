		...
		<div class="wrap">
			...
			<div class="s_container">
				...
				<div class="contents">
					...
					<div class="tab tab2">
						<ul>
							<li class="w_02"><a href="/front/en/03ir/IR_04.jsp"><span>IR REPORT</span></a></li>
							<li class="on w_02"><a href="/front/en/03ir/IR_05.jsp"><span>EARNING RELEASE</span></a></li>
						</ul>
					</div>

					<div class="irTitle">
						<h2>EARNING RELEASE</h2>
					...
					<div class="ir_manage">
						...
						<caption>EARNING RELEASE LIST</caption>
						<colgroup>
						<col style="width:12%">
						<col style="width:78%">
						<col style="width:20%">
					...
					<%
						...
						<jsp:include page="/front/inc/paging.jsp" flush="true" >
							...
							<jsp:param name="link" value='<%="/front/en/03ir/IR_05.jsp?grp_cd="+grp_cd%>' />
						</jsp:include>
