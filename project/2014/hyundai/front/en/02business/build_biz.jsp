				...
				<div class="contents">
					...
					<div class="tab tab2">
						<ul>
							...
							<li class="on"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=1"><span>MAJOR PROJECT</span></a></li>
						</ul>
					</div>
					...
					<div class="business">
						<div class="civil_tab">
							<ul>
								<li class="build01"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=1" <% if (grp_cd==1) {%> class="on"<%}%>><i></i><br>HOSPITAL</a></li>
								<li class="build02"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=2" <% if (grp_cd==2) {%> class="on"<%}%>><i></i><br>BUSINESS/OFFICE</a></li>
								<li class="build03"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=3" <% if (grp_cd==3) {%> class="on"<%}%>><i></i><br>HOTEL</a></li>
								<li class="build04"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=4" <% if (grp_cd==4) {%> class="on"<%}%>><i></i><br>EDUCATION/CULTURE/<br/>SPORTS FACILITY</a></li>
								<li class="build05"><a href="/front/en/02business/build_biz.jsp?lang=en&grp_cd=5" <% if (grp_cd==5) {%> class="on"<%}%>><i></i><br>OFFICETEL</a></li>
							</ul>
						</div>
...
<!-- 										<dl>
						...
						<jsp:include page="/front/inc/paging.jsp" flush="true" >
							...
							<jsp:param name="link" value="/front/en/02business/build_biz.jsp" />
						</jsp:include>
