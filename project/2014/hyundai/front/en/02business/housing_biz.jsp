		...
		<div class="wrap">
			...
			<div class="s_container">
				...
				<div class="contents">
					...
					<div class="tab tab2">
						<ul>
							<li><a href="/front/en/02business/housing_info.jsp"><span>SUMMARY</span></a></li>
							<li class="on"><a href="/front/en/02business/housing_biz.jsp"><span>MAJOR PROJECT</span></a></li>
						</ul>
					</div>
...
<!-- 										<dl>
						...
						<jsp:include page="/front/inc/paging.jsp" flush="true" >
							...
							<jsp:param name="link" value="/front/en/02business/housing_biz.jsp" />
						</jsp:include>
