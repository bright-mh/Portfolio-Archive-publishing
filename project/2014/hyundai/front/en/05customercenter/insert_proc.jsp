			 ...
			 //http://www.hyundai-dvp.com/kr/include/mail_download.jsp?filename=a.txt
				   ...
				   out.println(content);
						...
						if(q_type.equals("협력회사문의")){
							to = "yoonna@hyundai-dvp.com";
							//to = "yoonna@hyundai-dvp.com;5704@hyundai-dvp.com;1100970@hyundai-dvp.com";  
						}
					    ...
					    JavascriptUtil.location(response, "/front/en/05customercenter/csCenter.jsp", "정상적으로 등록되었습니다");
...
<script>
	alert ('등록되었습니다');
	location.href = "/front/en/05customercenter/csCenter.jsp";
</script>
</body></html>