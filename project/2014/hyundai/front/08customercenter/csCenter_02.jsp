			...
			<div class="s_container">
				<div class="location bg7">
					<ul>
						...
						<li class="gt last"><a href="/front/08customercenter/csCenter_02.jsp">일반문의</a></li>
					</ul>
				</div>

				<div class="contents">
				<form name="eventfrm" action="insert_proc.jsp" method="post" onsubmit="return check()" enctype="multipart/form-data">
				<input type="hidden" name="grp_cd" value="1" />
				<input type="hidden" name="q_type" value="일반문의">
				<input type="hidden" name="mode" value="save">
					<h1 class="pb20">일반문의</h1>

					<div class="tbl_customer">
						<table summary="작성자의 이름, 자택전화, 휴대전화, 이메일, 주소를 입력">
							<caption>작성자 정보 입력</caption>
							<colgroup>
					...
					<div class="tbl_customer mt30">
						<table summary="일반문의의 제목, 내용, 첨부파일을 입력 및 등록 ">
							<caption>일반문의 입력폼</caption>
							<colgroup>
								<col style="width:90px" />
								<col style="" />
							</colgroup>
								...
								<tr>
									...
									<td>
										<div class="input_file">
											<div class="input"><input type="text" value="" title="첨부파일 파일명" id="ff"></div>
											<div class="btn_find">
										...
										<span class="ml10">용량은 500KB를 넘길 수 없음</span>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="custom_firm">
						...
						<div class="check"><input type="checkbox" id="custom_agree" value="Y" name="agree_yn"> <label for="custom_agree">동의함</label></div>
					</div>
