...
String closing_type_blncsheet = request.getParameter("closing_type_blncsheet")==null?"110":request.getParameter("closing_type_blncsheet");
String url = "http://asp1.krx.co.kr/IR/basic/012630/user11.jsp?closing_type_blncsheet="+closing_type_blncsheet;
...
<head>
	...
	<script>
	function reload (closing_type_blncsheet) {
		location.href = "/front/05ir/IR_03_02.jsp?closing_type_blncsheet="+closing_type_blncsheet;
	}
	</script>	
</head>
<body class="main">
				...
				<div class="contents">
					...
					<div class="tab_mn2">
						<ul>
							...
							<li class="on"><a href="/front/05ir/IR_03_02.jsp">대차대조표</a></li>
							<li><a href="/front/05ir/IR_03_03.jsp">손익계산서</a></li>
						</ul>
					</div>

					<h3 class="hidden">대차대조표</h3>
					<div class="ir_manage">
						<div class="box_clear pb7">
							...
							<div class="fl manage_select">
								<select class="box_select" name="closing_type_blncsheet" onchange="reload(this.value)">
									<option value="110" <%if (closing_type_blncsheet.equals("110")){%>selected="selected"<%}%>>결산</option>
									<option value="210" <%if (closing_type_blncsheet.equals("210")){%>selected="selected"<%}%>>반기</option>
									<option value="310" <%if (closing_type_blncsheet.equals("310")){%>selected="selected"<%}%>>연결</option>
									<option value="510" <%if (closing_type_blncsheet.equals("510")){%>selected="selected"<%}%>>1/4 분기</option>
									<option value="610" <%if (closing_type_blncsheet.equals("610")){%>selected="selected"<%}%>>3/4 분기</option>
								</select>
							</div>
							<div class="fr font_ltgray mt50">(단위:금액-백만원 | 비ㆍ율-%)</div>
						</div>
