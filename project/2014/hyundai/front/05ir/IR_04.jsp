		...
		<div class="wrap">
			...
			<div class="s_container">
				...
				<div class="contents">
					...
					<div class="tab_mn2">
						<ul>
							<li class="on"><a href="/front/05ir/IR_04.jsp?grp_cd=1&lang=kr&limit=300">회사채</a></li>
							<li><a href="/front/05ir/IR_04_02.jsp?grp_cd=2&lang=kr">기업어음</a></li>
						</ul>
					</div>

					<h3 class="hidden">회사채</h3>
					<div class="ir_manage">
						<h4 class="h2_tit pt0 pb15">신용등급 회사채</h4>
						<div class="tbl_red">
							<table summary="회사채의 평가일자별 신용등급, 평가기관">
								<caption>회사채의 신용등급</caption>
								<colgroup>
									<col style="width:25%" />
									<col style="width:25%" />
									<col style="width:25%" />
								...
								<tbody>
									...
									<tr>
										<% if (i==0) { %>
										<th scope="rowgroup" rowspan="<%=list.size()%>">회사채</th>
										<% } %>
