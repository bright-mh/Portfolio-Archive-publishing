var musicOpen; //main 에서 플래시 플레이어 오픈 했을 때 true;
...
(function ($) {
  $.fn.extend({
    searchLayer: function () {
      ...
      if ($("input:focus").prop("id") == "query") {
        var focusSearch = $("input:focus");
        $("#query").removeClass("noneFocus");
      }
...
$.fn.extend({
  ...
  intervalSet: function () {
    ...
    $(this).bind({
      mouseout: function () {
        imgMove(
          $(this).parent().children(".viewerBody").children(".bigImg"),
          $(this).parent().children(".viewerBody").find(".bigImg ul li").length,
        );
      },
      mouseover: function () {
  ...
  intervalSet2: function () {
    $(this).bind({
      mouseout: function () {
        imgMove(
          $(this).parent().parent().parent().parent().children(".viewerBody").children(".bigImg"),
          $(this).parent().parent().parent().parent().children(".viewerBody").find(".bigImg ul li").length,
        );
      },
      mouseover: function () {
        clearInterval(interval);
  ...
  function viewerBody() {
    ...
    bigImg.each(function () {
      ...
      $(this).bind("click", function () {
        ...
        $(".popELCon")
          .find(".nextBtn")
          .css("left", left + $(".popELCon").find(".popCon").width() + 20);
        $(".popELCon")
          .find(".popMask")
          .bind("click", function () {
            close();
  ...
  if (bgHei01 < parseInt(toHeight01) + 14) {
    ...
    $("#btnMore01").bind("mousedown", function (e) {
      ...
      if ($("#layerMore01").css("height") == bgHei01 + "px") {
        ...
        $("#btnMore01 img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerMore01").animate({ height: bgHei01 }, 0);
        $("#btnMore01 img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  if (bgHei01_01 < parseInt(toHeight01_01) + 14) {
    ...
    $("#btnMore01_01").bind("mousedown", function (e) {
      ...
      if ($("#layerMore01_01").css("height") == bgHei01_01 + "px") {
        ...
        $("#btnMore01_01 img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerMore01_01").animate({ height: bgHei01_01 }, 0);
        $("#btnMore01_01 img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  if (top02 <= 104) {
    ...
    $("#btnMore02").bind("mousedown", function (e) {
      ...
      if ($("#layerMore02").css("height") == "20px") {
        ...
        $("#btnMore02 img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerMore02").animate({ height: "20px" }, 0);
        $("#btnMore02 img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  if (bgHei03 < parseInt(toHeight03) + 14) {
    ...
    $("#btnMore03").bind("mousedown", function (e) {
      ...
      if ($("#layerMore03").css("height") == bgHei03 + "px") {
        ...
        $("#btnMore03 img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerMore03").animate({ height: bgHei03 }, 0);
        $("#btnMore03 img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
...
*/
  ...
  if (bgHei04 < parseInt(toHeight04) + 14) {
    ...
    $("#btnMore04").bind("mousedown", function (e) {
      ...
      if ($("#layerMore04").css("height") == bgHei04 + "px") {
        ...
        $("#btnMore04 img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerMore04").animate({ height: bgHei04 }, 0);
        $("#btnMore04 img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  if (top05 <= 110) {
    ...
    $("#btnWriter").bind("mousedown", function (e) {
      ...
      if ($("#layerWriter").css("height") == "110px") {
        ...
        $("#btnWriter img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerWriter").animate({ height: "110px" }, 0);
        $("#btnWriter img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  if (top06 <= 114) {
    ...
    $("#btnViewList").bind("mousedown", function (e) {
      ...
      if ($("#layerViewList").css("height") == "110px") {
        ...
        $("#btnViewList img").attr("src", "../img/common/btn/icon_close_arrow_off.png");
        //	$("#btnMore01 a span").text("접기");
      } else {
        $("#layerViewList").animate({ height: "110px" }, 0);
        $("#btnViewList img").attr("src", "../img/common/btn/icon_open_arrow_off.png");
  ...
  function slideThumnail(obj) {
    ...
    jQuery(".slidecont #next").bind("click", function () {
      //next
      if (btnState) {
        if (cnt != len - 1) {
    ...
    jQuery(".slidecont #prev").bind("click", function () {
      //prev
      if (btnState) {
        if (cnt != 0) {
          cnt--;
    ...
    function slideMove(isState) {
      ...
      if (isState == "+") {
        wrap
          .stop()
          .animate({ "margin-left": newPos + -1 * widArr[cnt - 1] + "px" }, 400, "easeInOutCubic", function () {
            newPos -= widArr[cnt - 1];
            btnState = true;
          });
      } else {
  ...
  if (num) {
    for (var i = 0; i < num; i++) {
      $(".select2")
        .eq(6)
        .find(".overview ul")
        .append('<li><a href="#none">' + (i + 1) + "</a></li>");
    }
  }
}
/* // 2013-09-10 */
...
$(function () {
  ...
  $(".rankBox li").hover(
    function () {
      //$(this).find(".moreGame").append($("<span class='more'><a href='http://www.google.com' target='_blank'><img src='../img/common/icon/icon_viewmyphone.png' alt='내 폰에서 보기' /></a></span>"));
...
$("document").ready(function () {
  ...
  $(".csCenter .csInput01, .csCenter .csSearch input").bind("blur", function () {
    if ($(this).val() == "") {
      if ($(this).hasClass("csInput02")) {
        $(this).css("background", "url(../img/txt_cs_input02.gif) no-repeat 0 50%");
      } else if ($(this).hasClass("csInput03")) {
        $(this).css("background", "url(../img/txt_cs_input03.gif) no-repeat 0 0");
      } else if ($(this).hasClass("csInput04")) {
        $(this).css("background", "url(../img/txt_cs_input04.gif) no-repeat 0 0");
      } else {
        $(this).css("background", "url(../img/txt_cs_input01.gif) no-repeat 0 50%");
      }
    }
  });
  ...
  if ($("select#popSelect")) {
    $("select#popSelect").change(function () {
      $(this).popCheck(
        $('.inputCon input[type="text"]#phoneInput'),
        $('.inputCon input[type="text"]#phoneInput2'),
        $(".snsBtn a img"),
      );
    });
      ...
      item.find(".photo").bind({
        _stop: function () {
          ...
          if (!$(this).parent().parent().is(".play")) {
            ...
            $(this).prev().attr("src", "../img/common/btn/btn_musicbg.png");
          }
        },
      });
      item.find("a").bind({
        mouseenter: function () {
          if (!item.hasClass("play")) {
            ...
            item.find(".back").attr("src", "../img/common/btn/btn_play03.png");
          }
        },
        click: function () {
          //play
          if (!item.is("play")) {
            $(this).find(".back").attr("src", "../img/common/btn/btn_stop.png");
            _this.removeClass("play");
            item.addClass("play");
            _this.find(".photo").trigger("_stop");
          } else {
            $(this).find(".back").attr("src", "../img/common/btn/btn_play.png");
        ...
        mouseleave: function () {
          if (!item.is(".play")) {
            ...
            $(this).find(".back").attr("src", "../img/common/btn/btn_musicbg.png");
          }
        },
      });
    });
...
$(document).ready(function () {
  ...
  function winResize() {
    ...
    //detailGame preview
    if ($(".thumPop ul li .imgBox")) {
      //.thumPop .con .wrap .box
