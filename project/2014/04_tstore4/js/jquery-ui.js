...
(function ($, undefined) {
  ...
  $.fn.extend({
    disableSelection: function () {
      return this.bind(
        ($.support.selectstart ? "selectstart" : "mousedown") + ".ui-disableSelection",
        function (event) {
  ...
  $.widget("ui.sortable", $.ui.mouse, {
    ...
    _intersectsWithPointer: function (item) {
      var isOverElementHeight =
          this.options.axis === "x" ||
          $.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, item.top, item.height),
        isOverElementWidth =
          this.options.axis === "y" ||
          $.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, item.left, item.width),
  ...
  $.extend(Datepicker.prototype, {
    ...
    _showDatepicker: function (input) {
      ...
      if (!inst.inline) {
        ...
        inst.dpDiv.zIndex($(input).zIndex() + 13);
