...
(function ($) {
  $.fn.touchSlider2 = function (settings) {
    ...
    var opts = [];
    opts = $.extend({}, $.fn.touchSlider2.defaults, settings);

    return this.each(function () {
      var _this = this;

      $.fn.extend(this, touchSlider2);
      this.opts = opts;
      this.init();
  ...
  var touchSlider2 = {
    init: function () {
      ...
      /*   추가   */
      if (this._len <= this._view) {
        this.opts.btn_prev.hide();
        this.opts.btn_next.hide();
      }
    ...
    animate: function (d, btn_click) {
      if (this._drag || !this._scroll || btn_click) {
        ...
        if (!this.opts.roll && this.limit_chk()) gap = 0;
