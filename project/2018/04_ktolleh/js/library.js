    ...
    Y =
      ((i = f.createElement("div")),
      {
        touch:
          ...
          !!("ontouchstart" in B || (B.DocumentTouch && f instanceof B.DocumentTouch)),
            ...
            if (!a.isTouchEvent || "mousemove" !== n.type) {
              ...
              if (!t.allowTouchMove)
                return (
                  ...
                  void (
                    a.isTouched &&
                    (X.extend(s, { startX: o, startY: l, currentX: o, currentY: l }), (a.touchStartTime = X.now()))
                  )
                );
            ...
            X.extend(r, {
              ...
              touchEvents:
                ...
                Y.pointerEvents
                  ...
                  : Y.prefixedPointerEvents && (p = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
    ...
    D = {
      update: function (e) {
        ...
        if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
          ...
          for (var T = o; T <= l; T += 1)
            (T < g || b < T) &&
              t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + T + '"]').remove();
  ...
  var G = {
    ...
    _ = {
      onHashCange: function () {
        ...
        t !== e.slides.eq(e.activeIndex).attr("data-hash") &&
          e.slideTo(e.$wrapperEl.children("." + e.params.slideClass + '[data-hash="' + t + '"]').index());
      },
      setHash: function () {
        var e = this;
      ...
      setTranslate: function () {
        ...
        for (var h = 0; h < s.length; h += 1) {
          ...
          var E =
            ...
            "px)";
          if (
            (b <= 1 && -1 < b && ((u = 90 * f + 90 * b), o && (u = 90 * -f - 90 * b)), v.transform(E), d.slideShadows)
          ) {
            var T = p ? v.find(".swiper-slide-shadow-left") : v.find(".swiper-slide-shadow-top"),
              S = p ? v.find(".swiper-slide-shadow-right") : v.find(".swiper-slide-shadow-bottom");
            (0 === T.length &&
              ((T = L('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>')), v.append(T)),
              0 === S.length &&
      ...
      setTranslate: function () {
        for (
          ...
          if ((v.transform(E), (v[0].style.zIndex = 1 - Math.abs(Math.round(m))), n.slideShadows)) {
            ...
            (0 === T.length &&
              ((T = L('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>')), v.append(T)),
              0 === S.length &&
    ...
    ae = [
      ...
      },
      {
        ...
        create: function () {
          X.extend(this, {
            navigation: { init: N.init.bind(this), update: N.update.bind(this), destroy: N.destroy.bind(this) },
          });
        },
        on: {
          init: function () {
      ...
      },
      {
        ...
        create: function () {
          X.extend(this, {
            lazy: { initialImageLoaded: !1, load: q.load.bind(this), loadInSlide: q.loadInSlide.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
