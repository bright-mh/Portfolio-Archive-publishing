...
(function (window, doc) {
  ...
  iScroll.prototype = {
    ...
    _end: function (e) {
      ...
      if (that.zoomed) {
        ...
        that.scroller.style[transform] =
          "translate(" + that.x + "px," + that.y + "px) scale(" + that.scale + ")" + translateZ;
    ...
    refresh: function () {
      ...
      that.vScroll =
        that.options.vScroll && ((!that.options.bounceLock && !that.hScroll) || that.scrollerH > that.wrapperH);
      ...
      if (typeof that.options.snap == "string") {
        ...
        if (that.maxScrollX % that.wrapperW)
          that.pagesX[that.pagesX.length] =
            that.maxScrollX - that.pagesX[that.pagesX.length - 1] + that.pagesX[that.pagesX.length - 1];
        ...
        if (that.maxScrollY % that.wrapperH)
          that.pagesY[that.pagesY.length] =
            that.maxScrollY - that.pagesY[that.pagesY.length - 1] + that.pagesY[that.pagesY.length - 1];
      }
